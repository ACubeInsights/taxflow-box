...
export class GetFileCommentsOptionals {
    queryParams = {};
    headers = new GetFileCommentsHeaders({});
...
export class GetCommentByIdOptionals {
    queryParams = {};
    headers = new GetCommentByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.queryParams !== undefined) {
            this.queryParams = fields.queryParams;
...
export class UpdateCommentByIdOptionals {
    requestBody = {};
    queryParams = {};
    headers = new UpdateCommentByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
...
export class DeleteCommentByIdOptionals {
    headers = new DeleteCommentByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class CreateCommentOptionals {
    queryParams = {};
    headers = new CreateCommentHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.queryParams !== undefined) {
            this.queryParams = fields.queryParams;

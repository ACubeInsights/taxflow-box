import { deserializeFileVersions } from '../schemas/fileVersions.js';
import { deserializeFileVersionFull } from '../schemas/fileVersionFull.js';
...
export class GetFileVersionsOptionals {
    queryParams = {};
    headers = new GetFileVersionsHeaders({});
...
export class GetFileVersionByIdOptionals {
    queryParams = {};
    headers = new GetFileVersionByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.queryParams !== undefined) {
            this.queryParams = fields.queryParams;
...
export class DeleteFileVersionByIdOptionals {
    headers = new DeleteFileVersionByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class UpdateFileVersionByIdOptionals {
    requestBody = {};
    headers = new UpdateFileVersionByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
...
export class PromoteFileVersionOptionals {
    requestBody = {};
    queryParams = {};
    headers = new PromoteFileVersionHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.requestBody !== undefined) {
            this.requestBody = fields.requestBody;

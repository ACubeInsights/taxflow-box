...
export class GetShieldInformationBarrierSegmentByIdOptionals {
    headers = new GetShieldInformationBarrierSegmentByIdHeaders({});
...
export class DeleteShieldInformationBarrierSegmentByIdOptionals {
    headers = new DeleteShieldInformationBarrierSegmentByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class UpdateShieldInformationBarrierSegmentByIdOptionals {
    requestBody = {};
    headers = new UpdateShieldInformationBarrierSegmentByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
...
export class CreateShieldInformationBarrierSegmentOptionals {
    headers = new CreateShieldInformationBarrierSegmentHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;

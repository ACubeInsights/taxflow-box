...
import { serializeIntegrationMappingSlackOptions } from '../schemas/integrationMappingSlackOptions.js';
import { deserializeIntegrationMappingSlackOptions } from '../schemas/integrationMappingSlackOptions.js';
import { deserializeIntegrationMappingsTeams } from '../schemas/integrationMappingsTeams.js';
import { deserializeIntegrationMappingTeams } from '../schemas/integrationMappingTeams.js';
...
export class CreateSlackIntegrationMappingOptionals {
    headers = new CreateSlackIntegrationMappingHeaders({});
...
export class UpdateSlackIntegrationMappingByIdOptionals {
    requestBody = {};
    headers = new UpdateSlackIntegrationMappingByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
...
export class DeleteSlackIntegrationMappingByIdOptionals {
    headers = new DeleteSlackIntegrationMappingByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class CreateTeamsIntegrationMappingOptionals {
    headers = new CreateTeamsIntegrationMappingHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class UpdateTeamsIntegrationMappingByIdOptionals {
    requestBody = {};
    headers = new UpdateTeamsIntegrationMappingByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.requestBody !== undefined) {
            this.requestBody = fields.requestBody;
...
export class DeleteTeamsIntegrationMappingByIdOptionals {
    headers = new DeleteTeamsIntegrationMappingByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;

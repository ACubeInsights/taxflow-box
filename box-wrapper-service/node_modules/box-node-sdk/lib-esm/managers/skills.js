...
export class GetBoxSkillCardsOnFileOptionals {
    headers = new GetBoxSkillCardsOnFileHeaders({});
...
export class CreateBoxSkillCardsOnFileOptionals {
    headers = new CreateBoxSkillCardsOnFileHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class UpdateBoxSkillCardsOnFileOptionals {
    headers = new UpdateBoxSkillCardsOnFileHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class DeleteBoxSkillCardsFromFileOptionals {
    headers = new DeleteBoxSkillCardsFromFileHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class UpdateAllSkillCardsOnFileOptionals {
    headers = new UpdateAllSkillCardsOnFileHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export function deserializeUpdateBoxSkillCardsOnFileRequestBody(val) {
    ...
    const value = val.value == void 0 ? void 0 : deserializeSkillCard(val.value);
    return {
        op: op,
        path: path,
        value: value,

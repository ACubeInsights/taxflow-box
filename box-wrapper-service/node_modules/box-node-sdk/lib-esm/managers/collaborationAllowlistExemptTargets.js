...
export class CreateCollaborationWhitelistExemptTargetOptionals {
    headers = new CreateCollaborationWhitelistExemptTargetHeaders({});
...
export class GetCollaborationWhitelistExemptTargetByIdOptionals {
    headers = new GetCollaborationWhitelistExemptTargetByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class DeleteCollaborationWhitelistExemptTargetByIdOptionals {
    headers = new DeleteCollaborationWhitelistExemptTargetByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;

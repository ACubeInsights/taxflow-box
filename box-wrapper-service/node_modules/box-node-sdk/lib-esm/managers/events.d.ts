...
export type GetEventStreamQueryParamsStreamTypeField = 'all' | 'changes' | 'sync' | 'admin_logs' | 'admin_logs_streaming' | string;
...
export declare class GetEventStreamHeaders {
    /**
     * Extra headers that will be included in the HTTP request. */
    readonly extraHeaders?: {
        readonly [key: string]: undefined | string;
    };
    constructor(fields: Omit<GetEventStreamHeaders, 'extraHeaders'> & Partial<Pick<GetEventStreamHeaders, 'extraHeaders'>>);
}
...
export declare class EventsManager {
    ...
    constructor(fields: Omit<EventsManager, 'networkSession' | 'getEventsWithLongPolling' | 'getEvents' | 'getEventStream'> & Partial<Pick<EventsManager, 'networkSession'>>);
    /**
     ...
     * @returns {EventStream}
     */
    getEventStream(queryParams?: GetEventStreamQueryParams, headersInput?: GetEventStreamHeadersInput, cancellationToken?: CancellationToken): EventStream;
}
...
export declare function serializeGetEventStreamQueryParamsStreamTypeField(val: GetEventStreamQueryParamsStreamTypeField): SerializedData;
export declare function deserializeGetEventStreamQueryParamsStreamTypeField(val: SerializedData): GetEventStreamQueryParamsStreamTypeField;
export declare function serializeGetEventStreamQueryParamsEventTypeField(val: GetEventStreamQueryParamsEventTypeField): SerializedData;
export declare function deserializeGetEventStreamQueryParamsEventTypeField(val: SerializedData): GetEventStreamQueryParamsEventTypeField;

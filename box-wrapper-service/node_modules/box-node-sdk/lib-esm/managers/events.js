...
export function serializeGetEventStreamQueryParamsStreamTypeField(val) {
    return val;
}
export function deserializeGetEventStreamQueryParamsStreamTypeField(val) {
    if (val == 'all') {
        return val;
    }
    if (val == 'changes') {
...
export function serializeGetEventStreamQueryParamsEventTypeField(val) {
    return val;
}
export function deserializeGetEventStreamQueryParamsEventTypeField(val) {
    if (val == 'ACCESS_GRANTED') {
        return val;
    }
    if (val == 'ACCESS_REVOKED') {

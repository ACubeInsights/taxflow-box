...
export class GetSharedLinkForFolderOptionals {
    headers = new GetSharedLinkForFolderHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
...
export class AddShareLinkToFolderOptionals {
    headers = new AddShareLinkToFolderHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class UpdateSharedLinkOnFolderOptionals {
    headers = new UpdateSharedLinkOnFolderHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class RemoveSharedLinkFromFolderOptionals {
    headers = new RemoveSharedLinkFromFolderHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;

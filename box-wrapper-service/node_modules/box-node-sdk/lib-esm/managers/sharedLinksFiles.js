...
export class GetSharedLinkForFileOptionals {
    headers = new GetSharedLinkForFileHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
...
export class AddShareLinkToFileOptionals {
    headers = new AddShareLinkToFileHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class UpdateSharedLinkOnFileOptionals {
    headers = new UpdateSharedLinkOnFileHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class RemoveSharedLinkFromFileOptionals {
    headers = new RemoveSharedLinkFromFileHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;

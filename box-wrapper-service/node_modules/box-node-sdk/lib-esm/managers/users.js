import { deserializeUsers } from '../schemas/users.js';
import { deserializeUserFull } from '../schemas/userFull.js';
import { serializeTrackingCode } from '../schemas/trackingCode.js';
import { deserializeTrackingCode } from '../schemas/trackingCode.js';
...
export class GetUserByIdOptionals {
    queryParams = {};
    headers = new GetUserByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.queryParams !== undefined) {
            this.queryParams = fields.queryParams;
...
export class UpdateUserByIdOptionals {
    requestBody = {};
    queryParams = {};
    headers = new UpdateUserByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
...
export class DeleteUserByIdOptionals {
    queryParams = {};
    headers = new DeleteUserByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.queryParams !== undefined) {
            this.queryParams = fields.queryParams;

...
import { serializeOutcome } from '../schemas/outcome.js';
import { deserializeOutcome } from '../schemas/outcome.js';
...
export class GetWorkflowsOptionals {
    headers = new GetWorkflowsHeaders({});
...
export class StartWorkflowOptionals {
    headers = new StartWorkflowHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;

import { deserializeMetadataCascadePolicies } from '../schemas/metadataCascadePolicies.js';
import { deserializeMetadataCascadePolicy } from '../schemas/metadataCascadePolicy.js';
...
export class GetMetadataCascadePoliciesOptionals {
    headers = new GetMetadataCascadePoliciesHeaders({});
...
export class CreateMetadataCascadePolicyOptionals {
    headers = new CreateMetadataCascadePolicyHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class GetMetadataCascadePolicyByIdOptionals {
    headers = new GetMetadataCascadePolicyByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class DeleteMetadataCascadePolicyByIdOptionals {
    headers = new DeleteMetadataCascadePolicyByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class ApplyMetadataCascadePolicyOptionals {
    headers = new ApplyMetadataCascadePolicyHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;

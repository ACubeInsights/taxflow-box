...
export class GetClassificationOnFileOptionals {
    headers = new GetClassificationOnFileHeaders({});
...
export class AddClassificationToFileOptionals {
    requestBody = {};
    headers = new AddClassificationToFileHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
...
export class UpdateClassificationOnFileOptionals {
    headers = new UpdateClassificationOnFileHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class DeleteClassificationFromFileOptionals {
    headers = new DeleteClassificationFromFileHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
//# sourceMappingURL=fileClassifications.js.map
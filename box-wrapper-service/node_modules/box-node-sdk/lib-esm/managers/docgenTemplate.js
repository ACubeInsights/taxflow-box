...
export class CreateDocgenTemplateV2025R0Optionals {
    headers = new CreateDocgenTemplateV2025R0Headers({});
...
export class DeleteDocgenTemplateByIdV2025R0Optionals {
    headers = new DeleteDocgenTemplateByIdV2025R0Headers({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class GetDocgenTemplateByIdV2025R0Optionals {
    headers = new GetDocgenTemplateByIdV2025R0Headers({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class GetDocgenTemplateTagsV2025R0Optionals {
    queryParams = {};
    headers = new GetDocgenTemplateTagsV2025R0Headers({});
    cancellationToken = void 0;
    constructor(fields) {
...
export class GetDocgenTemplateJobByIdV2025R0Optionals {
    queryParams = {};
    headers = new GetDocgenTemplateJobByIdV2025R0Headers({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.queryParams !== undefined) {
            this.queryParams = fields.queryParams;

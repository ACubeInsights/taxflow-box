...
export class GetUserMembershipsOptionals {
    queryParams = {};
    headers = new GetUserMembershipsHeaders({});
...
export class GetGroupMembershipsOptionals {
    queryParams = {};
    headers = new GetGroupMembershipsHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.queryParams !== undefined) {
            this.queryParams = fields.queryParams;
...
export class CreateGroupMembershipOptionals {
    queryParams = {};
    headers = new CreateGroupMembershipHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.queryParams !== undefined) {
            this.queryParams = fields.queryParams;
...
export class GetGroupMembershipByIdOptionals {
    queryParams = {};
    headers = new GetGroupMembershipByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.queryParams !== undefined) {
            this.queryParams = fields.queryParams;
...
export class UpdateGroupMembershipByIdOptionals {
    requestBody = {};
    queryParams = {};
    headers = new UpdateGroupMembershipByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
...
export class DeleteGroupMembershipByIdOptionals {
    headers = new DeleteGroupMembershipByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;

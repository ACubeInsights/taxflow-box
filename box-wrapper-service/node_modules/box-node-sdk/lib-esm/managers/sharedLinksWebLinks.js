...
export class GetSharedLinkForWebLinkOptionals {
    headers = new GetSharedLinkForWebLinkHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
...
export class AddShareLinkToWebLinkOptionals {
    headers = new AddShareLinkToWebLinkHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class UpdateSharedLinkOnWebLinkOptionals {
    headers = new UpdateSharedLinkOnWebLinkHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class RemoveSharedLinkFromWebLinkOptionals {
    headers = new RemoveSharedLinkFromWebLinkHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;

...
export class GetTermsOfServiceUserStatusesOptionals {
    headers = new GetTermsOfServiceUserStatusesHeaders({});
...
export class CreateTermsOfServiceStatusForUserOptionals {
    headers = new CreateTermsOfServiceStatusForUserHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class UpdateTermsOfServiceStatusForUserByIdOptionals {
    headers = new UpdateTermsOfServiceStatusForUserByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;

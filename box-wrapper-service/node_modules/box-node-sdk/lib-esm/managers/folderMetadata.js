...
import { serializeMetadataInstanceValue } from '../schemas/metadataInstanceValue.js';
import { deserializeMetadataInstanceValue } from '../schemas/metadataInstanceValue.js';
...
export class GetFolderMetadataOptionals {
    queryParams = {};
    headers = new GetFolderMetadataHeaders({});
...
export class GetFolderMetadataByIdOptionals {
    headers = new GetFolderMetadataByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class CreateFolderMetadataByIdOptionals {
    headers = new CreateFolderMetadataByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class UpdateFolderMetadataByIdOptionals {
    headers = new UpdateFolderMetadataByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
export class DeleteFolderMetadataByIdOptionals {
    headers = new DeleteFolderMetadataByIdHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;

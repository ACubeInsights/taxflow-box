...
import { serializeAppItemAssociatedItem } from './appItemAssociatedItem.js';
import { deserializeAppItemAssociatedItem } from './appItemAssociatedItem.js';
...
export function deserializeAppItemAssociation(val) {
    ...
    const item = deserializeAppItemAssociatedItem(val.item);
    return {
        id: id,
        type: type,
        appItem: appItem,

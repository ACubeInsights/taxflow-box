import { serializeCollaborationItem } from './collaborationItem.js';
import { deserializeCollaborationItem } from './collaborationItem.js';
import { serializeAppItem } from './appItem.js';
import { deserializeAppItem } from './appItem.js';
import { serializeCollaborationAccessGrantee } from './collaborationAccessGrantee.js';
import { deserializeCollaborationAccessGrantee } from './collaborationAccessGrantee.js';
...
import { serializeTermsOfServiceBase } from './termsOfServiceBase.js';
import { deserializeTermsOfServiceBase } from './termsOfServiceBase.js';
...
export function serializeCollaboration(val) {
    return {
        ...
        ['item']: val.item == void 0 ? val.item : serializeCollaborationItem(val.item),
...
export function deserializeCollaboration(val) {
    ...
    const item = val.item == void 0 ? void 0 : deserializeCollaborationItem(val.item);

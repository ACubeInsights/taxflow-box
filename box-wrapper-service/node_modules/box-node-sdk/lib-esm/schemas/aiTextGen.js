...
import { serializeAiTextGenAgent } from './aiTextGenAgent.js';
import { deserializeAiTextGenAgent } from './aiTextGenAgent.js';
...
export function deserializeAiTextGen(val) {
    ...
    const dialogueHistory = val.dialogue_history == void 0
        ...
        : sdIsList(val.dialogue_history)
            ...
            : [];
    const aiAgent = val.ai_agent == void 0 ? void 0 : deserializeAiTextGenAgent(val.ai_agent);
    return {
        prompt: prompt,
        items: items,

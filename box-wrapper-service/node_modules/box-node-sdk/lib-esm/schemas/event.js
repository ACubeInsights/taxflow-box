...
import { serializeEventSourceResource } from './eventSourceResource.js';
import { deserializeEventSourceResource } from './eventSourceResource.js';
...
export function deserializeEvent(val) {
    ...
    const source = val.source == void 0 ? void 0 : deserializeEventSourceResource(val.source);

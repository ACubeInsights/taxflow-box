...
import { serializeSignRequestBase } from './signRequestBase.js';
import { serializeFileBase } from './fileBase.js';
import { deserializeFileBase } from './fileBase.js';
import { serializeSignRequestSigner } from './signRequestSigner.js';
import { deserializeSignRequestSigner } from './signRequestSigner.js';
...
export function deserializeSignRequest(val) {
    ...
    const finishedAt = val.finished_at == void 0 ? void 0 : deserializeDateTime(val.finished_at);

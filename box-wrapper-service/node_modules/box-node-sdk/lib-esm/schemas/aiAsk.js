import { serializeAiItemAsk } from './aiItemAsk.js';
import { deserializeAiItemAsk } from './aiItemAsk.js';
import { serializeAiDialogueHistory } from './aiDialogueHistory.js';
import { deserializeAiDialogueHistory } from './aiDialogueHistory.js';
import { serializeAiAskAgent } from './aiAskAgent.js';
import { deserializeAiAskAgent } from './aiAskAgent.js';
...
export function serializeAiAsk(val) {
    return {
        ...
        ['ai_agent']: val.aiAgent == void 0 ? val.aiAgent : serializeAiAskAgent(val.aiAgent),
    };
}
export function deserializeAiAsk(val) {
    ...
    const aiAgent = val.ai_agent == void 0 ? void 0 : deserializeAiAskAgent(val.ai_agent);
    return {
        mode: mode,
        prompt: prompt,
        items: items,

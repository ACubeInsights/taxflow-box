import { serializeRecentItemResource } from './recentItemResource.js';
import { deserializeRecentItemResource } from './recentItemResource.js';
...
export function serializeRecentItem(val) {
    return {
        ['type']: val.type,
        ['item']: val.item == void 0 ? val.item : serializeRecentItemResource(val.item),
...
export function deserializeRecentItem(val) {
    ...
    const item = val.item == void 0 ? void 0 : deserializeRecentItemResource(val.item);

...
const aiItemBase_1 = require("./aiItemBase.js");
const aiItemBase_2 = require("./aiItemBase.js");
const aiExtractStructuredAgent_1 = require("./aiExtractStructuredAgent.js");
const aiExtractStructuredAgent_2 = require("./aiExtractStructuredAgent.js");
...
function deserializeAiExtractStructuredMetadataTemplateField(val) {
    ...
    if (!(val.template_key == void 0) && !(0, json_2.sdIsString)(val.template_key)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.scope == void 0) && !(0, json_2.sdIsString)(val.scope)) {
        throw new errors_1.BoxSdkError({
...
function deserializeAiExtractStructuredFieldsOptionsField(val) {
    ...
    if (!(0, json_2.sdIsString)(val.key)) {
        throw new errors_1.BoxSdkError({
...
function deserializeAiExtractStructuredFieldsField(val) {
    ...
    if (!(val.prompt == void 0) && !(0, json_2.sdIsString)(val.prompt)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.options == void 0) && !(0, json_3.sdIsList)(val.options)) {
        throw new errors_1.BoxSdkError({
...
function deserializeAiExtractStructured(val) {
    ...
    if (!(0, json_3.sdIsList)(val.items)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting array for "items" of type "AiExtractStructured"',
        });
    }
    const items = (0, json_3.sdIsList)(val.items)
    ...
    if (!(val.fields == void 0) && !(0, json_3.sdIsList)(val.fields)) {
        throw new errors_1.BoxSdkError({
    ...
    const fields = val.fields == void 0
        ? void 0
        : (0, json_3.sdIsList)(val.fields)
            ? val.fields.map(function (itm) {
                return deserializeAiExtractStructuredFieldsField(itm);
            })
            : [];
    if (!(val.include_confidence_score == void 0) &&
        !(0, json_1.sdIsBoolean)(val.include_confidence_score)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting boolean for "include_confidence_score" of type "AiExtractStructured"',
        });
    }
    const includeConfidenceScore = val.include_confidence_score == void 0
        ? void 0

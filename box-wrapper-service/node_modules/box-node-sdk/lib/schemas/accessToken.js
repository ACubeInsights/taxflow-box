...
function deserializeAccessToken(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "AccessToken"' });
    }
    if (!(val.access_token == void 0) && !(0, json_2.sdIsString)(val.access_token)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.expires_in == void 0) && !(0, json_1.sdIsNumber)(val.expires_in)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.restricted_to == void 0) && !(0, json_3.sdIsList)(val.restricted_to)) {
        throw new errors_1.BoxSdkError({
    ...
    const restrictedTo = val.restricted_to == void 0
        ? void 0
        : (0, json_3.sdIsList)(val.restricted_to)
            ? val.restricted_to.map(function (itm) {
                return (0, resourceScope_2.deserializeResourceScope)(itm);
            })
            : [];
    if (!(val.refresh_token == void 0) && !(0, json_2.sdIsString)(val.refresh_token)) {
        throw new errors_1.BoxSdkError({

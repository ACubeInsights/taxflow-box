...
function deserializeZipDownloadStatus(val) {
    ...
    if (!(val.total_file_count == void 0) && !(0, json_1.sdIsNumber)(val.total_file_count)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.downloaded_file_count == void 0) &&
        !(0, json_1.sdIsNumber)(val.downloaded_file_count)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.skipped_file_count == void 0) &&
        !(0, json_1.sdIsNumber)(val.skipped_file_count)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.skipped_folder_count == void 0) &&
        !(0, json_1.sdIsNumber)(val.skipped_folder_count)) {
        throw new errors_1.BoxSdkError({

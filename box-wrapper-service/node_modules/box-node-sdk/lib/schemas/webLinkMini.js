...
const webLinkBase_2 = require("./webLinkBase.js");
const webLinkBase_3 = require("./webLinkBase.js");
const errors_1 = require("../box/errors.js");
const json_1 = require("../serialization/json.js");
const json_2 = require("../serialization/json.js");
class WebLinkMini extends webLinkBase_3.WebLinkBase {
    constructor(fields) {
        super(fields);
...
function serializeWebLinkMini(val) {
    const base = (0, webLinkBase_2.serializeWebLinkBase)(val);
    if (!(0, json_2.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "WebLinkMini"' });
    }
...
//# sourceMappingURL=webLinkMini.js.map
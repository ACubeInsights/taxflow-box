...
const legalHoldPolicy_1 = require("./legalHoldPolicy.js");
const legalHoldPolicy_2 = require("./legalHoldPolicy.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, legalHoldPolicy_1.serializeLegalHoldPolicy)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, legalHoldPolicy_2.deserializeLegalHoldPolicy)(itm);
            })
            : [];
    return {
        limit: limit,

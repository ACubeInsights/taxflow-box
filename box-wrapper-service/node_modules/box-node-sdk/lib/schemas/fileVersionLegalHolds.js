...
const fileVersionLegalHold_1 = require("./fileVersionLegalHold.js");
const fileVersionLegalHold_2 = require("./fileVersionLegalHold.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, fileVersionLegalHold_1.serializeFileVersionLegalHold)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, fileVersionLegalHold_2.deserializeFileVersionLegalHold)(itm);
            })
            : [];
    return {
        limit: limit,

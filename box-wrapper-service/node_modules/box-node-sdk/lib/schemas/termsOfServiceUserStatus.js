...
const termsOfServiceBase_1 = require("./termsOfServiceBase.js");
const termsOfServiceBase_2 = require("./termsOfServiceBase.js");
...
function serializeTermsOfServiceUserStatus(val) {
    return {
        ...
        ['tos']: val.tos == void 0 ? val.tos : (0, termsOfServiceBase_1.serializeTermsOfServiceBase)(val.tos),
        ['user']: val.user == void 0 ? val.user : (0, userMini_1.serializeUserMini)(val.user),
...
function deserializeTermsOfServiceUserStatus(val) {
    ...
    const tos = val.tos == void 0 ? void 0 : (0, termsOfServiceBase_2.deserializeTermsOfServiceBase)(val.tos);
    const user = val.user == void 0 ? void 0 : (0, userMini_2.deserializeUserMini)(val.user);
...
//# sourceMappingURL=termsOfServiceUserStatus.js.map
...
const webLinkBase_1 = require("./webLinkBase.js");
const webLinkMini_1 = require("./webLinkMini.js");
...
const webLinkMini_2 = require("./webLinkMini.js");
...
class WebLink extends webLinkMini_2.WebLinkMini {
    constructor(fields) {
        super(fields);
...
function serializeWebLink(val) {
    const base = (0, webLinkMini_1.serializeWebLinkMini)(val);
    if (!(0, json_5.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "WebLink"' });
    }
...
function deserializeWebLink(val) {
    ...
    const type = (0, webLinkBase_1.deserializeWebLinkBaseTypeField)(val.type);

...
const retentionPolicyBase_2 = require("./retentionPolicyBase.js");
const retentionPolicyBase_3 = require("./retentionPolicyBase.js");
const errors_1 = require("../box/errors.js");
const json_1 = require("../serialization/json.js");
const json_2 = require("../serialization/json.js");
class RetentionPolicyMini extends retentionPolicyBase_3.RetentionPolicyBase {
    constructor(fields) {
        super(fields);
...
function serializeRetentionPolicyMini(val) {
    const base = (0, retentionPolicyBase_2.serializeRetentionPolicyBase)(val);
...
function deserializeRetentionPolicyMini(val) {
    ...
    if (!(val.policy_name == void 0) && !(0, json_1.sdIsString)(val.policy_name)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.retention_length == void 0) && !(0, json_1.sdIsString)(val.retention_length)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=retentionPolicyMini.js.map
...
const aiStudioAgentLongTextTool_1 = require("./aiStudioAgentLongTextTool.js");
const aiStudioAgentLongTextTool_2 = require("./aiStudioAgentLongTextTool.js");
const aiStudioAgentBasicTextTool_1 = require("./aiStudioAgentBasicTextTool.js");
const aiStudioAgentBasicTextTool_2 = require("./aiStudioAgentBasicTextTool.js");
const aiStudioAgentSpreadsheetTool_1 = require("./aiStudioAgentSpreadsheetTool.js");
const aiStudioAgentSpreadsheetTool_2 = require("./aiStudioAgentSpreadsheetTool.js");
...
function serializeAiStudioAgentAsk(val) {
    return {
        ...
        ['long_text']: val.longText == void 0
            ? val.longText
            : (0, aiStudioAgentLongTextTool_1.serializeAiStudioAgentLongTextTool)(val.longText),
        ['basic_text']: val.basicText == void 0
            ? val.basicText
            : (0, aiStudioAgentBasicTextTool_1.serializeAiStudioAgentBasicTextTool)(val.basicText),
        ['basic_image']: val.basicImage == void 0
            ? val.basicImage
            : (0, aiStudioAgentBasicTextTool_1.serializeAiStudioAgentBasicTextTool)(val.basicImage),
        ['spreadsheet']: val.spreadsheet == void 0
            ? val.spreadsheet
            : (0, aiStudioAgentSpreadsheetTool_1.serializeAiStudioAgentSpreadsheetTool)(val.spreadsheet),
        ['long_text_multi']: val.longTextMulti == void 0
            ? val.longTextMulti
            : (0, aiStudioAgentLongTextTool_1.serializeAiStudioAgentLongTextTool)(val.longTextMulti),
        ['basic_text_multi']: val.basicTextMulti == void 0
            ? val.basicTextMulti
            : (0, aiStudioAgentBasicTextTool_1.serializeAiStudioAgentBasicTextTool)(val.basicTextMulti),
        ['basic_image_multi']: val.basicImageMulti == void 0
            ? val.basicImageMulti
            : (0, aiStudioAgentBasicTextTool_1.serializeAiStudioAgentBasicTextTool)(val.basicImageMulti),
    };
}
function deserializeAiStudioAgentAsk(val) {
    ...
    const longText = val.long_text == void 0
        ? void 0
        : (0, aiStudioAgentLongTextTool_2.deserializeAiStudioAgentLongTextTool)(val.long_text);
    const basicText = val.basic_text == void 0
        ? void 0
        : (0, aiStudioAgentBasicTextTool_2.deserializeAiStudioAgentBasicTextTool)(val.basic_text);
    const basicImage = val.basic_image == void 0
        ? void 0
        : (0, aiStudioAgentBasicTextTool_2.deserializeAiStudioAgentBasicTextTool)(val.basic_image);
    const spreadsheet = val.spreadsheet == void 0
        ? void 0
        : (0, aiStudioAgentSpreadsheetTool_2.deserializeAiStudioAgentSpreadsheetTool)(val.spreadsheet);
    const longTextMulti = val.long_text_multi == void 0
        ? void 0
        : (0, aiStudioAgentLongTextTool_2.deserializeAiStudioAgentLongTextTool)(val.long_text_multi);
    const basicTextMulti = val.basic_text_multi == void 0
        ? void 0
        : (0, aiStudioAgentBasicTextTool_2.deserializeAiStudioAgentBasicTextTool)(val.basic_text_multi);
    const basicImageMulti = val.basic_image_multi == void 0
        ? void 0
        : (0, aiStudioAgentBasicTextTool_2.deserializeAiStudioAgentBasicTextTool)(val.basic_image_multi);
    return {
        type: type,
...
//# sourceMappingURL=aiStudioAgentAsk.js.map
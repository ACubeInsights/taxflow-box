...
const signRequestPrefillTag_1 = require("./signRequestPrefillTag.js");
const signRequestSignerInputValidation_1 = require("./signRequestSignerInputValidation.js");
const signRequestSignerInputValidation_2 = require("./signRequestSignerInputValidation.js");
...
function deserializeTemplateSignerInputDimensionsField(val) {
    ...
    if (!(val.width == void 0) && !(0, json_2.sdIsNumber)(val.width)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.height == void 0) && !(0, json_2.sdIsNumber)(val.height)) {
        throw new errors_1.BoxSdkError({
...
function serializeTemplateSignerInput(val) {
    const base = (0, signRequestPrefillTag_1.serializeSignRequestPrefillTag)(val);
    ...
    return Object.assign(Object.assign({}, base), {
        ...
        ['validation']: val.validation == void 0
            ? val.validation
            : (0, signRequestSignerInputValidation_1.serializeSignRequestSignerInputValidation)(val.validation),
    });
}
function deserializeTemplateSignerInput(val) {
    ...
    if (!(val.is_required == void 0) && !(0, json_1.sdIsBoolean)(val.is_required)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_2.sdIsNumber)(val.page_index)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting number for "page_index" of type "TemplateSignerInput"',
        });
    }
    const pageIndex = val.page_index;
    if (!(val.document_id == void 0) && !(0, json_3.sdIsString)(val.document_id)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.dropdown_choices == void 0) && !(0, json_4.sdIsList)(val.dropdown_choices)) {
        throw new errors_1.BoxSdkError({
    ...
    const dropdownChoices = val.dropdown_choices == void 0
        ? void 0
        : (0, json_4.sdIsList)(val.dropdown_choices)
            ...
            : [];
    if (!(val.group_id == void 0) && !(0, json_3.sdIsString)(val.group_id)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.label == void 0) && !(0, json_3.sdIsString)(val.label)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "label" of type "TemplateSignerInput"',
        });
    }
    const label = val.label == void 0 ? void 0 : val.label;
    if (!(val.read_only == void 0) && !(0, json_1.sdIsBoolean)(val.read_only)) {
        throw new errors_1.BoxSdkError({
    ...
    const validation = val.validation == void 0
        ? void 0
        : (0, signRequestSignerInputValidation_2.deserializeSignRequestSignerInputValidation)(val.validation);
    if (!(val.document_tag_id == void 0) && !(0, json_3.sdIsString)(val.document_tag_id)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.text_value == void 0) && !(0, json_3.sdIsString)(val.text_value)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.checkbox_value == void 0) && !(0, json_1.sdIsBoolean)(val.checkbox_value)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.date_value == void 0) && !(0, json_3.sdIsString)(val.date_value)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "date_value" of type "TemplateSignerInput"',
        });
    }
    const dateValue = val.date_value == void 0 ? void 0 : (0, utils_1.deserializeDate)(val.date_value);
    return {
        type: type,
...
//# sourceMappingURL=templateSignerInput.js.map
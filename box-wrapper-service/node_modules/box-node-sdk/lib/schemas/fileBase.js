...
function deserializeFileBaseTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize FileBaseTypeField" });
}
...
function deserializeFileBase(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "FileBase"' });
    }
    if (val.id == void 0) {
...
function deserializeFileBaseInput(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "FileBaseInput"' });
    }
    if (val.id == void 0) {
        throw new errors_1.BoxSdkError({

...
function deserializeInviteTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize InviteTypeField" });
}
...
function serializeInvite(val) {
    return {
        ...
        ['actionable_by']: val.actionableBy == void 0
            ? val.actionableBy
            : (0, userMini_1.serializeUserMini)(val.actionableBy),
        ['invited_by']: val.invitedBy == void 0
            ? val.invitedBy
            : (0, userMini_1.serializeUserMini)(val.invitedBy),
        ['status']: val.status,
...
function deserializeInvite(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "Invite"' });
    }
    if (val.id == void 0) {
        throw new errors_1.BoxSdkError({
    ...
    const actionableBy = val.actionable_by == void 0
        ? void 0
        : (0, userMini_2.deserializeUserMini)(val.actionable_by);
    const invitedBy = val.invited_by == void 0 ? void 0 : (0, userMini_2.deserializeUserMini)(val.invited_by);
    if (!(val.status == void 0) && !(0, json_1.sdIsString)(val.status)) {
        throw new errors_1.BoxSdkError({
...
function deserializeInviteInput(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "InviteInput"' });
    }
    if (val.id == void 0) {
        throw new errors_1.BoxSdkError({

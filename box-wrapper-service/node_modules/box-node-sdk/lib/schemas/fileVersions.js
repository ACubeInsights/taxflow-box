...
const fileVersionFull_1 = require("./fileVersionFull.js");
const fileVersionFull_2 = require("./fileVersionFull.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, fileVersionFull_1.serializeFileVersionFull)(item);
            }),
    };
}
function deserializeFileVersions(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "FileVersions"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, fileVersionFull_2.deserializeFileVersionFull)(itm);
            })
            : [];
    return {

...
function deserializeAppItemTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize AppItemTypeField" });
}
...
function deserializeAppItem(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "AppItem"' });
    }
    if (val.id == void 0) {
    ...
    if (!(0, json_1.sdIsString)(val.application_type)) {
        throw new errors_1.BoxSdkError({
...
function deserializeAppItemInput(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "AppItemInput"' });
    }
    if (val.id == void 0) {
        throw new errors_1.BoxSdkError({

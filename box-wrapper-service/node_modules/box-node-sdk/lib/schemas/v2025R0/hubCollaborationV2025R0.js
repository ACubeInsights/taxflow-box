...
const hubAccessGranteeV2025R0_1 = require("./hubAccessGranteeV2025R0.js");
const hubAccessGranteeV2025R0_2 = require("./hubAccessGranteeV2025R0.js");
const termsOfServiceBaseV2025R0_1 = require("./termsOfServiceBaseV2025R0.js");
const termsOfServiceBaseV2025R0_2 = require("./termsOfServiceBaseV2025R0.js");
...
function serializeHubCollaborationV2025R0AcceptanceRequirementsStatusTermsOfServiceRequirementField(val) {
    return {
        ...
        ['terms_of_service']: val.termsOfService == void 0
            ? val.termsOfService
            : (0, termsOfServiceBaseV2025R0_1.serializeTermsOfServiceBaseV2025R0)(val.termsOfService),
    };
}
function deserializeHubCollaborationV2025R0AcceptanceRequirementsStatusTermsOfServiceRequirementField(val) {
    ...
    const termsOfService = val.terms_of_service == void 0
        ? void 0
        : (0, termsOfServiceBaseV2025R0_2.deserializeTermsOfServiceBaseV2025R0)(val.terms_of_service);
    return {
...
function serializeHubCollaborationV2025R0(val) {
    return {
        ...
        ['hub']: val.hub == void 0 ? val.hub : (0, hubBaseV2025R0_1.serializeHubBaseV2025R0)(val.hub),
        ['accessible_by']: val.accessibleBy == void 0
            ? val.accessibleBy
            : (0, hubAccessGranteeV2025R0_1.serializeHubAccessGranteeV2025R0)(val.accessibleBy),
        ['role']: val.role,
...
function deserializeHubCollaborationV2025R0(val) {
    ...
    const hub = val.hub == void 0 ? void 0 : (0, hubBaseV2025R0_2.deserializeHubBaseV2025R0)(val.hub);
    const accessibleBy = val.accessible_by == void 0
        ? void 0
        : (0, hubAccessGranteeV2025R0_2.deserializeHubAccessGranteeV2025R0)(val.accessible_by);
    if (!(val.role == void 0) && !(0, json_2.sdIsString)(val.role)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=hubCollaborationV2025R0.js.map
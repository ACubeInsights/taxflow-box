...
function deserializeShieldListContentEmailV2025R0(val) {
    ...
    if (!(0, json_2.sdIsList)(val.email_addresses)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting array for "email_addresses" of type "ShieldListContentEmailV2025R0"',
        });
    }
    const emailAddresses = (0, json_2.sdIsList)(val.email_addresses)
...
//# sourceMappingURL=shieldListContentEmailV2025R0.js.map
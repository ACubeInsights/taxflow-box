...
function deserializeDocGenTagV2025R0(val) {
    ...
    if (!(0, json_1.sdIsString)(val.tag_content)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_2.sdIsList)(val.json_paths)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting array for "json_paths" of type "DocGenTagV2025R0"',
        });
    }
    const jsonPaths = (0, json_2.sdIsList)(val.json_paths)
...
//# sourceMappingURL=docGenTagV2025R0.js.map
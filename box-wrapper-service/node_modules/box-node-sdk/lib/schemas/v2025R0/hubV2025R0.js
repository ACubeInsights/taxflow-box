...
const hubBaseV2025R0_1 = require("./hubBaseV2025R0.js");
const hubBaseV2025R0_2 = require("./hubBaseV2025R0.js");
const userMiniV2025R0_1 = require("./userMiniV2025R0.js");
const userMiniV2025R0_2 = require("./userMiniV2025R0.js");
const utils_1 = require("../../internal/utils.js");
const utils_2 = require("../../internal/utils.js");
const hubBaseV2025R0_3 = require("./hubBaseV2025R0.js");
...
class HubV2025R0 extends hubBaseV2025R0_3.HubBaseV2025R0 {
    constructor(fields) {
        super(fields);
...
function serializeHubV2025R0(val) {
    const base = (0, hubBaseV2025R0_2.serializeHubBaseV2025R0)(val);
    if (!(0, json_4.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "HubV2025R0"' });
    }
    return Object.assign(Object.assign({}, base), {
        ...
        ['created_by']: val.createdBy == void 0
            ? val.createdBy
            : (0, userMiniV2025R0_1.serializeUserMiniV2025R0)(val.createdBy),
        ['updated_by']: val.updatedBy == void 0
            ? val.updatedBy
            : (0, userMiniV2025R0_1.serializeUserMiniV2025R0)(val.updatedBy),
...
function deserializeHubV2025R0(val) {
    ...
    if (!(val.title == void 0) && !(0, json_3.sdIsString)(val.title)) {
    ...
    if (!(val.updated_at == void 0) && !(0, json_3.sdIsString)(val.updated_at)) {
        throw new errors_1.BoxSdkError({
    ...
    const createdBy = val.created_by == void 0
        ? void 0
        : (0, userMiniV2025R0_2.deserializeUserMiniV2025R0)(val.created_by);
    const updatedBy = val.updated_by == void 0
        ? void 0
        : (0, userMiniV2025R0_2.deserializeUserMiniV2025R0)(val.updated_by);
    if (!(val.view_count == void 0) && !(0, json_2.sdIsNumber)(val.view_count)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting number for "view_count" of type "HubV2025R0"',
        });
    }
    const viewCount = val.view_count == void 0 ? void 0 : val.view_count;
    if (!(val.is_ai_enabled == void 0) && !(0, json_1.sdIsBoolean)(val.is_ai_enabled)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.can_shared_link_be_created == void 0) &&
        !(0, json_1.sdIsBoolean)(val.can_shared_link_be_created)) {
        throw new errors_1.BoxSdkError({
    ...
    const type = (0, hubBaseV2025R0_1.deserializeHubBaseV2025R0TypeField)(val.type);
    return {
        title: title,
...
//# sourceMappingURL=hubV2025R0.js.map
...
const docGenTagV2025R0_1 = require("./docGenTagV2025R0.js");
const docGenTagV2025R0_2 = require("./docGenTagV2025R0.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, docGenTagV2025R0_1.serializeDocGenTagV2025R0)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, docGenTagV2025R0_2.deserializeDocGenTagV2025R0)(itm);
            })
            : [];
    return {
        limit: limit,
...
//# sourceMappingURL=docGenTagsV2025R0.js.map
...
function serializeUserMiniV2025R0(val) {
    const base = (0, userBaseV2025R0_2.serializeUserBaseV2025R0)(val);
    if (!(0, json_2.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "UserMiniV2025R0"' });
    }
...
function deserializeUserMiniV2025R0(val) {
    ...
    const type = (0, userBaseV2025R0_1.deserializeUserBaseV2025R0TypeField)(val.type);
    return {
        name: name,
        login: login,
        id: id,
...
//# sourceMappingURL=userMiniV2025R0.js.map
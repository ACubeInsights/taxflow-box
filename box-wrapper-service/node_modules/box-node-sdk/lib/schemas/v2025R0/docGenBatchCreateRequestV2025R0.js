...
const fileReferenceV2025R0_2 = require("./fileReferenceV2025R0.js");
const fileVersionBaseV2025R0_1 = require("./fileVersionBaseV2025R0.js");
const fileVersionBaseV2025R0_2 = require("./fileVersionBaseV2025R0.js");
const docGenDocumentGenerationDataV2025R0_1 = require("./docGenDocumentGenerationDataV2025R0.js");
const docGenDocumentGenerationDataV2025R0_2 = require("./docGenDocumentGenerationDataV2025R0.js");
...
function serializeDocGenBatchCreateRequestV2025R0(val) {
    return {
        ['file']: (0, fileReferenceV2025R0_1.serializeFileReferenceV2025R0)(val.file),
        ['file_version']: val.fileVersion == void 0
            ? val.fileVersion
            : (0, fileVersionBaseV2025R0_1.serializeFileVersionBaseV2025R0)(val.fileVersion),
        ...
        ['document_generation_data']: val.documentGenerationData.map(function (item) {
            return (0, docGenDocumentGenerationDataV2025R0_1.serializeDocGenDocumentGenerationDataV2025R0)(item);
        }),
    };
}
function deserializeDocGenBatchCreateRequestV2025R0(val) {
    ...
    const file = (0, fileReferenceV2025R0_2.deserializeFileReferenceV2025R0)(val.file);
    const fileVersion = val.file_version == void 0
        ? void 0
        : (0, fileVersionBaseV2025R0_2.deserializeFileVersionBaseV2025R0)(val.file_version);
    if (val.input_source == void 0) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting "input_source" of type "DocGenBatchCreateRequestV2025R0" to be defined',
        });
    }
    if (!(0, json_1.sdIsString)(val.input_source)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_2.sdIsList)(val.document_generation_data)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting array for "document_generation_data" of type "DocGenBatchCreateRequestV2025R0"',
        });
    }
    const documentGenerationData = (0, json_2.sdIsList)(val.document_generation_data)
        ? val.document_generation_data.map(function (itm) {
            return (0, docGenDocumentGenerationDataV2025R0_2.deserializeDocGenDocumentGenerationDataV2025R0)(itm);
        })
        : [];
    return {
        file: file,

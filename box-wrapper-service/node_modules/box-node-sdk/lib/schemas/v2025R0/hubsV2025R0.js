...
const hubV2025R0_1 = require("./hubV2025R0.js");
const hubV2025R0_2 = require("./hubV2025R0.js");
    ...
    return {
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, hubV2025R0_1.serializeHubV2025R0)(item);
            }),
        ['limit']: val.limit,
...
function deserializeHubsV2025R0(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "HubsV2025R0"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, hubV2025R0_2.deserializeHubV2025R0)(itm);
            })
            : [];
...
//# sourceMappingURL=hubsV2025R0.js.map
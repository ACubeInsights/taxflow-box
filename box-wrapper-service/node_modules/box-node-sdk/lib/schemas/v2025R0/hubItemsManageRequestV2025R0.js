...
const hubItemOperationV2025R0_1 = require("./hubItemOperationV2025R0.js");
const hubItemOperationV2025R0_2 = require("./hubItemOperationV2025R0.js");
    ...
    return {
        ['operations']: val.operations == void 0
            ...
            : val.operations.map(function (item) {
                return (0, hubItemOperationV2025R0_1.serializeHubItemOperationV2025R0)(item);
            }),
    };
}
function deserializeHubItemsManageRequestV2025R0(val) {
    ...
    if (!(val.operations == void 0) && !(0, json_1.sdIsList)(val.operations)) {
        throw new errors_1.BoxSdkError({
    ...
    const operations = val.operations == void 0
        ? void 0
        : (0, json_1.sdIsList)(val.operations)
            ? val.operations.map(function (itm) {
                return (0, hubItemOperationV2025R0_2.deserializeHubItemOperationV2025R0)(itm);
            })
            : [];
    return { operations: operations };
}
//# sourceMappingURL=hubItemsManageRequestV2025R0.js.map
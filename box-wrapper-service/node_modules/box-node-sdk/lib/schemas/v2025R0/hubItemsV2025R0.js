...
const hubItemV2025R0_1 = require("./hubItemV2025R0.js");
const hubItemV2025R0_2 = require("./hubItemV2025R0.js");
    ...
    return {
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, hubItemV2025R0_1.serializeHubItemV2025R0)(item);
            }),
        ['limit']: val.limit,
...
function deserializeHubItemsV2025R0(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "HubItemsV2025R0"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, hubItemV2025R0_2.deserializeHubItemV2025R0)(itm);
            })
            : [];
...
//# sourceMappingURL=hubItemsV2025R0.js.map
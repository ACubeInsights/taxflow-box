...
const docGenTemplateBaseV2025R0_1 = require("./docGenTemplateBaseV2025R0.js");
...
function serializeDocGenTemplateV2025R0(val) {
    const base = (0, docGenTemplateBaseV2025R0_1.serializeDocGenTemplateBaseV2025R0)(val);
...
function deserializeDocGenTemplateV2025R0(val) {
    ...
    if (!(val.file_name == void 0) && !(0, json_1.sdIsString)(val.file_name)) {
        throw new errors_1.BoxSdkError({
    ...
    const file = val.file == void 0 ? void 0 : (0, fileReferenceV2025R0_1.deserializeFileReferenceV2025R0)(val.file);
    return { fileName: fileName, file: file };
}
//# sourceMappingURL=docGenTemplateV2025R0.js.map
...
const groupBaseV2025R0_1 = require("./groupBaseV2025R0.js");
const groupBaseV2025R0_2 = require("./groupBaseV2025R0.js");
const groupBaseV2025R0_3 = require("./groupBaseV2025R0.js");
const errors_1 = require("../../box/errors.js");
const json_1 = require("../../serialization/json.js");
const json_2 = require("../../serialization/json.js");
class GroupMiniV2025R0 extends groupBaseV2025R0_3.GroupBaseV2025R0 {
    constructor(fields) {
        super(fields);
...
function serializeGroupMiniV2025R0(val) {
    const base = (0, groupBaseV2025R0_2.serializeGroupBaseV2025R0)(val);
...
function deserializeGroupMiniV2025R0(val) {
    ...
    const type = (0, groupBaseV2025R0_1.deserializeGroupBaseV2025R0TypeField)(val.type);
    return {
        name: name,
        groupType: groupType,
        id: id,
...
//# sourceMappingURL=groupMiniV2025R0.js.map
...
const archiveV2025R0_1 = require("./archiveV2025R0.js");
const archiveV2025R0_2 = require("./archiveV2025R0.js");
    ...
    return {
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, archiveV2025R0_1.serializeArchiveV2025R0)(item);
            }),
        ['limit']: val.limit,
...
function deserializeArchivesV2025R0(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "ArchivesV2025R0"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, archiveV2025R0_2.deserializeArchiveV2025R0)(itm);
            })
            : [];
...
//# sourceMappingURL=archivesV2025R0.js.map
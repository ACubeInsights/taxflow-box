...
const hubItemReferenceV2025R0_1 = require("./hubItemReferenceV2025R0.js");
const hubItemReferenceV2025R0_2 = require("./hubItemReferenceV2025R0.js");
...
function serializeHubItemOperationResultV2025R0(val) {
    return {
        ...
        ['item']: val.item == void 0
            ? val.item
            : (0, hubItemReferenceV2025R0_1.serializeHubItemReferenceV2025R0)(val.item),
        ['status']: val.status,
        ['error']: val.error,
    };
}
function deserializeHubItemOperationResultV2025R0(val) {
    ...
    if (!(val.action == void 0) && !(0, json_2.sdIsString)(val.action)) {
        throw new errors_1.BoxSdkError({
    ...
    const item = val.item == void 0 ? void 0 : (0, hubItemReferenceV2025R0_2.deserializeHubItemReferenceV2025R0)(val.item);
    ...
    if (!(val.error == void 0) && !(0, json_2.sdIsString)(val.error)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=hubItemOperationResultV2025R0.js.map
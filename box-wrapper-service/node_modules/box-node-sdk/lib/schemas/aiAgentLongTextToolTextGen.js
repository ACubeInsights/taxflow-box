...
const aiAgentBasicTextToolTextGen_1 = require("./aiAgentBasicTextToolTextGen.js");
...
function deserializeAiAgentLongTextToolTextGenEmbeddingsStrategyField(val) {
    ...
    if (!(val.num_tokens_per_chunk == void 0) &&
        !(0, json_1.sdIsNumber)(val.num_tokens_per_chunk)) {
        throw new errors_1.BoxSdkError({
...
function deserializeAiAgentLongTextToolTextGenEmbeddingsField(val) {
    ...
    if (!(val.model == void 0) && !(0, json_2.sdIsString)(val.model)) {
        throw new errors_1.BoxSdkError({
...
function serializeAiAgentLongTextToolTextGen(val) {
    const base = (0, aiAgentBasicTextToolTextGen_1.serializeAiAgentBasicTextToolTextGen)(val);
...
function deserializeAiAgentLongTextToolTextGen(val) {
    ...
    if (!(val.system_message == void 0) && !(0, json_2.sdIsString)(val.system_message)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.prompt_template == void 0) && !(0, json_2.sdIsString)(val.prompt_template)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.num_tokens_for_completion == void 0) &&
        !(0, json_1.sdIsNumber)(val.num_tokens_for_completion)) {
        throw new errors_1.BoxSdkError({

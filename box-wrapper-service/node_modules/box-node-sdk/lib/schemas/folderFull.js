...
const folderBase_1 = require("./folderBase.js");
const folderMini_1 = require("./folderMini.js");
const utils_1 = require("../internal/utils.js");
const folder_1 = require("./folder.js");
const userMini_1 = require("./userMini.js");
const folder_2 = require("./folder.js");
const folder_3 = require("./folder.js");
const folder_4 = require("./folder.js");
const items_1 = require("./items.js");
const folder_5 = require("./folder.js");
const metadataFull_1 = require("./metadataFull.js");
const folder_6 = require("./folder.js");
...
class FolderFull extends folder_6.Folder {
    constructor(fields) {
        super(fields);
...
function deserializeFolderFullPermissionsField(val) {
    ...
    if (!(val.can_apply_watermark == void 0) &&
        !(0, json_1.sdIsBoolean)(val.can_apply_watermark)) {
        throw new errors_1.BoxSdkError({
...
function deserializeFolderFullWatermarkInfoField(val) {
    ...
    if (!(val.is_watermark_inherited == void 0) &&
        !(0, json_1.sdIsBoolean)(val.is_watermark_inherited)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.is_watermarked_by_access_policy == void 0) &&
        !(0, json_1.sdIsBoolean)(val.is_watermarked_by_access_policy)) {
        throw new errors_1.BoxSdkError({
...
function serializeFolderFull(val) {
    const base = (0, folder_5.serializeFolder)(val);
    if (!(0, json_5.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "FolderFull"' });
    }
...
function deserializeFolderFull(val) {
    ...
    if (!(val.allowed_shared_link_access_levels == void 0) &&
        !(0, json_4.sdIsList)(val.allowed_shared_link_access_levels)) {
        throw new errors_1.BoxSdkError({
    ...
    const pathCollection = val.path_collection == void 0
        ? void 0
        : (0, folder_1.deserializeFolderPathCollectionField)(val.path_collection);
    const createdBy = val.created_by == void 0 ? void 0 : (0, userMini_1.deserializeUserMini)(val.created_by);
    const modifiedBy = val.modified_by == void 0 ? void 0 : (0, userMini_1.deserializeUserMini)(val.modified_by);
    if (!(val.trashed_at == void 0) && !(0, json_3.sdIsString)(val.trashed_at)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "trashed_at" of type "FolderFull"',
        });
    }
    const trashedAt = val.trashed_at == void 0 ? void 0 : (0, utils_1.deserializeDateTime)(val.trashed_at);
    if (!(val.purged_at == void 0) && !(0, json_3.sdIsString)(val.purged_at)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "purged_at" of type "FolderFull"',
        });
    }
    const purgedAt = val.purged_at == void 0 ? void 0 : (0, utils_1.deserializeDateTime)(val.purged_at);
    ...
    const contentCreatedAt = val.content_created_at == void 0
        ? void 0
        : (0, utils_1.deserializeDateTime)(val.content_created_at);
    ...
    const contentModifiedAt = val.content_modified_at == void 0
        ? void 0
        : (0, utils_1.deserializeDateTime)(val.content_modified_at);
    const ownedBy = val.owned_by == void 0 ? void 0 : (0, userMini_1.deserializeUserMini)(val.owned_by);
    const sharedLink = val.shared_link == void 0
        ? void 0
        : (0, folder_2.deserializeFolderSharedLinkField)(val.shared_link);
    const folderUploadEmail = val.folder_upload_email == void 0
        ? void 0
        : (0, folder_3.deserializeFolderFolderUploadEmailField)(val.folder_upload_email);
    ...
    const itemStatus = val.item_status == void 0
        ? void 0
        : (0, folder_4.deserializeFolderItemStatusField)(val.item_status);
    const itemCollection = val.item_collection == void 0
        ? void 0
        : (0, items_1.deserializeItems)(val.item_collection);
    ...
    const type = (0, folderBase_1.deserializeFolderBaseTypeField)(val.type);
    return {
        syncState: syncState,
...
//# sourceMappingURL=folderFull.js.map
...
const metadataCascadePolicy_1 = require("./metadataCascadePolicy.js");
const metadataCascadePolicy_2 = require("./metadataCascadePolicy.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, metadataCascadePolicy_1.serializeMetadataCascadePolicy)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, metadataCascadePolicy_2.deserializeMetadataCascadePolicy)(itm);
            })
            : [];
    return {
        limit: limit,

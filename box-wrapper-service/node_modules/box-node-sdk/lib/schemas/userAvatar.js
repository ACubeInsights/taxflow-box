...
function deserializeUserAvatar(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "UserAvatar"' });
    }

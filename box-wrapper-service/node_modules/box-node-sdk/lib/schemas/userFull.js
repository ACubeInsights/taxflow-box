...
const user_2 = require("./user.js");
const user_3 = require("./user.js");
const trackingCode_1 = require("./trackingCode.js");
const trackingCode_2 = require("./trackingCode.js");
const user_4 = require("./user.js");
...
class UserFull extends user_4.User {
    constructor(fields) {
        super(fields);
...
function deserializeUserFullRoleField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize UserFullRoleField" });
}
...
function serializeUserFull(val) {
    const base = (0, user_3.serializeUser)(val);
...
function deserializeUserFull(val) {
    ...
    if (!(val.my_tags == void 0) && !(0, json_4.sdIsList)(val.my_tags)) {
        throw new errors_1.BoxSdkError({
    ...
    const myTags = val.my_tags == void 0
        ...
        : (0, json_4.sdIsList)(val.my_tags)
            ...
            : [];
    if (!(val.hostname == void 0) && !(0, json_3.sdIsString)(val.hostname)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.space_used == void 0) && !(0, json_2.sdIsNumber)(val.space_used)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting number for "space_used" of type "UserFull"',
        });
    }
    const spaceUsed = val.space_used == void 0 ? void 0 : val.space_used;
    if (!(val.max_upload_size == void 0) && !(0, json_2.sdIsNumber)(val.max_upload_size)) {
        throw new errors_1.BoxSdkError({
    ...
    const status = val.status == void 0 ? void 0 : (0, user_1.deserializeUserStatusField)(val.status);
    ...
    if (!(val.avatar_url == void 0) && !(0, json_3.sdIsString)(val.avatar_url)) {
        throw new errors_1.BoxSdkError({
    ...
    const notificationEmail = val.notification_email == void 0
        ? void 0
        : (0, user_2.deserializeUserNotificationEmailField)(val.notification_email);
    if (!(val.name == void 0) && !(0, json_3.sdIsString)(val.name)) {
        throw new errors_1.BoxSdkError({
    ...
    const type = (0, userBase_1.deserializeUserBaseTypeField)(val.type);
    return {
        role: role,

...
const workflow_2 = require("./workflow.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, workflow_1.serializeWorkflow)(item);
            }),
    };
}
function deserializeWorkflows(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "Workflows"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, workflow_2.deserializeWorkflow)(itm);
            })
            : [];
    return {
        limit: limit,

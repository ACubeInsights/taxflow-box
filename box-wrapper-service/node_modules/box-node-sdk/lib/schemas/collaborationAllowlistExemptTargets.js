...
const collaborationAllowlistExemptTarget_1 = require("./collaborationAllowlistExemptTarget.js");
const collaborationAllowlistExemptTarget_2 = require("./collaborationAllowlistExemptTarget.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, collaborationAllowlistExemptTarget_1.serializeCollaborationAllowlistExemptTarget)(item);
            }),
    };
}
function deserializeCollaborationAllowlistExemptTargets(val) {
    ...
    if (!(val.prev_marker == void 0) && !(0, json_2.sdIsString)(val.prev_marker)) {
        throw new errors_1.BoxSdkError({
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, collaborationAllowlistExemptTarget_2.deserializeCollaborationAllowlistExemptTarget)(itm);
            })
            : [];
    return {
        limit: limit,

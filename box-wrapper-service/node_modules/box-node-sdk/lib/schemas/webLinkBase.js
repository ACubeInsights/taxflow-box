...
function deserializeWebLinkBaseTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize WebLinkBaseTypeField" });
}
...
function deserializeWebLinkBase(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "WebLinkBase"' });
    }
    if (val.id == void 0) {
...
//# sourceMappingURL=webLinkBase.js.map
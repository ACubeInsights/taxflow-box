...
const fileBase_1 = require("./fileBase.js");
...
class File extends fileMini_2.FileMini {
    constructor(fields) {
        super(fields);
...
function deserializeFilePathCollectionField(val) {
    ...
    if (!(0, json_2.sdIsNumber)(val.total_count)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_4.sdIsList)(val.entries)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting array for "entries" of type "FilePathCollectionField"',
        });
    }
    const entries = (0, json_4.sdIsList)(val.entries)
...
function deserializeFileSharedLinkPermissionsField(val) {
    ...
    if (!(0, json_1.sdIsBoolean)(val.can_edit)) {
        throw new errors_1.BoxSdkError({
...
function deserializeFileSharedLinkField(val) {
    ...
    if (!(val.unshared_at == void 0) && !(0, json_3.sdIsString)(val.unshared_at)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_1.sdIsBoolean)(val.is_password_enabled)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_2.sdIsNumber)(val.download_count)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_2.sdIsNumber)(val.preview_count)) {
        throw new errors_1.BoxSdkError({
...
function deserializeFileItemStatusField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize FileItemStatusField" });
}
function serializeFile(val) {
    const base = (0, fileMini_1.serializeFileMini)(val);
    if (!(0, json_5.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "File"' });
    }

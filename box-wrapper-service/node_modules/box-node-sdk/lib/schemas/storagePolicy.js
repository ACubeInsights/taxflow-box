...
const storagePolicyMini_1 = require("./storagePolicyMini.js");
const storagePolicyMini_2 = require("./storagePolicyMini.js");
const storagePolicyMini_3 = require("./storagePolicyMini.js");
const errors_1 = require("../box/errors.js");
const json_1 = require("../serialization/json.js");
const json_2 = require("../serialization/json.js");
class StoragePolicy extends storagePolicyMini_3.StoragePolicyMini {
    constructor(fields) {
        super(fields);
...
function serializeStoragePolicy(val) {
    const base = (0, storagePolicyMini_2.serializeStoragePolicyMini)(val);
    if (!(0, json_2.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "StoragePolicy"' });
    }
...
function deserializeStoragePolicy(val) {
    ...
    const type = (0, storagePolicyMini_1.deserializeStoragePolicyMiniTypeField)(val.type);
    return { name: name, id: id, type: type };
}
//# sourceMappingURL=storagePolicy.js.map
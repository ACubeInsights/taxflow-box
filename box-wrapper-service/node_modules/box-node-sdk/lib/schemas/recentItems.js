...
const recentItem_1 = require("./recentItem.js");
const recentItem_2 = require("./recentItem.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, recentItem_1.serializeRecentItem)(item);
            }),
    };
}
function deserializeRecentItems(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "RecentItems"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, recentItem_2.deserializeRecentItem)(itm);
            })
            : [];
    return {
        limit: limit,

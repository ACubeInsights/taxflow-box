...
function deserializeMetadataQueryOrderByField(val) {
    ...
    if (!(val.field_key == void 0) && !(0, json_2.sdIsString)(val.field_key)) {
        throw new errors_1.BoxSdkError({
...
function deserializeMetadataQuery(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "MetadataQuery"' });
    }
    if (val.from == void 0) {
        throw new errors_1.BoxSdkError({
    ...
    const queryParams = val.query_params == void 0
        ? void 0
        : (0, json_4.sdIsMap)(val.query_params)
    ...
    const orderBy = val.order_by == void 0
        ? void 0
        : (0, json_3.sdIsList)(val.order_by)
    ...
    if (!(val.marker == void 0) && !(0, json_2.sdIsString)(val.marker)) {
        throw new errors_1.BoxSdkError({

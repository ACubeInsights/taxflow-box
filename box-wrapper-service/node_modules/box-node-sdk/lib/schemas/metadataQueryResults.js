...
const metadataQueryResultItem_1 = require("./metadataQueryResultItem.js");
const metadataQueryResultItem_2 = require("./metadataQueryResultItem.js");
    ...
    return {
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, metadataQueryResultItem_1.serializeMetadataQueryResultItem)(item);
            }),
        ['limit']: val.limit,
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, metadataQueryResultItem_2.deserializeMetadataQueryResultItem)(itm);
            })
            : [];
...
//# sourceMappingURL=metadataQueryResults.js.map
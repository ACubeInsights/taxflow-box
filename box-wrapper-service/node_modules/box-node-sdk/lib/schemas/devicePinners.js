...
const devicePinner_1 = require("./devicePinner.js");
const devicePinner_2 = require("./devicePinner.js");
    ...
    return {
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, devicePinner_1.serializeDevicePinner)(item);
            }),
        ['limit']: val.limit,
...
function deserializeDevicePinners(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "DevicePinners"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, devicePinner_2.deserializeDevicePinner)(itm);
            })
            : [];
    ...
    if (!(val.next_marker == void 0) && !(0, json_1.sdIsNumber)(val.next_marker)) {
        throw new errors_1.BoxSdkError({

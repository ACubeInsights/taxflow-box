...
const legalHoldPolicyMini_1 = require("./legalHoldPolicyMini.js");
const legalHoldPolicyMini_2 = require("./legalHoldPolicyMini.js");
const userMini_1 = require("./userMini.js");
const userMini_2 = require("./userMini.js");
const utils_1 = require("../internal/utils.js");
const utils_2 = require("../internal/utils.js");
const legalHoldPolicyMini_3 = require("./legalHoldPolicyMini.js");
...
class LegalHoldPolicy extends legalHoldPolicyMini_3.LegalHoldPolicyMini {
    constructor(fields) {
        super(fields);
...
function deserializeLegalHoldPolicyAssignmentCountsField(val) {
    ...
    if (!(val.ownership == void 0) && !(0, json_1.sdIsNumber)(val.ownership)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.interactions == void 0) && !(0, json_1.sdIsNumber)(val.interactions)) {
        throw new errors_1.BoxSdkError({
...
function serializeLegalHoldPolicy(val) {
    const base = (0, legalHoldPolicyMini_2.serializeLegalHoldPolicyMini)(val);
    if (!(0, json_3.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "LegalHoldPolicy"' });
    }
    return Object.assign(Object.assign({}, base), {
        ...
        ['filter_started_at']: val.filterStartedAt == void 0
            ? val.filterStartedAt
            : (0, utils_1.serializeDateTime)(val.filterStartedAt),
        ['filter_ended_at']: val.filterEndedAt == void 0
            ? val.filterEndedAt
            : (0, utils_1.serializeDateTime)(val.filterEndedAt),
...
function deserializeLegalHoldPolicy(val) {
    ...
    if (!(val.deleted_at == void 0) && !(0, json_2.sdIsString)(val.deleted_at)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.filter_started_at == void 0) &&
        !(0, json_2.sdIsString)(val.filter_started_at)) {
        throw new errors_1.BoxSdkError({
    ...
    const filterStartedAt = val.filter_started_at == void 0
        ? void 0
        : (0, utils_2.deserializeDateTime)(val.filter_started_at);
    if (!(val.filter_ended_at == void 0) && !(0, json_2.sdIsString)(val.filter_ended_at)) {
        throw new errors_1.BoxSdkError({
    ...
    const filterEndedAt = val.filter_ended_at == void 0
        ? void 0
        : (0, utils_2.deserializeDateTime)(val.filter_ended_at);
    if (!(val.release_notes == void 0) && !(0, json_2.sdIsString)(val.release_notes)) {
        throw new errors_1.BoxSdkError({
    ...
    const type = (0, legalHoldPolicyMini_1.deserializeLegalHoldPolicyMiniTypeField)(val.type);
    return {
...
//# sourceMappingURL=legalHoldPolicy.js.map
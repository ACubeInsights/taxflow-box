...
class FileVersion extends fileVersionMini_2.FileVersionMini {
    constructor(fields) {
        super(fields);
...
function serializeFileVersion(val) {
    const base = (0, fileVersionMini_1.serializeFileVersionMini)(val);
    if (!(0, json_3.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "FileVersion"' });
    }
    return Object.assign(Object.assign({}, base), {
        ...
        ['trashed_by']: val.trashedBy == void 0
            ? val.trashedBy
            : (0, userMini_1.serializeUserMini)(val.trashedBy),
        ['restored_at']: val.restoredAt == void 0
            ? val.restoredAt
            : (0, utils_1.serializeDateTime)(val.restoredAt),
        ['restored_by']: val.restoredBy == void 0
            ? val.restoredBy
            : (0, userMini_1.serializeUserMini)(val.restoredBy),
...
function deserializeFileVersion(val) {
    ...
    const trashedBy = val.trashed_by == void 0 ? void 0 : (0, userMini_2.deserializeUserMini)(val.trashed_by);
    ...
    const restoredAt = val.restored_at == void 0 ? void 0 : (0, utils_2.deserializeDateTime)(val.restored_at);
    const restoredBy = val.restored_by == void 0 ? void 0 : (0, userMini_2.deserializeUserMini)(val.restored_by);

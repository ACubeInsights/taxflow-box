...
function serializeMetadataFull(val) {
    const base = (0, metadata_1.serializeMetadata)(val);
    if (!(0, json_4.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "MetadataFull"' });
    }
...
function deserializeMetadataFull(val) {
    ...
    if (!(val.$canEdit == void 0) && !(0, json_1.sdIsBoolean)(val.$canEdit)) {
    ...
    if (!(val.$type == void 0) && !(0, json_3.sdIsString)(val.$type)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "$type" of type "MetadataFull"',
        });
    }
    const type = val.$type == void 0 ? void 0 : val.$type;
    if (!(val.$typeVersion == void 0) && !(0, json_2.sdIsNumber)(val.$typeVersion)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val == void 0) && !(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=metadataFull.js.map
...
const fileMini_1 = require("./fileMini.js");
const fileMini_2 = require("./fileMini.js");
const templateSigner_1 = require("./templateSigner.js");
const templateSigner_2 = require("./templateSigner.js");
...
function deserializeSignTemplateTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize SignTemplateTypeField" });
}
...
function deserializeSignTemplateAdditionalInfoField(val) {
    ...
    if (!(val.non_editable == void 0) && !(0, json_4.sdIsList)(val.non_editable)) {
        throw new errors_1.BoxSdkError({
    ...
    const nonEditable = val.non_editable == void 0
        ? void 0
        : (0, json_4.sdIsList)(val.non_editable)
...
function deserializeSignTemplateReadySignLinkField(val) {
    ...
    if (!(val.instructions == void 0) && !(0, json_3.sdIsString)(val.instructions)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.folder_id == void 0) && !(0, json_3.sdIsString)(val.folder_id)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.is_notification_disabled == void 0) &&
        !(0, json_1.sdIsBoolean)(val.is_notification_disabled)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.is_active == void 0) && !(0, json_1.sdIsBoolean)(val.is_active)) {
        throw new errors_1.BoxSdkError({
...
function deserializeSignTemplateCustomBrandingField(val) {
    ...
    if (!(val.company_name == void 0) && !(0, json_3.sdIsString)(val.company_name)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.logo_uri == void 0) && !(0, json_3.sdIsString)(val.logo_uri)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.branding_color == void 0) && !(0, json_3.sdIsString)(val.branding_color)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.email_footer_text == void 0) &&
        !(0, json_3.sdIsString)(val.email_footer_text)) {
        throw new errors_1.BoxSdkError({
...
function serializeSignTemplate(val) {
    return {
        ...
        ['signers']: val.signers == void 0
            ? val.signers
            : val.signers.map(function (item) {
                return (0, templateSigner_1.serializeTemplateSigner)(item);
            }),
...
function deserializeSignTemplate(val) {
    if (!(0, json_5.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "SignTemplate"' });
    }
    ...
    if (!(val.are_fields_locked == void 0) &&
        !(0, json_1.sdIsBoolean)(val.are_fields_locked)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.are_options_locked == void 0) &&
        !(0, json_1.sdIsBoolean)(val.are_options_locked)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.are_recipients_locked == void 0) &&
        !(0, json_1.sdIsBoolean)(val.are_recipients_locked)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.are_email_settings_locked == void 0) &&
        !(0, json_1.sdIsBoolean)(val.are_email_settings_locked)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.are_files_locked == void 0) && !(0, json_1.sdIsBoolean)(val.are_files_locked)) {
        throw new errors_1.BoxSdkError({
    ...
    const signers = val.signers == void 0
        ...
        : (0, json_4.sdIsList)(val.signers)
            ? val.signers.map(function (itm) {
                return (0, templateSigner_2.deserializeTemplateSigner)(itm);
            })
            : [];

...
const folderBase_2 = require("./folderBase.js");
const folderBase_3 = require("./folderBase.js");
const errors_1 = require("../box/errors.js");
const json_1 = require("../serialization/json.js");
const json_2 = require("../serialization/json.js");
class FolderMini extends folderBase_3.FolderBase {
    constructor(fields) {
        super(fields);
...
function serializeFolderMini(val) {
    const base = (0, folderBase_2.serializeFolderBase)(val);
    if (!(0, json_2.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "FolderMini"' });
    }
...
//# sourceMappingURL=folderMini.js.map
...
function deserializeOAuth2Error(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "OAuth2Error"' });
    }
    if (!(val.error == void 0) && !(0, json_1.sdIsString)(val.error)) {
    ...
    if (!(val.error_description == void 0) &&
        !(0, json_1.sdIsString)(val.error_description)) {
        throw new errors_1.BoxSdkError({

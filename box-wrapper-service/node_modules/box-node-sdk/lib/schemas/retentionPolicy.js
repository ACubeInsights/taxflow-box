...
const retentionPolicyBase_1 = require("./retentionPolicyBase.js");
const retentionPolicyMini_1 = require("./retentionPolicyMini.js");
const retentionPolicyMini_2 = require("./retentionPolicyMini.js");
const userMini_1 = require("./userMini.js");
const userMini_2 = require("./userMini.js");
const utils_1 = require("../internal/utils.js");
const utils_2 = require("../internal/utils.js");
const retentionPolicyMini_3 = require("./retentionPolicyMini.js");
...
class RetentionPolicy extends retentionPolicyMini_3.RetentionPolicyMini {
    constructor(fields) {
        super(fields);
...
function deserializeRetentionPolicyAssignmentCountsField(val) {
    ...
    if (!(val.enterprise == void 0) && !(0, json_2.sdIsNumber)(val.enterprise)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.folder == void 0) && !(0, json_2.sdIsNumber)(val.folder)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.metadata_template == void 0) &&
        !(0, json_2.sdIsNumber)(val.metadata_template)) {
        throw new errors_1.BoxSdkError({
...
function serializeRetentionPolicy(val) {
    const base = (0, retentionPolicyMini_2.serializeRetentionPolicyMini)(val);
    if (!(0, json_5.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "RetentionPolicy"' });
    }
...
function deserializeRetentionPolicy(val) {
    ...
    if (!(val.custom_notification_recipients == void 0) &&
        !(0, json_4.sdIsList)(val.custom_notification_recipients)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.policy_name == void 0) && !(0, json_3.sdIsString)(val.policy_name)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.retention_length == void 0) && !(0, json_3.sdIsString)(val.retention_length)) {
        throw new errors_1.BoxSdkError({
    ...
    const dispositionAction = val.disposition_action == void 0
        ? void 0
        : (0, retentionPolicyMini_1.deserializeRetentionPolicyMiniDispositionActionField)(val.disposition_action);
    if (val.id == void 0) {
        throw new errors_1.BoxSdkError({
    ...
    const type = (0, retentionPolicyBase_1.deserializeRetentionPolicyBaseTypeField)(val.type);
    return {

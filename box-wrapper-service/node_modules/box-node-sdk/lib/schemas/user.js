...
class User extends userMini_2.UserMini {
    constructor(fields) {
        super(fields);
...
function deserializeUserStatusField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize UserStatusField" });
}
...
function deserializeUserNotificationEmailField(val) {
    ...
    if (!(val.is_confirmed == void 0) && !(0, json_1.sdIsBoolean)(val.is_confirmed)) {
        throw new errors_1.BoxSdkError({
...
function serializeUser(val) {
    const base = (0, userMini_1.serializeUserMini)(val);
    if (!(0, json_4.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "User"' });
    }

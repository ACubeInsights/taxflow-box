...
const signRequestBase_1 = require("./signRequestBase.js");
const fileBase_1 = require("./fileBase.js");
const fileBase_2 = require("./fileBase.js");
...
function serializeSignRequestCreateRequest(val) {
    ...
    return Object.assign(Object.assign({}, base), {
        ...
        ['signers']: val.signers.map(function (item) {
            return (0, signRequestCreateSigner_1.serializeSignRequestCreateSigner)(item);
        }),
...
function deserializeSignRequestCreateRequest(val) {
    ...
    if (!(0, json_4.sdIsList)(val.signers)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting array for "signers" of type "SignRequestCreateRequest"',
        });
    }
    const signers = (0, json_4.sdIsList)(val.signers)
        ? val.signers.map(function (itm) {
            return (0, signRequestCreateSigner_2.deserializeSignRequestCreateSigner)(itm);
        })
        : [];
...
//# sourceMappingURL=signRequestCreateRequest.js.map
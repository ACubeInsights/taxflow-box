...
function deserializeAiItemAskTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize AiItemAskTypeField" });
}
...
function deserializeAiItemAsk(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "AiItemAsk"' });
    }
    if (val.id == void 0) {
...
//# sourceMappingURL=aiItemAsk.js.map
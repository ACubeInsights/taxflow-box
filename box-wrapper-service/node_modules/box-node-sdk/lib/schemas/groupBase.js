...
function deserializeGroupBaseTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize GroupBaseTypeField" });
}
...
function deserializeGroupBase(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "GroupBase"' });
    }
    if (val.id == void 0) {
...
function deserializeGroupBaseInput(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "GroupBaseInput"' });
    }
    if (val.id == void 0) {
        throw new errors_1.BoxSdkError({

...
function serializeSignRequestPrefillTag(val) {
    return {
        ...
        ['date_value']: val.dateValue == void 0 ? val.dateValue : (0, utils_1.serializeDate)(val.dateValue),
    };
}
function deserializeSignRequestPrefillTag(val) {
    ...
    if (!(val.document_tag_id == void 0) && !(0, json_2.sdIsString)(val.document_tag_id)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.text_value == void 0) && !(0, json_2.sdIsString)(val.text_value)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.date_value == void 0) && !(0, json_2.sdIsString)(val.date_value)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "date_value" of type "SignRequestPrefillTag"',
        });
    }
    const dateValue = val.date_value == void 0 ? void 0 : (0, utils_2.deserializeDate)(val.date_value);
    return {
...
//# sourceMappingURL=signRequestPrefillTag.js.map
...
function deserializeEmailAliasTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize EmailAliasTypeField" });
}
...
function deserializeEmailAlias(val) {
    if (!(0, json_3.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "EmailAlias"' });
    }
...
//# sourceMappingURL=emailAlias.js.map
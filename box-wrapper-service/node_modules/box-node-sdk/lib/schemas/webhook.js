...
const webhookMini_1 = require("./webhookMini.js");
const webhookMini_2 = require("./webhookMini.js");
const webhookMini_3 = require("./webhookMini.js");
...
function deserializeWebhookTriggersField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize WebhookTriggersField" });
}
function serializeWebhook(val) {
    const base = (0, webhookMini_3.serializeWebhookMini)(val);
    if (!(0, json_3.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "Webhook"' });
    }
...
function deserializeWebhook(val) {
    ...
    const type = val.type == void 0 ? void 0 : (0, webhookMini_1.deserializeWebhookMiniTypeField)(val.type);
    const target = val.target == void 0
        ? void 0
        : (0, webhookMini_2.deserializeWebhookMiniTargetField)(val.target);
    return {
        createdBy: createdBy,
        createdAt: createdAt,
        address: address,

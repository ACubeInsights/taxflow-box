...
function serializeAiStudioAgentSpreadsheetToolResponse(val) {
    const base = (0, aiStudioAgentSpreadsheetTool_1.serializeAiStudioAgentSpreadsheetTool)(val);
...
function deserializeAiStudioAgentSpreadsheetToolResponse(val) {
    ...
    if (!(val.warnings == void 0) && !(0, json_3.sdIsList)(val.warnings)) {
        throw new errors_1.BoxSdkError({
    ...
    const warnings = val.warnings == void 0
        ? void 0
        : (0, json_3.sdIsList)(val.warnings)
...
//# sourceMappingURL=aiStudioAgentSpreadsheetToolResponse.js.map
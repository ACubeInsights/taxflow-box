...
const aiLlmEndpointParams_2 = require("./aiLlmEndpointParams.js");
...
function serializeAiAgentSpreadsheetTool(val) {
    return {
        ...
        ['llm_endpoint_params']: val.llmEndpointParams == void 0
            ...
            : (0, aiLlmEndpointParams_1.serializeAiLlmEndpointParams)(val.llmEndpointParams),
    };
}
function deserializeAiAgentSpreadsheetTool(val) {
    ...
    const llmEndpointParams = val.llm_endpoint_params == void 0
        ? void 0
        : (0, aiLlmEndpointParams_2.deserializeAiLlmEndpointParams)(val.llm_endpoint_params);
    return {
        model: model,
...
//# sourceMappingURL=aiAgentSpreadsheetTool.js.map
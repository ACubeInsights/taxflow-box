...
function deserializeCollectionTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize CollectionTypeField" });
}
...
function deserializeCollectionNameField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize CollectionNameField" });
}
...
function deserializeCollection(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "Collection"' });
    }

...
const aiLlmEndpointParams_1 = require("./aiLlmEndpointParams.js");
const aiAgentLongTextToolTextGen_1 = require("./aiAgentLongTextToolTextGen.js");
const aiStudioAgentBasicGenTool_1 = require("./aiStudioAgentBasicGenTool.js");
...
function serializeAiStudioAgentBasicGenToolResponse(val) {
    const base = (0, aiStudioAgentBasicGenTool_1.serializeAiStudioAgentBasicGenTool)(val);
...
function deserializeAiStudioAgentBasicGenToolResponse(val) {
    ...
    if (!(val.warnings == void 0) && !(0, json_4.sdIsList)(val.warnings)) {
        throw new errors_1.BoxSdkError({
    ...
    const warnings = val.warnings == void 0
        ? void 0
        : (0, json_4.sdIsList)(val.warnings)
    ...
    if (!(val.is_custom_instructions_included == void 0) &&
        !(0, json_1.sdIsBoolean)(val.is_custom_instructions_included)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.content_template == void 0) && !(0, json_3.sdIsString)(val.content_template)) {
        throw new errors_1.BoxSdkError({
    ...
    const embeddings = val.embeddings == void 0
        ? void 0
        : (0, aiAgentLongTextToolTextGen_1.deserializeAiAgentLongTextToolTextGenEmbeddingsField)(val.embeddings);
    if (!(val.system_message == void 0) && !(0, json_3.sdIsString)(val.system_message)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.prompt_template == void 0) && !(0, json_3.sdIsString)(val.prompt_template)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.model == void 0) && !(0, json_3.sdIsString)(val.model)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.num_tokens_for_completion == void 0) &&
        !(0, json_2.sdIsNumber)(val.num_tokens_for_completion)) {
        throw new errors_1.BoxSdkError({
    ...
    const llmEndpointParams = val.llm_endpoint_params == void 0
        ? void 0
        : (0, aiLlmEndpointParams_1.deserializeAiLlmEndpointParams)(val.llm_endpoint_params);
    return {
        warnings: warnings,
...
//# sourceMappingURL=aiStudioAgentBasicGenToolResponse.js.map
...
const taskAssignments_1 = require("./taskAssignments.js");
const taskAssignments_2 = require("./taskAssignments.js");
...
function deserializeTaskTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize TaskTypeField" });
}
...
function deserializeTaskActionField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize TaskActionField" });
}
...
function serializeTask(val) {
    return {
        ...
        ['item']: val.item == void 0 ? val.item : (0, fileMini_1.serializeFileMini)(val.item),
        ...
        ['task_assignment_collection']: val.taskAssignmentCollection == void 0
            ...
            : (0, taskAssignments_1.serializeTaskAssignments)(val.taskAssignmentCollection),
...
function deserializeTask(val) {
    if (!(0, json_3.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "Task"' });
    }
    ...
    const item = val.item == void 0 ? void 0 : (0, fileMini_2.deserializeFileMini)(val.item);
    if (!(val.due_at == void 0) && !(0, json_2.sdIsString)(val.due_at)) {
        throw new errors_1.BoxSdkError({
    ...
    const taskAssignmentCollection = val.task_assignment_collection == void 0
        ? void 0
        : (0, taskAssignments_2.deserializeTaskAssignments)(val.task_assignment_collection);
    if (!(val.is_completed == void 0) && !(0, json_1.sdIsBoolean)(val.is_completed)) {
        throw new errors_1.BoxSdkError({

...
const recentItemResource_1 = require("./recentItemResource.js");
const recentItemResource_2 = require("./recentItemResource.js");
...
function serializeRecentItem(val) {
    return {
        ['type']: val.type,
        ['item']: val.item == void 0 ? val.item : (0, recentItemResource_1.serializeRecentItemResource)(val.item),
        ...
        ['interacted_at']: val.interactedAt == void 0
            ? val.interactedAt
            : (0, utils_1.serializeDateTime)(val.interactedAt),
        ['interaction_shared_link']: val.interactionSharedLink,
    };
}
function deserializeRecentItem(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "RecentItem"' });
    }
    ...
    const item = val.item == void 0 ? void 0 : (0, recentItemResource_2.deserializeRecentItemResource)(val.item);
    const interactionType = val.interaction_type == void 0
        ? void 0
        : deserializeRecentItemInteractionTypeField(val.interaction_type);
    if (!(val.interacted_at == void 0) && !(0, json_1.sdIsString)(val.interacted_at)) {
        throw new errors_1.BoxSdkError({
    ...
    const interactedAt = val.interacted_at == void 0
        ? void 0
        : (0, utils_2.deserializeDateTime)(val.interacted_at);
    if (!(val.interaction_shared_link == void 0) &&
        !(0, json_1.sdIsString)(val.interaction_shared_link)) {
        throw new errors_1.BoxSdkError({

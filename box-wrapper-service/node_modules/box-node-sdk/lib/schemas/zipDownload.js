...
function deserializeZipDownloadNameConflictsField(val) {
    ...
    if (!(val.original_name == void 0) && !(0, json_1.sdIsString)(val.original_name)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.download_name == void 0) && !(0, json_1.sdIsString)(val.download_name)) {
        throw new errors_1.BoxSdkError({
...
function deserializeZipDownload(val) {
    if (!(0, json_3.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "ZipDownload"' });
    }
    if (!(val.download_url == void 0) && !(0, json_1.sdIsString)(val.download_url)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.status_url == void 0) && !(0, json_1.sdIsString)(val.status_url)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "status_url" of type "ZipDownload"',
        });
    }
    const statusUrl = val.status_url == void 0 ? void 0 : val.status_url;
    if (!(val.expires_at == void 0) && !(0, json_1.sdIsString)(val.expires_at)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.name_conflicts == void 0) && !(0, json_2.sdIsList)(val.name_conflicts)) {
        throw new errors_1.BoxSdkError({
    ...
    const nameConflicts = val.name_conflicts == void 0
        ? void 0
        : (0, json_2.sdIsList)(val.name_conflicts)
            ? val.name_conflicts.map(function (itm) {
                return (0, json_2.sdIsList)(itm)
...
//# sourceMappingURL=zipDownload.js.map
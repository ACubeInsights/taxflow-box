...
const appItemAssociation_1 = require("./appItemAssociation.js");
const appItemAssociation_2 = require("./appItemAssociation.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, appItemAssociation_1.serializeAppItemAssociation)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, appItemAssociation_2.deserializeAppItemAssociation)(itm);
            })
            : [];
    return {
        limit: limit,

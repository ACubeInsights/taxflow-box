...
const aiAgentLongTextTool_2 = require("./aiAgentLongTextTool.js");
const aiAgentBasicTextTool_1 = require("./aiAgentBasicTextTool.js");
const aiAgentBasicTextTool_2 = require("./aiAgentBasicTextTool.js");
...
function serializeAiAgentExtract(val) {
    return {
        ...
        ['long_text']: val.longText == void 0
            ? val.longText
            : (0, aiAgentLongTextTool_1.serializeAiAgentLongTextTool)(val.longText),
        ['basic_text']: val.basicText == void 0
            ? val.basicText
            : (0, aiAgentBasicTextTool_1.serializeAiAgentBasicTextTool)(val.basicText),
        ['basic_image']: val.basicImage == void 0
            ? val.basicImage
            : (0, aiAgentBasicTextTool_1.serializeAiAgentBasicTextTool)(val.basicImage),
    };
}
function deserializeAiAgentExtract(val) {
    if (!(0, json_1.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "AiAgentExtract"' });
    }
    if (val.type == void 0) {
        throw new errors_1.BoxSdkError({
    ...
    const longText = val.long_text == void 0
        ? void 0
        : (0, aiAgentLongTextTool_2.deserializeAiAgentLongTextTool)(val.long_text);
    const basicText = val.basic_text == void 0
        ? void 0
        : (0, aiAgentBasicTextTool_2.deserializeAiAgentBasicTextTool)(val.basic_text);
    const basicImage = val.basic_image == void 0
        ? void 0
        : (0, aiAgentBasicTextTool_2.deserializeAiAgentBasicTextTool)(val.basic_image);
    return {
        type: type,
        longText: longText,
        basicText: basicText,
...
//# sourceMappingURL=aiAgentExtract.js.map
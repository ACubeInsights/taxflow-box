...
function deserializeFolderBaseTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize FolderBaseTypeField" });
}
...
function deserializeFolderBase(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "FolderBase"' });
    }
    if (val.id == void 0) {
...
function deserializeFolderBaseInput(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "FolderBaseInput"' });
    }
    if (val.id == void 0) {
        throw new errors_1.BoxSdkError({

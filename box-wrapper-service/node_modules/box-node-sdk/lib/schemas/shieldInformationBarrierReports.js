...
const shieldInformationBarrierReport_1 = require("./shieldInformationBarrierReport.js");
const shieldInformationBarrierReport_2 = require("./shieldInformationBarrierReport.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, shieldInformationBarrierReport_1.serializeShieldInformationBarrierReport)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, shieldInformationBarrierReport_2.deserializeShieldInformationBarrierReport)(itm);
            })
            : [];
    return {
        limit: limit,

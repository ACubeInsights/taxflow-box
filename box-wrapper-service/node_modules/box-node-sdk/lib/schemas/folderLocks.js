...
const folderLock_1 = require("./folderLock.js");
const folderLock_2 = require("./folderLock.js");
    ...
    return {
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, folderLock_1.serializeFolderLock)(item);
            }),
        ['limit']: val.limit,
...
function deserializeFolderLocks(val) {
    if (!(0, json_3.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "FolderLocks"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_2.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, folderLock_2.deserializeFolderLock)(itm);
            })
            : [];
    if (!(val.limit == void 0) && !(0, json_1.sdIsString)(val.limit)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "limit" of type "FolderLocks"',
        });
    }
    const limit = val.limit == void 0 ? void 0 : val.limit;
    if (!(val.next_marker == void 0) && !(0, json_1.sdIsString)(val.next_marker)) {
        throw new errors_1.BoxSdkError({

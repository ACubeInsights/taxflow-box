...
function deserializeFileRequestTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize FileRequestTypeField" });
}
...
function serializeFileRequest(val) {
    return {
        ...
        ['folder']: (0, folderMini_1.serializeFolderMini)(val.folder),
        ['url']: val.url,
        ['etag']: val.etag,
        ...
        ['updated_by']: val.updatedBy == void 0
            ? val.updatedBy
            : (0, userMini_1.serializeUserMini)(val.updatedBy),
        ['updated_at']: (0, utils_1.serializeDateTime)(val.updatedAt),
    };
}
function deserializeFileRequest(val) {
    if (!(0, json_3.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "FileRequest"' });
    }
    if (val.id == void 0) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.title == void 0) && !(0, json_2.sdIsString)(val.title)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.is_email_required == void 0) &&
        !(0, json_1.sdIsBoolean)(val.is_email_required)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.is_description_required == void 0) &&
        !(0, json_1.sdIsBoolean)(val.is_description_required)) {
        throw new errors_1.BoxSdkError({
    ...
    const folder = (0, folderMini_2.deserializeFolderMini)(val.folder);
    if (!(val.url == void 0) && !(0, json_2.sdIsString)(val.url)) {
        throw new errors_1.BoxSdkError({
    ...
    const updatedBy = val.updated_by == void 0 ? void 0 : (0, userMini_2.deserializeUserMini)(val.updated_by);
    if (val.updated_at == void 0) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting "updated_at" of type "FileRequest" to be defined',
        });
    }
    if (!(0, json_2.sdIsString)(val.updated_at)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "updated_at" of type "FileRequest"',
        });
    }
    const updatedAt = (0, utils_2.deserializeDateTime)(val.updated_at);
    return {
        id: id,
        type: type,
        title: title,

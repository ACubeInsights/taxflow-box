...
function deserializeMetadataBase(val) {
    if (!(0, json_3.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "MetadataBase"' });
    }
    if (!(val.$parent == void 0) && !(0, json_2.sdIsString)(val.$parent)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "$parent" of type "MetadataBase"',
        });
    }
    const parent = val.$parent == void 0 ? void 0 : val.$parent;
    if (!(val.$template == void 0) && !(0, json_2.sdIsString)(val.$template)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.$version == void 0) && !(0, json_1.sdIsNumber)(val.$version)) {
        throw new errors_1.BoxSdkError({

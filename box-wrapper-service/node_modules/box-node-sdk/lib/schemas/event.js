...
const eventSourceResource_1 = require("./eventSourceResource.js");
const eventSourceResource_2 = require("./eventSourceResource.js");
...
function deserializeEventEventTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize EventEventTypeField" });
}
function serializeEvent(val) {
    return {
        ...
        ['recorded_at']: val.recordedAt == void 0
            ? val.recordedAt
            : (0, utils_1.serializeDateTime)(val.recordedAt),
        ...
        ['source']: val.source == void 0
            ? val.source
            : (0, eventSourceResource_1.serializeEventSourceResource)(val.source),
        ['additional_details']: val.additionalDetails == void 0
            ? val.additionalDetails
            : Object.fromEntries(Object.entries(val.additionalDetails).map(([k, v]) => [
                k,
                (function (v) {
                    return v;
                })(v),
...
function deserializeEvent(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "Event"' });
    }
    ...
    if (!(val.recorded_at == void 0) && !(0, json_1.sdIsString)(val.recorded_at)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "recorded_at" of type "Event"',
        });
    }
    const recordedAt = val.recorded_at == void 0 ? void 0 : (0, utils_2.deserializeDateTime)(val.recorded_at);
    if (!(val.event_id == void 0) && !(0, json_1.sdIsString)(val.event_id)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.session_id == void 0) && !(0, json_1.sdIsString)(val.session_id)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "session_id" of type "Event"',
        });
    }
    const sessionId = val.session_id == void 0 ? void 0 : val.session_id;
    const source = val.source == void 0 ? void 0 : (0, eventSourceResource_2.deserializeEventSourceResource)(val.source);
    if (!(val.additional_details == void 0) && !(0, json_2.sdIsMap)(val.additional_details)) {
        throw new errors_1.BoxSdkError({
    ...
    const additionalDetails = val.additional_details == void 0
        ? void 0
        : (0, json_2.sdIsMap)(val.additional_details)
            ? Object.fromEntries(Object.entries(val.additional_details).map(([k, v]) => [
                k,
                (function (v) {
                    return v;
                })(v),

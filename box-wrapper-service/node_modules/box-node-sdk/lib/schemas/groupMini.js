...
const groupBase_1 = require("./groupBase.js");
const groupBase_2 = require("./groupBase.js");
const groupBase_3 = require("./groupBase.js");
const errors_1 = require("../box/errors.js");
const json_1 = require("../serialization/json.js");
const json_2 = require("../serialization/json.js");
class GroupMini extends groupBase_3.GroupBase {
    constructor(fields) {
        super(fields);
...
function serializeGroupMini(val) {
    const base = (0, groupBase_2.serializeGroupBase)(val);
    if (!(0, json_2.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "GroupMini"' });
    }
...
//# sourceMappingURL=groupMini.js.map
...
const aiDialogueHistory_1 = require("./aiDialogueHistory.js");
const aiDialogueHistory_2 = require("./aiDialogueHistory.js");
const aiTextGenAgent_1 = require("./aiTextGenAgent.js");
const aiTextGenAgent_2 = require("./aiTextGenAgent.js");
...
function deserializeAiTextGenItemsField(val) {
    ...
    if (!(val.content == void 0) && !(0, json_1.sdIsString)(val.content)) {
        throw new errors_1.BoxSdkError({
    ...
    return {
        ...
        ['dialogue_history']: val.dialogueHistory == void 0
            ...
            : val.dialogueHistory.map(function (item) {
                return (0, aiDialogueHistory_1.serializeAiDialogueHistory)(item);
            }),
        ['ai_agent']: val.aiAgent == void 0
            ? val.aiAgent
            : (0, aiTextGenAgent_1.serializeAiTextGenAgent)(val.aiAgent),
    };
}
function deserializeAiTextGen(val) {
    if (!(0, json_3.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "AiTextGen"' });
    }
    ...
    if (!(0, json_1.sdIsString)(val.prompt)) {
        throw new errors_1.BoxSdkError({
    ...
    const items = (0, json_2.sdIsList)(val.items)
        ...
        : [];
    if (!(val.dialogue_history == void 0) && !(0, json_2.sdIsList)(val.dialogue_history)) {
        throw new errors_1.BoxSdkError({
    ...
    const dialogueHistory = val.dialogue_history == void 0
        ? void 0
        : (0, json_2.sdIsList)(val.dialogue_history)
            ? val.dialogue_history.map(function (itm) {
                return (0, aiDialogueHistory_2.deserializeAiDialogueHistory)(itm);
            })
            : [];
    const aiAgent = val.ai_agent == void 0 ? void 0 : (0, aiTextGenAgent_2.deserializeAiTextGenAgent)(val.ai_agent);
    return {
        prompt: prompt,
        items: items,
...
//# sourceMappingURL=aiTextGen.js.map
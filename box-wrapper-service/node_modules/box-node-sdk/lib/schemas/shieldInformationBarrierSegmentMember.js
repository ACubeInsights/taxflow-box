...
const shieldInformationBarrierSegmentMemberBase_1 = require("./shieldInformationBarrierSegmentMemberBase.js");
const shieldInformationBarrierSegmentMemberMini_1 = require("./shieldInformationBarrierSegmentMemberMini.js");
const shieldInformationBarrierBase_1 = require("./shieldInformationBarrierBase.js");
const shieldInformationBarrierBase_2 = require("./shieldInformationBarrierBase.js");
const userBase_1 = require("./userBase.js");
const userBase_2 = require("./userBase.js");
...
function serializeShieldInformationBarrierSegmentMember(val) {
    const base = (0, shieldInformationBarrierSegmentMemberMini_1.serializeShieldInformationBarrierSegmentMemberMini)(val);
...
function deserializeShieldInformationBarrierSegmentMember(val) {
    ...
    const createdBy = val.created_by == void 0 ? void 0 : (0, userBase_2.deserializeUserBase)(val.created_by);
    ...
    const updatedBy = val.updated_by == void 0 ? void 0 : (0, userBase_2.deserializeUserBase)(val.updated_by);
    const user = val.user == void 0 ? void 0 : (0, userBase_2.deserializeUserBase)(val.user);
    if (!(val.id == void 0) && !(0, json_1.sdIsString)(val.id)) {
        throw new errors_1.BoxSdkError({
    ...
    const type = val.type == void 0
        ? void 0
        : (0, shieldInformationBarrierSegmentMemberBase_1.deserializeShieldInformationBarrierSegmentMemberBaseTypeField)(val.type);
    return {
...
//# sourceMappingURL=shieldInformationBarrierSegmentMember.js.map
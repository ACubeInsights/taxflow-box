...
const item_1 = require("./item.js");
const item_2 = require("./item.js");
...
function deserializeItemsOrderField(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "ItemsOrderField"' });
    }
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, item_1.serializeItem)(item);
            }),
    };
}
function deserializeItems(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "Items"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, item_2.deserializeItem)(itm);
            })
            : [];
    return {
        limit: limit,

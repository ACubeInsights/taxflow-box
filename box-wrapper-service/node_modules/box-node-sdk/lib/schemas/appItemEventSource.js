...
const groupMini_1 = require("./groupMini.js");
const groupMini_2 = require("./groupMini.js");
...
function serializeAppItemEventSource(val) {
    return {
        ...
        ['group']: val.group == void 0 ? val.group : (0, groupMini_1.serializeGroupMini)(val.group),
    };
}
function deserializeAppItemEventSource(val) {
    ...
    if (!(0, json_1.sdIsString)(val.app_item_type)) {
        throw new errors_1.BoxSdkError({
    ...
    const group = val.group == void 0 ? void 0 : (0, groupMini_2.deserializeGroupMini)(val.group);
    return {
        id: id,
        type: type,
...
//# sourceMappingURL=appItemEventSource.js.map
...
const shieldInformationBarrierSegmentMember_1 = require("./shieldInformationBarrierSegmentMember.js");
const shieldInformationBarrierSegmentMember_2 = require("./shieldInformationBarrierSegmentMember.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, shieldInformationBarrierSegmentMember_1.serializeShieldInformationBarrierSegmentMember)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, shieldInformationBarrierSegmentMember_2.deserializeShieldInformationBarrierSegmentMember)(itm);
            })
            : [];
    return {
        limit: limit,

...
const userFull_1 = require("./userFull.js");
const userFull_2 = require("./userFull.js");
...
function deserializeUsersOrderField(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "UsersOrderField"' });
    }
    if (!(val.by == void 0) && !(0, json_2.sdIsString)(val.by)) {
        throw new errors_1.BoxSdkError({
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, userFull_1.serializeUserFull)(item);
            }),
    };
}
function deserializeUsers(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "Users"' });
    }
    ...
    if (!(val.order == void 0) && !(0, json_3.sdIsList)(val.order)) {
        throw new errors_1.BoxSdkError({
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, userFull_2.deserializeUserFull)(itm);
            })
            : [];
    return {
        limit: limit,

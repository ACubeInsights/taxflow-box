...
function deserializeRealtimeServer(val) {
    if (!(0, json_3.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "RealtimeServer"' });
    }
    ...
    if (!(val.ttl == void 0) && !(0, json_2.sdIsString)(val.ttl)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "ttl" of type "RealtimeServer"',
        });
    }
    const ttl = val.ttl == void 0 ? void 0 : val.ttl;
    if (!(val.max_retries == void 0) && !(0, json_2.sdIsString)(val.max_retries)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.retry_timeout == void 0) && !(0, json_1.sdIsNumber)(val.retry_timeout)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=realtimeServer.js.map
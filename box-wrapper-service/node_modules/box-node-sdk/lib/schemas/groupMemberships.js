...
const groupMembership_1 = require("./groupMembership.js");
const groupMembership_2 = require("./groupMembership.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, groupMembership_1.serializeGroupMembership)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, groupMembership_2.deserializeGroupMembership)(itm);
            })
            : [];
    return {
...
//# sourceMappingURL=groupMemberships.js.map
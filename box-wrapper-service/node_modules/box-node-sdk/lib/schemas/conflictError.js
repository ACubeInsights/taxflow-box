...
const clientError_1 = require("./clientError.js");
const clientError_2 = require("./clientError.js");
const clientError_3 = require("./clientError.js");
const fileConflict_1 = require("./fileConflict.js");
const fileConflict_2 = require("./fileConflict.js");
    ...
    return {
        ['conflicts']: val.conflicts == void 0
            ...
            : val.conflicts.map(function (item) {
                return (0, fileConflict_1.serializeFileConflict)(item);
            }),
    };
}
function deserializeConflictErrorContextInfoField(val) {
    ...
    if (!(val.conflicts == void 0) && !(0, json_3.sdIsList)(val.conflicts)) {
        throw new errors_1.BoxSdkError({
    ...
    const conflicts = val.conflicts == void 0
        ? void 0
        : (0, json_3.sdIsList)(val.conflicts)
            ? val.conflicts.map(function (itm) {
                return (0, fileConflict_2.deserializeFileConflict)(itm);
            })
            : [];
    return { conflicts: conflicts };
}
function serializeConflictError(val) {
    const base = (0, clientError_3.serializeClientError)(val);
    if (!(0, json_4.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "ConflictError"' });
    }
...
function deserializeConflictError(val) {
    ...
    const type = val.type == void 0 ? void 0 : (0, clientError_1.deserializeClientErrorTypeField)(val.type);
    if (!(val.status == void 0) && !(0, json_1.sdIsNumber)(val.status)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting number for "status" of type "ConflictError"',
        });
    }
    const status = val.status == void 0 ? void 0 : val.status;
    const code = val.code == void 0 ? void 0 : (0, clientError_2.deserializeClientErrorCodeField)(val.code);
    ...
    if (!(val.context_info == void 0) && !(0, json_4.sdIsMap)(val.context_info)) {
        throw new errors_1.BoxSdkError({
    ...
    const contextInfo = val.context_info == void 0
        ? void 0
        : (0, json_4.sdIsMap)(val.context_info)
            ...
            : {};
    if (!(val.help_url == void 0) && !(0, json_2.sdIsString)(val.help_url)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "help_url" of type "ConflictError"',
        });
    }
    const helpUrl = val.help_url == void 0 ? void 0 : val.help_url;
    if (!(val.request_id == void 0) && !(0, json_2.sdIsString)(val.request_id)) {
        throw new errors_1.BoxSdkError({

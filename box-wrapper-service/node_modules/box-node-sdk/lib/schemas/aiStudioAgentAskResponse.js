...
const aiStudioAgentLongTextToolResponse_1 = require("./aiStudioAgentLongTextToolResponse.js");
const aiStudioAgentLongTextToolResponse_2 = require("./aiStudioAgentLongTextToolResponse.js");
const aiStudioAgentBasicTextToolResponse_1 = require("./aiStudioAgentBasicTextToolResponse.js");
const aiStudioAgentBasicTextToolResponse_2 = require("./aiStudioAgentBasicTextToolResponse.js");
const aiStudioAgentSpreadsheetToolResponse_1 = require("./aiStudioAgentSpreadsheetToolResponse.js");
const aiStudioAgentSpreadsheetToolResponse_2 = require("./aiStudioAgentSpreadsheetToolResponse.js");
...
function serializeAiStudioAgentAskResponse(val) {
    return {
        ...
        ['long_text']: val.longText == void 0
            ? val.longText
            : (0, aiStudioAgentLongTextToolResponse_1.serializeAiStudioAgentLongTextToolResponse)(val.longText),
        ['basic_text']: val.basicText == void 0
            ? val.basicText
            : (0, aiStudioAgentBasicTextToolResponse_1.serializeAiStudioAgentBasicTextToolResponse)(val.basicText),
        ['basic_image']: val.basicImage == void 0
            ? val.basicImage
            : (0, aiStudioAgentBasicTextToolResponse_1.serializeAiStudioAgentBasicTextToolResponse)(val.basicImage),
        ['spreadsheet']: val.spreadsheet == void 0
            ? val.spreadsheet
            : (0, aiStudioAgentSpreadsheetToolResponse_1.serializeAiStudioAgentSpreadsheetToolResponse)(val.spreadsheet),
        ['long_text_multi']: val.longTextMulti == void 0
            ? val.longTextMulti
            : (0, aiStudioAgentLongTextToolResponse_1.serializeAiStudioAgentLongTextToolResponse)(val.longTextMulti),
        ['basic_text_multi']: val.basicTextMulti == void 0
            ? val.basicTextMulti
            : (0, aiStudioAgentBasicTextToolResponse_1.serializeAiStudioAgentBasicTextToolResponse)(val.basicTextMulti),
        ['basic_image_multi']: val.basicImageMulti == void 0
            ? val.basicImageMulti
            : (0, aiStudioAgentBasicTextToolResponse_1.serializeAiStudioAgentBasicTextToolResponse)(val.basicImageMulti),
    };
}
function deserializeAiStudioAgentAskResponse(val) {
    ...
    if (!(0, json_1.sdIsString)(val.access_state)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_1.sdIsString)(val.description)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.custom_instructions == void 0) &&
        !(0, json_1.sdIsString)(val.custom_instructions)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.suggested_questions == void 0) &&
        !(0, json_2.sdIsList)(val.suggested_questions)) {
        throw new errors_1.BoxSdkError({
    ...
    const longText = val.long_text == void 0
        ? void 0
        : (0, aiStudioAgentLongTextToolResponse_2.deserializeAiStudioAgentLongTextToolResponse)(val.long_text);
    const basicText = val.basic_text == void 0
        ? void 0
        : (0, aiStudioAgentBasicTextToolResponse_2.deserializeAiStudioAgentBasicTextToolResponse)(val.basic_text);
    const basicImage = val.basic_image == void 0
        ? void 0
        : (0, aiStudioAgentBasicTextToolResponse_2.deserializeAiStudioAgentBasicTextToolResponse)(val.basic_image);
    const spreadsheet = val.spreadsheet == void 0
        ? void 0
        : (0, aiStudioAgentSpreadsheetToolResponse_2.deserializeAiStudioAgentSpreadsheetToolResponse)(val.spreadsheet);
    const longTextMulti = val.long_text_multi == void 0
        ? void 0
        : (0, aiStudioAgentLongTextToolResponse_2.deserializeAiStudioAgentLongTextToolResponse)(val.long_text_multi);
    const basicTextMulti = val.basic_text_multi == void 0
        ? void 0
        : (0, aiStudioAgentBasicTextToolResponse_2.deserializeAiStudioAgentBasicTextToolResponse)(val.basic_text_multi);
    const basicImageMulti = val.basic_image_multi == void 0
        ? void 0
        : (0, aiStudioAgentBasicTextToolResponse_2.deserializeAiStudioAgentBasicTextToolResponse)(val.basic_image_multi);
    return {
        type: type,
...
//# sourceMappingURL=aiStudioAgentAskResponse.js.map
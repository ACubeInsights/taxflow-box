...
const fileVersionBase_2 = require("./fileVersionBase.js");
const fileVersionBase_3 = require("./fileVersionBase.js");
const errors_1 = require("../box/errors.js");
const json_1 = require("../serialization/json.js");
const json_2 = require("../serialization/json.js");
class FileVersionMini extends fileVersionBase_3.FileVersionBase {
    constructor(fields) {
        super(fields);
...
function serializeFileVersionMini(val) {
    const base = (0, fileVersionBase_2.serializeFileVersionBase)(val);
    if (!(0, json_2.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "FileVersionMini"' });
    }
...
//# sourceMappingURL=fileVersionMini.js.map
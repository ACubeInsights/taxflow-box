...
const metadataTemplate_1 = require("./metadataTemplate.js");
const metadataTemplate_2 = require("./metadataTemplate.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, metadataTemplate_1.serializeMetadataTemplate)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, metadataTemplate_2.deserializeMetadataTemplate)(itm);
            })
            : [];
    return {
        limit: limit,

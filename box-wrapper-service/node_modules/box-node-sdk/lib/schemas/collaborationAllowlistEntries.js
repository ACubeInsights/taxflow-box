...
const collaborationAllowlistEntry_1 = require("./collaborationAllowlistEntry.js");
const collaborationAllowlistEntry_2 = require("./collaborationAllowlistEntry.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, collaborationAllowlistEntry_1.serializeCollaborationAllowlistEntry)(item);
            }),
    };
}
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, collaborationAllowlistEntry_2.deserializeCollaborationAllowlistEntry)(itm);
            })
            : [];
    return {
        limit: limit,

...
const event_1 = require("./event.js");
const event_2 = require("./event.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, event_1.serializeEvent)(item);
            }),
    };
}
function deserializeEvents(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "Events"' });
    }
    if (!(val.chunk_size == void 0) && !(0, json_1.sdIsNumber)(val.chunk_size)) {
        throw new errors_1.BoxSdkError({
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, event_2.deserializeEvent)(itm);
            })
            : [];
    return {
        chunkSize: chunkSize,

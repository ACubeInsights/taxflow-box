...
function deserializeWebhookMiniTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize WebhookMiniTypeField" });
}
...
function deserializeWebhookMini(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "WebhookMini"' });
    }
    if (!(val.id == void 0) && !(0, json_1.sdIsString)(val.id)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=webhookMini.js.map
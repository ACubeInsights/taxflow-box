...
const fileVersionMini_1 = require("./fileVersionMini.js");
const fileVersionMini_2 = require("./fileVersionMini.js");
const userMini_1 = require("./userMini.js");
const userMini_2 = require("./userMini.js");
...
function deserializeTrashFileTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize TrashFileTypeField" });
}
...
function deserializeTrashFilePathCollectionEntriesField(val) {
    ...
    if (!(val.sequence_id == void 0) && !(0, json_2.sdIsString)(val.sequence_id)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.etag == void 0) && !(0, json_2.sdIsString)(val.etag)) {
        throw new errors_1.BoxSdkError({
...
function deserializeTrashFilePathCollectionField(val) {
    ...
    if (!(0, json_1.sdIsNumber)(val.total_count)) {
        throw new errors_1.BoxSdkError({
...
function serializeTrashFile(val) {
    return {
        ...
        ['created_at']: (0, utils_1.serializeDateTime)(val.createdAt),
        ['modified_at']: (0, utils_1.serializeDateTime)(val.modifiedAt),
        ...
        ['modified_by']: (0, userMini_1.serializeUserMini)(val.modifiedBy),
        ['owned_by']: (0, userMini_1.serializeUserMini)(val.ownedBy),
...
function deserializeTrashFile(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "TrashFile"' });
    }
    if (val.id == void 0) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_2.sdIsString)(val.sequence_id)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_2.sdIsString)(val.sha1)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_2.sdIsString)(val.description)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_2.sdIsString)(val.created_at)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "created_at" of type "TrashFile"',
        });
    }
    const createdAt = (0, utils_2.deserializeDateTime)(val.created_at);
    if (val.modified_at == void 0) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting "modified_at" of type "TrashFile" to be defined',
        });
    }
    if (!(0, json_2.sdIsString)(val.modified_at)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "modified_at" of type "TrashFile"',
        });
    }
    const modifiedAt = (0, utils_2.deserializeDateTime)(val.modified_at);
    if (!(val.trashed_at == void 0) && !(0, json_2.sdIsString)(val.trashed_at)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.purged_at == void 0) && !(0, json_2.sdIsString)(val.purged_at)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.content_created_at == void 0) &&
        !(0, json_2.sdIsString)(val.content_created_at)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.content_modified_at == void 0) &&
        !(0, json_2.sdIsString)(val.content_modified_at)) {
        throw new errors_1.BoxSdkError({
    ...
    const modifiedBy = (0, userMini_2.deserializeUserMini)(val.modified_by);
    if (val.owned_by == void 0) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting "owned_by" of type "TrashFile" to be defined',
        });
    }
    const ownedBy = (0, userMini_2.deserializeUserMini)(val.owned_by);
    if (!(val.shared_link == void 0) && !(0, json_2.sdIsString)(val.shared_link)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "shared_link" of type "TrashFile"',
        });
    }
    const sharedLink = val.shared_link == void 0 ? void 0 : val.shared_link;
    const parent = val.parent == void 0 ? void 0 : (0, folderMini_2.deserializeFolderMini)(val.parent);
...
function deserializeTrashFileInput(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "TrashFileInput"' });
    }
    if (val.id == void 0) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=trashFile.js.map
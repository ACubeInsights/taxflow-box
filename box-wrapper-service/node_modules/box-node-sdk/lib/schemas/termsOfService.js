...
const termsOfServiceBase_3 = require("./termsOfServiceBase.js");
const errors_1 = require("../box/errors.js");
const json_1 = require("../serialization/json.js");
const json_2 = require("../serialization/json.js");
class TermsOfService extends termsOfServiceBase_3.TermsOfServiceBase {
    constructor(fields) {
        super(fields);
...
function serializeTermsOfService(val) {
    const base = (0, termsOfServiceBase_2.serializeTermsOfServiceBase)(val);
    if (!(0, json_2.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "TermsOfService"' });
    }
...
function deserializeTermsOfService(val) {
    ...
    const type = (0, termsOfServiceBase_1.deserializeTermsOfServiceBaseTypeField)(val.type);
    return {
        status: status,

...
const commentFull_1 = require("./commentFull.js");
const commentFull_2 = require("./commentFull.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, commentFull_1.serializeCommentFull)(item);
            }),
    };
}
function deserializeComments(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "Comments"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, commentFull_2.deserializeCommentFull)(itm);
            })
            : [];
    return {

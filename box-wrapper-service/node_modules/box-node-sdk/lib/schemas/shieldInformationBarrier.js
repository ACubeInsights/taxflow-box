...
const enterpriseBase_1 = require("./enterpriseBase.js");
const enterpriseBase_2 = require("./enterpriseBase.js");
...
function serializeShieldInformationBarrier(val) {
    return {
        ...
        ['enterprise']: val.enterprise == void 0
            ? val.enterprise
            : (0, enterpriseBase_1.serializeEnterpriseBase)(val.enterprise),
        ...
        ['enabled_at']: val.enabledAt == void 0
            ? val.enabledAt
            : (0, utils_1.serializeDateTime)(val.enabledAt),
        ['enabled_by']: val.enabledBy == void 0
            ? val.enabledBy
            : (0, userBase_1.serializeUserBase)(val.enabledBy),
    };
}
function deserializeShieldInformationBarrier(val) {
    ...
    const enterprise = val.enterprise == void 0
        ? void 0
        : (0, enterpriseBase_2.deserializeEnterpriseBase)(val.enterprise);
    ...
    if (!(val.enabled_at == void 0) && !(0, json_1.sdIsString)(val.enabled_at)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "enabled_at" of type "ShieldInformationBarrier"',
        });
    }
    const enabledAt = val.enabled_at == void 0 ? void 0 : (0, utils_2.deserializeDateTime)(val.enabled_at);
    const enabledBy = val.enabled_by == void 0 ? void 0 : (0, userBase_2.deserializeUserBase)(val.enabled_by);
    return {
        id: id,
        type: type,
...
//# sourceMappingURL=shieldInformationBarrier.js.map
...
function deserializeUserBaseTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize UserBaseTypeField" });
}
...
function deserializeUserBase(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "UserBase"' });
    }
    if (val.id == void 0) {
...
function deserializeUserBaseInput(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "UserBaseInput"' });
    }
    if (val.id == void 0) {
        throw new errors_1.BoxSdkError({

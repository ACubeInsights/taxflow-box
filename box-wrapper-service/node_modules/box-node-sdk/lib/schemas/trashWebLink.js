...
function deserializeTrashWebLinkTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize TrashWebLinkTypeField" });
}
...
function deserializeTrashWebLink(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "TrashWebLink"' });
    }
...
//# sourceMappingURL=trashWebLink.js.map
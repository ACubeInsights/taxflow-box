...
const workflowMini_1 = require("./workflowMini.js");
const workflowMini_2 = require("./workflowMini.js");
...
function deserializeWorkflowFlowsTriggerScopeField(val) {
    ...
    if (!(val.ref == void 0) && !(0, json_2.sdIsString)(val.ref)) {
        throw new errors_1.BoxSdkError({
...
function deserializeWorkflowFlowsTriggerField(val) {
    ...
    if (!(val.scope == void 0) && !(0, json_3.sdIsList)(val.scope)) {
        throw new errors_1.BoxSdkError({
...
function deserializeWorkflowFlowsOutcomesField(val) {
    ...
    if (!(val.if_rejected == void 0) && !(0, json_3.sdIsList)(val.if_rejected)) {
        throw new errors_1.BoxSdkError({
    ...
    const ifRejected = val.if_rejected == void 0
        ? void 0
        : (0, json_3.sdIsList)(val.if_rejected)
...
function deserializeWorkflowFlowsField(val) {
    ...
    if (!(val.outcomes == void 0) && !(0, json_3.sdIsList)(val.outcomes)) {
        throw new errors_1.BoxSdkError({
    ...
    const outcomes = val.outcomes == void 0
        ? void 0
        : (0, json_3.sdIsList)(val.outcomes)
...
function serializeWorkflow(val) {
    const base = (0, workflowMini_2.serializeWorkflowMini)(val);
    if (!(0, json_4.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "Workflow"' });
    }
...
function deserializeWorkflow(val) {
    ...
    if (!(val.flows == void 0) && !(0, json_3.sdIsList)(val.flows)) {
        throw new errors_1.BoxSdkError({
    ...
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : (0, workflowMini_1.deserializeWorkflowMiniTypeField)(val.type);
    if (!(val.name == void 0) && !(0, json_2.sdIsString)(val.name)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.is_enabled == void 0) && !(0, json_1.sdIsBoolean)(val.is_enabled)) {
        throw new errors_1.BoxSdkError({

...
const taskAssignment_1 = require("./taskAssignment.js");
const taskAssignment_2 = require("./taskAssignment.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, taskAssignment_1.serializeTaskAssignment)(item);
            }),
    };
}
function deserializeTaskAssignments(val) {
    if (!(0, json_3.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "TaskAssignments"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_2.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, taskAssignment_2.deserializeTaskAssignment)(itm);
            })
            : [];

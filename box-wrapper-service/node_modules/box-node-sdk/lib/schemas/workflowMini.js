...
function deserializeWorkflowMiniTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize WorkflowMiniTypeField" });
}
...
function deserializeWorkflowMini(val) {
    if (!(0, json_3.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "WorkflowMini"' });
    }
...
//# sourceMappingURL=workflowMini.js.map
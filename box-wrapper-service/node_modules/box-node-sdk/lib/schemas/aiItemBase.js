...
function deserializeAiItemBaseTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize AiItemBaseTypeField" });
}
...
function deserializeAiItemBase(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "AiItemBase"' });
    }
    if (val.id == void 0) {
...
function deserializeAiItemBaseInput(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "AiItemBaseInput"' });
    }
    if (val.id == void 0) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=aiItemBase.js.map
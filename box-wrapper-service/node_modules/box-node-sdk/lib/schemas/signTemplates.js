...
const signTemplate_1 = require("./signTemplate.js");
const signTemplate_2 = require("./signTemplate.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, signTemplate_1.serializeSignTemplate)(item);
            }),
    };
}
function deserializeSignTemplates(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "SignTemplates"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, signTemplate_2.deserializeSignTemplate)(itm);
            })
            : [];
    return {
        limit: limit,

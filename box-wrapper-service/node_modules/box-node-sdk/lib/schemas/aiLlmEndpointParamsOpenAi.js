...
function deserializeAiLlmEndpointParamsOpenAi(val) {
    ...
    if (!(val.frequency_penalty == void 0) &&
        !(0, json_1.sdIsNumber)(val.frequency_penalty)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.presence_penalty == void 0) && !(0, json_1.sdIsNumber)(val.presence_penalty)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.stop == void 0) && !(0, json_2.sdIsString)(val.stop)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=aiLlmEndpointParamsOpenAi.js.map
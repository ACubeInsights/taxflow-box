...
const shieldInformationBarrierSegmentRestrictionBase_1 = require("./shieldInformationBarrierSegmentRestrictionBase.js");
const shieldInformationBarrierSegmentRestrictionBase_2 = require("./shieldInformationBarrierSegmentRestrictionBase.js");
...
function serializeShieldInformationBarrierSegmentRestrictionMini(val) {
    const base = (0, shieldInformationBarrierSegmentRestrictionBase_2.serializeShieldInformationBarrierSegmentRestrictionBase)(val);
...
function deserializeShieldInformationBarrierSegmentRestrictionMini(val) {
    ...
    const type = val.type == void 0
        ? void 0
        : (0, shieldInformationBarrierSegmentRestrictionBase_1.deserializeShieldInformationBarrierSegmentRestrictionBaseTypeField)(val.type);
    if (!(val.id == void 0) && !(0, json_1.sdIsString)(val.id)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=shieldInformationBarrierSegmentRestrictionMini.js.map
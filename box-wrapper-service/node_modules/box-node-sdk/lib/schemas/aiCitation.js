...
function deserializeAiCitationTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize AiCitationTypeField" });
}
...
function deserializeAiCitation(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "AiCitation"' });
    }
...
//# sourceMappingURL=aiCitation.js.map
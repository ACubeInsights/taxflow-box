...
const group_1 = require("./group.js");
const group_2 = require("./group.js");
...
class GroupFull extends group_2.Group {
    constructor(fields) {
        super(fields);
...
function deserializeGroupFullPermissionsField(val) {
    ...
    if (!(val.can_invite_as_collaborator == void 0) &&
        !(0, json_1.sdIsBoolean)(val.can_invite_as_collaborator)) {
        throw new errors_1.BoxSdkError({
...
function serializeGroupFull(val) {
    const base = (0, group_1.serializeGroup)(val);

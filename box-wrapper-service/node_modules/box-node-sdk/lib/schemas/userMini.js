...
function serializeUserMini(val) {
    const base = (0, userBase_2.serializeUserBase)(val);
    if (!(0, json_2.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "UserMini"' });
    }
...
//# sourceMappingURL=userMini.js.map
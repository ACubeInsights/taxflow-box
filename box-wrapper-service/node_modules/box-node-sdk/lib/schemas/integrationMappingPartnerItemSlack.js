...
function deserializeIntegrationMappingPartnerItemSlack(val) {
    ...
    if (!(val.slack_workspace_id == void 0) &&
        !(0, json_1.sdIsString)(val.slack_workspace_id)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.slack_org_id == void 0) && !(0, json_1.sdIsString)(val.slack_org_id)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=integrationMappingPartnerItemSlack.js.map
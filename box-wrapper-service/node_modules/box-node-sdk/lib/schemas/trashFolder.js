...
function deserializeTrashFolderTypeField(val) {
    ...
    throw new errors_1.BoxSdkError({ message: "Can't deserialize TrashFolderTypeField" });
}
...
function serializeTrashFolder(val) {
    return {
        ...
        ['created_by']: (0, userMini_1.serializeUserMini)(val.createdBy),
...
function deserializeTrashFolder(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "TrashFolder"' });
    }
    if (val.id == void 0) {
        throw new errors_1.BoxSdkError({
    ...
    const createdBy = (0, userMini_2.deserializeUserMini)(val.created_by);
    ...
    if (!(val.folder_upload_email == void 0) &&
        !(0, json_2.sdIsString)(val.folder_upload_email)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=trashFolder.js.map
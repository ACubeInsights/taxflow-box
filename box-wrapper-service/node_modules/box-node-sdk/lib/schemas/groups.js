...
const groupFull_1 = require("./groupFull.js");
const groupFull_2 = require("./groupFull.js");
    ...
    return {
        ...
        ['entries']: val.entries == void 0
            ...
            : val.entries.map(function (item) {
                return (0, groupFull_1.serializeGroupFull)(item);
            }),
    };
}
function deserializeGroups(val) {
    if (!(0, json_4.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "Groups"' });
    }
    ...
    const entries = val.entries == void 0
        ...
        : (0, json_3.sdIsList)(val.entries)
            ? val.entries.map(function (itm) {
                return (0, groupFull_2.deserializeGroupFull)(itm);
            })
            : [];
    return {

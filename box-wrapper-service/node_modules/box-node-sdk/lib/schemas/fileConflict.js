...
class FileConflict extends fileMini_2.FileMini {
    constructor(fields) {
        super(fields);
    }
}
...
function serializeFileConflict(val) {
    ...
    if (!(0, json_2.sdIsMap)(base)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "FileConflict"' });
    }
...
function deserializeFileConflict(val) {
    ...
    if (!(val.sequence_id == void 0) && !(0, json_1.sdIsString)(val.sequence_id)) {
    ...
    if (!(val.sha1 == void 0) && !(0, json_1.sdIsString)(val.sha1)) {
        throw new errors_1.BoxSdkError({
    ...
    const id = val.id;
    if (!(val.etag == void 0) && !(0, json_1.sdIsString)(val.etag)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=fileConflict.js.map
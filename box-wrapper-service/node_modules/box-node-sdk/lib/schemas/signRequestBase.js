...
const signRequestPrefillTag_2 = require("./signRequestPrefillTag.js");
    ...
    return {
        ...
        ['prefill_tags']: val.prefillTags == void 0
            ...
            : val.prefillTags.map(function (item) {
                return (0, signRequestPrefillTag_1.serializeSignRequestPrefillTag)(item);
            }),
...
function deserializeSignRequestBase(val) {
    if (!(0, json_5.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "SignRequestBase"' });
    }
    ...
    const prefillTags = val.prefill_tags == void 0
        ...
        : (0, json_4.sdIsList)(val.prefill_tags)
            ? val.prefill_tags.map(function (itm) {
                return (0, signRequestPrefillTag_2.deserializeSignRequestPrefillTag)(itm);
            })
            : [];

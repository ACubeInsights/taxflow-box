...
function deserializeBaseUrls(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "BaseUrls"' });
    }
    ...
    if (!(0, json_1.sdIsString)(val.base_url)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_1.sdIsString)(val.upload_url)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_1.sdIsString)(val.oauth2_url)) {
        throw new errors_1.BoxSdkError({
...
function deserializeBaseUrlsInput(val) {
    if (!(0, json_2.sdIsMap)(val)) {
        throw new errors_1.BoxSdkError({ message: 'Expecting a map for "BaseUrlsInput"' });
    }
    if (!(val.baseUrl == void 0) && !(0, json_1.sdIsString)(val.baseUrl)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "baseUrl" of type "BaseUrlsInput"',
        });
    }
    const baseUrl = val.baseUrl == void 0 ? void 0 : val.baseUrl;
    if (!(val.uploadUrl == void 0) && !(0, json_1.sdIsString)(val.uploadUrl)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "uploadUrl" of type "BaseUrlsInput"',
        });
    }
    const uploadUrl = val.uploadUrl == void 0 ? void 0 : val.uploadUrl;
    if (!(val.oauth2Url == void 0) && !(0, json_1.sdIsString)(val.oauth2Url)) {
        throw new errors_1.BoxSdkError({

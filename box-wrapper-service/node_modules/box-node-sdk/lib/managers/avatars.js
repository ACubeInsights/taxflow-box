...
const userAvatar_1 = require("../schemas/userAvatar.js");
...
class AvatarsManager {
    ...
    createUserAvatar(userId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (userId, requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, userAvatar_1.deserializeUserAvatar)(response.data)), { rawData: response.data });
        });
    }
    /**

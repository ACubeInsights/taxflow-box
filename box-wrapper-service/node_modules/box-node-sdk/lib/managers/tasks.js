...
const tasks_1 = require("../schemas/tasks.js");
const task_1 = require("../schemas/task.js");
...
class TasksManager {
    ...
    getFileTasks(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, tasks_1.deserializeTasks)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createTask(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, task_1.deserializeTask)(response.data)), { rawData: response.data });
        });
    }
    /**

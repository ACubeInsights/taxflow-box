import { ArchivesV2025R0 } from '../schemas/v2025R0/archivesV2025R0.js';
import { BoxVersionHeaderV2025R0 } from '../parameters/v2025R0/boxVersionHeaderV2025R0.js';
import { ArchiveV2025R0 } from '../schemas/v2025R0/archiveV2025R0.js';
...
export declare class UpdateArchiveByIdV2025R0Optionals {
    readonly requestBody: UpdateArchiveByIdV2025R0RequestBody;
    readonly headers: UpdateArchiveByIdV2025R0Headers;
    readonly cancellationToken?: CancellationToken;
    constructor(fields: Omit<UpdateArchiveByIdV2025R0Optionals, 'requestBody' | 'headers' | 'cancellationToken'> & Partial<Pick<UpdateArchiveByIdV2025R0Optionals, 'requestBody' | 'headers' | 'cancellationToken'>>);
}
...
export declare class UpdateArchiveByIdV2025R0Headers {
    /**
     * Version header. */
    readonly boxVersion: BoxVersionHeaderV2025R0;
    /**
    ...
    constructor(fields: Omit<UpdateArchiveByIdV2025R0Headers, 'boxVersion' | 'extraHeaders'> & Partial<Pick<UpdateArchiveByIdV2025R0Headers, 'boxVersion' | 'extraHeaders'>>);
}
...
export declare class ArchivesManager {
    ...
    constructor(fields: Omit<ArchivesManager, 'networkSession' | 'getArchivesV2025R0' | 'createArchiveV2025R0' | 'deleteArchiveByIdV2025R0' | 'updateArchiveByIdV2025R0'> & Partial<Pick<ArchivesManager, 'networkSession'>>);
    /**
    ...
    /**
       ...
       * @returns {Promise<ArchiveV2025R0>}
       */
    updateArchiveByIdV2025R0(archiveId: string, optionalsInput?: UpdateArchiveByIdV2025R0OptionalsInput): Promise<ArchiveV2025R0>;
}
...
export declare function serializeUpdateArchiveByIdV2025R0RequestBody(val: UpdateArchiveByIdV2025R0RequestBody): SerializedData;
export declare function deserializeUpdateArchiveByIdV2025R0RequestBody(val: SerializedData): UpdateArchiveByIdV2025R0RequestBody;

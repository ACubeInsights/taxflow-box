...
const emailAliases_1 = require("../schemas/emailAliases.js");
const emailAlias_1 = require("../schemas/emailAlias.js");
...
class EmailAliasesManager {
    ...
    getUserEmailAliases(userId_1) {
        return __awaiter(this, arguments, void 0, function* (userId, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/users/', (0, utils_2.toString)(userId), '/email_aliases'),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return Object.assign(Object.assign({}, (0, emailAliases_1.deserializeEmailAliases)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createUserEmailAlias(userId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (userId, requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, emailAlias_1.deserializeEmailAlias)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteUserEmailAliasById(userId_1, emailAliasId_1) {
        return __awaiter(this, arguments, void 0, function* (userId, emailAliasId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/users/', (0, utils_2.toString)(userId), '/email_aliases/', (0, utils_2.toString)(emailAliasId)),
                method: 'DELETE',
                headers: headersMap,
...
function deserializeCreateUserEmailAliasRequestBody(val) {
    ...
    if (!(0, json_1.sdIsString)(val.email)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=emailAliases.js.map
...
const appItem_1 = require("../schemas/appItem.js");
...
class SharedLinksAppItemsManager {
    ...
    findAppItemForSharedLink(headersInput_1) {
        return __awaiter(this, arguments, void 0, function* (headersInput, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({ ['boxapi']: (0, utils_2.toString)(headers.boxapi) }, headers.extraHeaders));
            ...
            return Object.assign(Object.assign({}, (0, appItem_1.deserializeAppItem)(response.data)), { rawData: response.data });
        });
    }
}
exports.SharedLinksAppItemsManager = SharedLinksAppItemsManager;
//# sourceMappingURL=sharedLinksAppItems.js.map
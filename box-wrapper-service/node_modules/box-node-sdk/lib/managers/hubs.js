...
const hubsV2025R0_1 = require("../schemas/v2025R0/hubsV2025R0.js");
const hubV2025R0_1 = require("../schemas/v2025R0/hubV2025R0.js");
const hubCreateRequestV2025R0_1 = require("../schemas/v2025R0/hubCreateRequestV2025R0.js");
const hubUpdateRequestV2025R0_1 = require("../schemas/v2025R0/hubUpdateRequestV2025R0.js");
const hubCopyRequestV2025R0_1 = require("../schemas/v2025R0/hubCopyRequestV2025R0.js");
...
class HubsManager {
    ...
    getHubsV2025R0() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetHubsV2025R0Headers({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, hubsV2025R0_1.deserializeHubsV2025R0)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createHubV2025R0(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                ...
                method: 'POST',
                headers: headersMap,
                data: (0, hubCreateRequestV2025R0_1.serializeHubCreateRequestV2025R0)(requestBody),
            ...
            return Object.assign(Object.assign({}, (0, hubV2025R0_1.deserializeHubV2025R0)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getHubByIdV2025R0(hubId_1) {
        return __awaiter(this, arguments, void 0, function* (hubId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({ ['box-version']: (0, utils_2.toString)(headers.boxVersion) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/hubs/', (0, utils_2.toString)(hubId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
    ...
    updateHubByIdV2025R0(hubId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (hubId, requestBody, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                ...
                method: 'PUT',
                headers: headersMap,
                data: (0, hubUpdateRequestV2025R0_1.serializeHubUpdateRequestV2025R0)(requestBody),
                contentType: 'application/json',
                responseFormat: 'json',
                auth: this.auth,
                networkSession: this.networkSession,
    ...
    copyHubV2025R0(hubId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (hubId, requestBody, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({ ['box-version']: (0, utils_2.toString)(headers.boxVersion) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/hubs/', (0, utils_2.toString)(hubId), '/copy'),
                method: 'POST',
                headers: headersMap,
                data: (0, hubCopyRequestV2025R0_1.serializeHubCopyRequestV2025R0)(requestBody),
                contentType: 'application/json',
                responseFormat: 'json',
                auth: this.auth,
                networkSession: this.networkSession,

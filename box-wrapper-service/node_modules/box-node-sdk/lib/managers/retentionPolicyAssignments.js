...
const retentionPolicyAssignments_1 = require("../schemas/retentionPolicyAssignments.js");
const retentionPolicyAssignment_1 = require("../schemas/retentionPolicyAssignment.js");
const filesUnderRetention_1 = require("../schemas/filesUnderRetention.js");
...
class RetentionPolicyAssignmentsManager {
    ...
    getRetentionPolicyAssignments(retentionPolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (retentionPolicyId, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, retentionPolicyAssignments_1.deserializeRetentionPolicyAssignments)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createRetentionPolicyAssignment(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, retentionPolicyAssignment_1.deserializeRetentionPolicyAssignment)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getFilesUnderRetentionPolicyAssignment(retentionPolicyAssignmentId_1) {
        return __awaiter(this, arguments, void 0, function* (retentionPolicyAssignmentId, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, filesUnderRetention_1.deserializeFilesUnderRetention)(response.data)), { rawData: response.data });
        });
    }
}

...
const fileFull_1 = require("../schemas/fileFull.js");
...
const utils_5 = require("../internal/utils.js");
const utils_6 = require("../internal/utils.js");
...
class FilesManager {
    ...
    getFileById(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_3.prepareParams)(Object.assign({
                ...
                ['x-rep-hints']: (0, utils_4.toString)(headers.xRepHints),
            }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/files/', (0, utils_4.toString)(fileId)),
                method: 'GET',
            ...
            return Object.assign(Object.assign({}, (0, fileFull_1.deserializeFileFull)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    copyFile(fileId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, requestBody, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/files/', (0, utils_4.toString)(fileId), '/copy'),
                method: 'POST',
                params: queryParamsMap,
                headers: headersMap,
    ...
    getFileThumbnailUrl(fileId_1, extension_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, extension, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_3.prepareParams)({
                ['min_height']: (0, utils_4.toString)(queryParams.minHeight),
                ['min_width']: (0, utils_4.toString)(queryParams.minWidth),
                ['max_height']: (0, utils_4.toString)(queryParams.maxHeight),
                ['max_width']: (0, utils_4.toString)(queryParams.maxWidth),
            });
            const headersMap = (0, utils_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const cancellationController = (0, utils_6.createCancellationController)();
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/files/', (0, utils_4.toString)(fileId), '/thumbnail.', (0, utils_4.toString)(extension)),
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'no_content',
    ...
    getFileThumbnailById(fileId_1, extension_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, extension, optionalsInput = {}) {
            ...
            if ((0, utils_4.toString)(response.status) == '202') {
                return void 0;
            }
...
function deserializeUpdateFileByIdRequestBody(val) {
    ...
    if (!(val.disposition_at == void 0) && !(0, json_2.sdIsString)(val.disposition_at)) {
        throw new errors_1.BoxSdkError({
...
function deserializeCopyFileRequestBody(val) {
    ...
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.version == void 0) && !(0, json_2.sdIsString)(val.version)) {
        throw new errors_1.BoxSdkError({

...
const hubItemsV2025R0_1 = require("../schemas/v2025R0/hubItemsV2025R0.js");
const hubItemsManageResponseV2025R0_1 = require("../schemas/v2025R0/hubItemsManageResponseV2025R0.js");
const hubItemsManageRequestV2025R0_1 = require("../schemas/v2025R0/hubItemsManageRequestV2025R0.js");
...
class HubItemsManager {
    ...
    getHubItemsV2025R0(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, hubItemsV2025R0_1.deserializeHubItemsV2025R0)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    manageHubItemsV2025R0(hubId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (hubId, requestBody, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({ ['box-version']: (0, utils_2.toString)(headers.boxVersion) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/hubs/', (0, utils_2.toString)(hubId), '/manage_items'),
                method: 'POST',
                headers: headersMap,
                data: (0, hubItemsManageRequestV2025R0_1.serializeHubItemsManageRequestV2025R0)(requestBody),
            ...
            return Object.assign(Object.assign({}, (0, hubItemsManageResponseV2025R0_1.deserializeHubItemsManageResponseV2025R0)(response.data)), { rawData: response.data });
        });
    }
}
exports.HubItemsManager = HubItemsManager;
//# sourceMappingURL=hubItems.js.map
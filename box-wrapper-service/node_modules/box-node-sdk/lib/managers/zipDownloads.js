...
const zipDownload_1 = require("../schemas/zipDownload.js");
const zipDownloadRequest_1 = require("../schemas/zipDownloadRequest.js");
const zipDownloadStatus_1 = require("../schemas/zipDownloadStatus.js");
...
class ZipDownloadsManager {
    ...
    createZipDownload(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, zipDownload_1.deserializeZipDownload)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getZipDownloadStatus(statusUrl_1) {
        return __awaiter(this, arguments, void 0, function* (statusUrl, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, zipDownloadStatus_1.deserializeZipDownloadStatus)(response.data)), { rawData: response.data });
        });
    }
    /**

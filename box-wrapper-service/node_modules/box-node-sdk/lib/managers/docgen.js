...
const docGenJobV2025R0_1 = require("../schemas/v2025R0/docGenJobV2025R0.js");
const docGenJobsFullV2025R0_1 = require("../schemas/v2025R0/docGenJobsFullV2025R0.js");
const docGenJobsV2025R0_1 = require("../schemas/v2025R0/docGenJobsV2025R0.js");
const docGenBatchBaseV2025R0_1 = require("../schemas/v2025R0/docGenBatchBaseV2025R0.js");
const docGenBatchCreateRequestV2025R0_1 = require("../schemas/v2025R0/docGenBatchCreateRequestV2025R0.js");
...
class DocgenManager {
    ...
    getDocgenJobByIdV2025R0(jobId_1) {
        return __awaiter(this, arguments, void 0, function* (jobId, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/docgen_jobs/', (0, utils_2.toString)(jobId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return Object.assign(Object.assign({}, (0, docGenJobV2025R0_1.deserializeDocGenJobV2025R0)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getDocgenJobsV2025R0() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetDocgenJobsV2025R0Headers({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, docGenJobsFullV2025R0_1.deserializeDocGenJobsFullV2025R0)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getDocgenBatchJobByIdV2025R0(batchId_1) {
        return __awaiter(this, arguments, void 0, function* (batchId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({ ['box-version']: (0, utils_2.toString)(headers.boxVersion) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/docgen_batch_jobs/', (0, utils_2.toString)(batchId)),
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
    ...
    createDocgenBatchV2025R0(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                ...
                method: 'POST',
                headers: headersMap,
                data: (0, docGenBatchCreateRequestV2025R0_1.serializeDocGenBatchCreateRequestV2025R0)(requestBody),
            ...
            return Object.assign(Object.assign({}, (0, docGenBatchBaseV2025R0_1.deserializeDocGenBatchBaseV2025R0)(response.data)), { rawData: response.data });
        });
    }
}

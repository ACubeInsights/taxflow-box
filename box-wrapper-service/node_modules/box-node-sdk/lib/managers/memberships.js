...
const groupMemberships_1 = require("../schemas/groupMemberships.js");
const groupMembership_1 = require("../schemas/groupMembership.js");
...
class MembershipsManager {
    ...
    getUserMemberships(userId_1) {
        return __awaiter(this, arguments, void 0, function* (userId, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/users/', (0, utils_2.toString)(userId), '/memberships'),
                method: 'GET',
            ...
            return Object.assign(Object.assign({}, (0, groupMemberships_1.deserializeGroupMemberships)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getGroupMemberships(groupId_1) {
        return __awaiter(this, arguments, void 0, function* (groupId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/groups/', (0, utils_2.toString)(groupId), '/memberships'),
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
    ...
    createGroupMembership(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, groupMembership_1.deserializeGroupMembership)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getGroupMembershipById(groupMembershipId_1) {
        return __awaiter(this, arguments, void 0, function* (groupMembershipId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/group_memberships/', (0, utils_2.toString)(groupMembershipId)),
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
...
function deserializeCreateGroupMembershipRequestBody(val) {
    ...
    if (!(val.configurable_permissions == void 0) &&
        !(0, json_3.sdIsMap)(val.configurable_permissions)) {
        throw new errors_1.BoxSdkError({

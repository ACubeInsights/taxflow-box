...
const webhooks_1 = require("../schemas/webhooks.js");
const webhook_1 = require("../schemas/webhook.js");
...
const utils_7 = require("../internal/utils.js");
...
class WebhooksManager {
    ...
    getWebhooks() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetWebhooksHeaders({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, webhooks_1.deserializeWebhooks)(response.data)), { rawData: response.data });
        });
    }
    /**
     * Creates a webhook.
    ...
    createWebhook(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, webhook_1.deserializeWebhook)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getWebhookById(webhookId_1) {
        return __awaiter(this, arguments, void 0, function* (webhookId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/webhooks/', (0, utils_2.toString)(webhookId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
    ...
    static validateMessage(body_1, headers_1, primaryKey_1) {
        return __awaiter(this, arguments, void 0, function* (body, headers, primaryKey, optionalsInput = {}) {
            ...
            const deliveryTimestamp = (0, utils_5.dateTimeFromString)(headers['box-delivery-timestamp']);
            const currentEpoch = (0, utils_6.getEpochTimeInSeconds)();
            if (currentEpoch - maxAge > (0, utils_7.dateTimeToEpochSeconds)(deliveryTimestamp) ||
                (0, utils_7.dateTimeToEpochSeconds)(deliveryTimestamp) > currentEpoch) {
                return false;
            }
            if (!(primaryKey == void 0) &&
                !(headers['box-signature-primary'] == void 0) &&
                (yield (0, utils_4.compareSignatures)(yield (0, utils_3.computeWebhookSignature)(body, headers, primaryKey, false), headers['box-signature-primary']))) {
                return true;
            }
            if (!(primaryKey == void 0) &&
                !(headers['box-signature-primary'] == void 0) &&
                (yield (0, utils_4.compareSignatures)(yield (0, utils_3.computeWebhookSignature)(body, headers, primaryKey, true), headers['box-signature-primary']))) {
                return true;
            }
            if (!(secondaryKey == void 0) &&
                !(headers['box-signature-secondary'] == void 0) &&
                (yield (0, utils_4.compareSignatures)(yield (0, utils_3.computeWebhookSignature)(body, headers, secondaryKey, false), headers['box-signature-secondary']))) {
                return true;
            }
            if (!(secondaryKey == void 0) &&
                !(headers['box-signature-secondary'] == void 0) &&
                (yield (0, utils_4.compareSignatures)(yield (0, utils_3.computeWebhookSignature)(body, headers, secondaryKey, true), headers['box-signature-secondary']))) {
                return true;
            }
            return false;
        });
...
function deserializeCreateWebhookRequestBody(val) {
    ...
    if (!(0, json_1.sdIsString)(val.address)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_2.sdIsList)(val.triggers)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting array for "triggers" of type "CreateWebhookRequestBody"',
        });
    }
    const triggers = (0, json_2.sdIsList)(val.triggers)
...
function deserializeUpdateWebhookByIdRequestBody(val) {
    ...
    if (!(val.address == void 0) && !(0, json_1.sdIsString)(val.address)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.triggers == void 0) && !(0, json_2.sdIsList)(val.triggers)) {
        throw new errors_1.BoxSdkError({
    ...
    const triggers = val.triggers == void 0
        ? void 0
        : (0, json_2.sdIsList)(val.triggers)
            ? val.triggers.map(function (itm) {

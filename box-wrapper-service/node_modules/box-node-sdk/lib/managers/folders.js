...
const folderFull_1 = require("../schemas/folderFull.js");
const items_1 = require("../schemas/items.js");
...
const utils_3 = require("../internal/utils.js");
const utils_4 = require("../internal/utils.js");
...
class FoldersManager {
    ...
    getFolderById(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            ...
            const queryParamsMap = (0, utils_3.prepareParams)({
                ['fields']: queryParams.fields
                    ? queryParams.fields.map(utils_4.toString).join(',')
                    : undefined,
                ['sort']: (0, utils_4.toString)(queryParams.sort),
                ['direction']: (0, utils_4.toString)(queryParams.direction),
                ['offset']: (0, utils_4.toString)(queryParams.offset),
                ['limit']: (0, utils_4.toString)(queryParams.limit),
            });
            const headersMap = (0, utils_3.prepareParams)(Object.assign({
                ['if-none-match']: (0, utils_4.toString)(headers.ifNoneMatch),
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folders/', (0, utils_4.toString)(folderId)),
                method: 'GET',
            ...
            return Object.assign(Object.assign({}, (0, folderFull_1.deserializeFolderFull)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateFolderById(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_3.prepareParams)(Object.assign({ ['if-match']: (0, utils_4.toString)(headers.ifMatch) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folders/', (0, utils_4.toString)(folderId)),
                method: 'PUT',
                params: queryParamsMap,
    ...
    deleteFolderById(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_3.prepareParams)({
                ['recursive']: (0, utils_4.toString)(queryParams.recursive),
            });
            const headersMap = (0, utils_3.prepareParams)(Object.assign({ ['if-match']: (0, utils_4.toString)(headers.ifMatch) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folders/', (0, utils_4.toString)(folderId)),
        ...
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            ...
            const queryParamsMap = (0, utils_3.prepareParams)({
                ['fields']: queryParams.fields
                    ? queryParams.fields.map(utils_4.toString).join(',')
                    : undefined,
                ['usemarker']: (0, utils_4.toString)(queryParams.usemarker),
                ['marker']: (0, utils_4.toString)(queryParams.marker),
                ['offset']: (0, utils_4.toString)(queryParams.offset),
                ['limit']: (0, utils_4.toString)(queryParams.limit),
                ['sort']: (0, utils_4.toString)(queryParams.sort),
                ['direction']: (0, utils_4.toString)(queryParams.direction),
            });
            const headersMap = (0, utils_3.prepareParams)(Object.assign({ ['boxapi']: (0, utils_4.toString)(headers.boxapi) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folders/', (0, utils_4.toString)(folderId), '/items'),
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
            ...
            return Object.assign(Object.assign({}, (0, items_1.deserializeItems)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createFolder(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
    ...
    copyFolder(folderId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, requestBody, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folders/', (0, utils_4.toString)(folderId), '/copy'),
                method: 'POST',
                params: queryParamsMap,
                headers: headersMap,
...
function deserializeUpdateFolderByIdRequestBodyParentField(val) {
    ...
    if (!(val.user_id == void 0) && !(0, json_2.sdIsString)(val.user_id)) {
        throw new errors_1.BoxSdkError({
...
function deserializeUpdateFolderByIdRequestBodySharedLinkPermissionsField(val) {
    ...
    if (!(val.can_download == void 0) && !(0, json_1.sdIsBoolean)(val.can_download)) {
        throw new errors_1.BoxSdkError({
...
function deserializeUpdateFolderByIdRequestBodySharedLinkField(val) {
    ...
    if (!(val.password == void 0) && !(0, json_2.sdIsString)(val.password)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.vanity_name == void 0) && !(0, json_2.sdIsString)(val.vanity_name)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.unshared_at == void 0) && !(0, json_2.sdIsString)(val.unshared_at)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "unshared_at" of type "UpdateFolderByIdRequestBodySharedLinkField"',
        });
    }
    const unsharedAt = val.unshared_at == void 0 ? void 0 : (0, utils_2.deserializeDateTime)(val.unshared_at);
...
function deserializeUpdateFolderByIdRequestBodyCollectionsField(val) {
    ...
    const id = val.id == void 0 ? void 0 : val.id;
    if (!(val.type == void 0) && !(0, json_2.sdIsString)(val.type)) {
        throw new errors_1.BoxSdkError({
...
function deserializeUpdateFolderByIdRequestBody(val) {
    ...
    if (!(val.can_non_owners_invite == void 0) &&
        !(0, json_1.sdIsBoolean)(val.can_non_owners_invite)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.tags == void 0) && !(0, json_3.sdIsList)(val.tags)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.is_collaboration_restricted_to_enterprise == void 0) &&
        !(0, json_1.sdIsBoolean)(val.is_collaboration_restricted_to_enterprise)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.collections == void 0) && !(0, json_3.sdIsList)(val.collections)) {
        throw new errors_1.BoxSdkError({
    ...
    const collections = val.collections == void 0
        ? void 0
        : (0, json_3.sdIsList)(val.collections)
    ...
    if (!(val.can_non_owners_view_collaborators == void 0) &&
        !(0, json_1.sdIsBoolean)(val.can_non_owners_view_collaborators)) {
        throw new errors_1.BoxSdkError({
...
function deserializeCreateFolderRequestBody(val) {
    ...
    if (!(0, json_2.sdIsString)(val.name)) {
        throw new errors_1.BoxSdkError({

...
const comments_1 = require("../schemas/comments.js");
const commentFull_1 = require("../schemas/commentFull.js");
...
class CommentsManager {
    ...
    getFileComments(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/files/', (0, utils_2.toString)(fileId), '/comments'),
                method: 'GET',
            ...
            return Object.assign(Object.assign({}, (0, comments_1.deserializeComments)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getCommentById(commentId_1) {
        return __awaiter(this, arguments, void 0, function* (commentId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/comments/', (0, utils_2.toString)(commentId)),
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
            ...
            return Object.assign(Object.assign({}, (0, commentFull_1.deserializeCommentFull)(response.data)), { rawData: response.data });
        });
    }
    /**
...
function deserializeCreateCommentRequestBody(val) {
    ...
    if (!(val.tagged_message == void 0) && !(0, json_1.sdIsString)(val.tagged_message)) {
        throw new errors_1.BoxSdkError({

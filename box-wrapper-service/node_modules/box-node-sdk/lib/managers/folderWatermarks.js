...
const watermark_1 = require("../schemas/watermark.js");
    ...
    getFolderWatermark(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folders/', (0, utils_2.toString)(folderId), '/watermark'),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return Object.assign(Object.assign({}, (0, watermark_1.deserializeWatermark)(response.data)), { rawData: response.data });
        });
    }
    /**
...
//# sourceMappingURL=folderWatermarks.js.map
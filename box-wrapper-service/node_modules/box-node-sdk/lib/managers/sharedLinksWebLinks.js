...
const webLink_1 = require("../schemas/webLink.js");
...
class SharedLinksWebLinksManager {
    ...
    findWebLinkForSharedLink() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, webLink_1.deserializeWebLink)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getSharedLinkForWebLink(webLinkId_1, queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (webLinkId, queryParams, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_3.prepareParams)({ ['fields']: (0, utils_4.toString)(queryParams.fields) });
            const headersMap = (0, utils_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/web_links/', (0, utils_4.toString)(webLinkId), '#get_shared_link'),
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
    ...
    addShareLinkToWebLink(webLinkId_1) {
        return __awaiter(this, arguments, void 0, function* (webLinkId, requestBody = {}, queryParams, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/web_links/', (0, utils_4.toString)(webLinkId), '#add_shared_link'),
                method: 'PUT',
                params: queryParamsMap,
                headers: headersMap,
    ...
    updateSharedLinkOnWebLink(webLinkId_1) {
        return __awaiter(this, arguments, void 0, function* (webLinkId, requestBody = {}, queryParams, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/web_links/', (0, utils_4.toString)(webLinkId), '#update_shared_link'),
                method: 'PUT',
                params: queryParamsMap,
                headers: headersMap,
    ...
    removeSharedLinkFromWebLink(webLinkId_1) {
        return __awaiter(this, arguments, void 0, function* (webLinkId, requestBody = {}, queryParams, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/web_links/', (0, utils_4.toString)(webLinkId), '#remove_shared_link'),
                method: 'PUT',
                params: queryParamsMap,
                headers: headersMap,
...
function deserializeAddShareLinkToWebLinkRequestBodySharedLinkPermissionsField(val) {
    ...
    if (!(val.can_preview == void 0) && !(0, json_1.sdIsBoolean)(val.can_preview)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.can_edit == void 0) && !(0, json_1.sdIsBoolean)(val.can_edit)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=sharedLinksWebLinks.js.map
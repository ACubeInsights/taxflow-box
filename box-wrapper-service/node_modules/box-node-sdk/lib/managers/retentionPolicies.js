...
const retentionPolicies_1 = require("../schemas/retentionPolicies.js");
const retentionPolicy_1 = require("../schemas/retentionPolicy.js");
const userMini_1 = require("../schemas/userMini.js");
const userMini_2 = require("../schemas/userMini.js");
...
class RetentionPoliciesManager {
    ...
    getRetentionPolicies() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetRetentionPoliciesHeaders({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, retentionPolicies_1.deserializeRetentionPolicies)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createRetentionPolicy(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, retentionPolicy_1.deserializeRetentionPolicy)(response.data)), { rawData: response.data });
        });
    }
    /**

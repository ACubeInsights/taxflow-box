...
const shieldInformationBarrier_1 = require("../schemas/shieldInformationBarrier.js");
const shieldInformationBarriers_1 = require("../schemas/shieldInformationBarriers.js");
const enterpriseBase_1 = require("../schemas/enterpriseBase.js");
const enterpriseBase_2 = require("../schemas/enterpriseBase.js");
...
class ShieldInformationBarriersManager {
    ...
    getShieldInformationBarrierById(shieldInformationBarrierId_1) {
        return __awaiter(this, arguments, void 0, function* (shieldInformationBarrierId, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, shieldInformationBarrier_1.deserializeShieldInformationBarrier)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getShieldInformationBarriers() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetShieldInformationBarriersHeaders({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, shieldInformationBarriers_1.deserializeShieldInformationBarriers)(response.data)), { rawData: response.data });
        });
    }
    /**

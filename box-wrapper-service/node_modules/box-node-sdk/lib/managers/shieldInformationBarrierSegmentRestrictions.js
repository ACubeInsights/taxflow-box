...
const shieldInformationBarrierSegmentRestriction_1 = require("../schemas/shieldInformationBarrierSegmentRestriction.js");
const shieldInformationBarrierSegmentRestrictions_1 = require("../schemas/shieldInformationBarrierSegmentRestrictions.js");
...
class ShieldInformationBarrierSegmentRestrictionsManager {
    ...
    getShieldInformationBarrierSegmentRestrictionById(shieldInformationBarrierSegmentRestrictionId_1) {
        return __awaiter(this, arguments, void 0, function* (shieldInformationBarrierSegmentRestrictionId, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/shield_information_barrier_segment_restrictions/', (0, utils_2.toString)(shieldInformationBarrierSegmentRestrictionId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return Object.assign(Object.assign({}, (0, shieldInformationBarrierSegmentRestriction_1.deserializeShieldInformationBarrierSegmentRestriction)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getShieldInformationBarrierSegmentRestrictions(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, shieldInformationBarrierSegmentRestrictions_1.deserializeShieldInformationBarrierSegmentRestrictions)(response.data)), { rawData: response.data });
        });
    }
    /**
...
//# sourceMappingURL=shieldInformationBarrierSegmentRestrictions.js.map
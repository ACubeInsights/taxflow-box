...
const workflows_1 = require("../schemas/workflows.js");
const outcome_1 = require("../schemas/outcome.js");
const outcome_2 = require("../schemas/outcome.js");
...
class WorkflowsManager {
    ...
    getWorkflows(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            const queryParamsMap = (0, utils_1.prepareParams)({
                ...
                ['trigger_type']: (0, utils_2.toString)(queryParams.triggerType),
            ...
            return Object.assign(Object.assign({}, (0, workflows_1.deserializeWorkflows)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    startWorkflow(workflowId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (workflowId, requestBody, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/workflows/', (0, utils_2.toString)(workflowId), '/start'),
                method: 'POST',
                headers: headersMap,
    ...
    return {
        ...
        ['outcomes']: val.outcomes == void 0
            ...
            : val.outcomes.map(function (item) {
                return (0, outcome_1.serializeOutcome)(item);
            }),
    };
}
function deserializeStartWorkflowRequestBody(val) {
    ...
    if (!(0, json_2.sdIsList)(val.files)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting array for "files" of type "StartWorkflowRequestBody"',
        });
    }
    const files = (0, json_2.sdIsList)(val.files)
    ...
    if (!(val.outcomes == void 0) && !(0, json_2.sdIsList)(val.outcomes)) {
        throw new errors_1.BoxSdkError({
    ...
    const outcomes = val.outcomes == void 0
        ? void 0
        : (0, json_2.sdIsList)(val.outcomes)
            ? val.outcomes.map(function (itm) {
                return (0, outcome_2.deserializeOutcome)(itm);
            })
            : [];
    return {
        type: type,

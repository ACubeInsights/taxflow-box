...
const collaborations_1 = require("../schemas/collaborations.js");
const collaborationsOffsetPaginated_1 = require("../schemas/collaborationsOffsetPaginated.js");
...
class ListCollaborationsManager {
    ...
    getFileCollaborations(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, collaborations_1.deserializeCollaborations)(response.data)), { rawData: response.data });
        });
    }
    /**
       * Retrieves a list of pending and active collaborations for a
    ...
    getCollaborations(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, collaborationsOffsetPaginated_1.deserializeCollaborationsOffsetPaginated)(response.data)), { rawData: response.data });
        });
    }
    /**

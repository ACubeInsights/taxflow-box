...
export type CreateLegalHoldPolicyAssignmentRequestBodyAssignToTypeField = 'file' | 'file_version' | 'folder' | 'user' | 'ownership' | 'interactions';
...
//# sourceMappingURL=legalHoldPolicyAssignments.d.ts.map
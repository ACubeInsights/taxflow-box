...
const skillCardsMetadata_1 = require("../schemas/skillCardsMetadata.js");
const skillCard_1 = require("../schemas/skillCard.js");
const skillCard_2 = require("../schemas/skillCard.js");
...
function serializeCreateBoxSkillCardsOnFileRequestBody(val) {
    return {
        ['cards']: val.cards.map(function (item) {
            return (0, skillCard_1.serializeSkillCard)(item);
        }),
    };
}
function deserializeCreateBoxSkillCardsOnFileRequestBody(val) {
    ...
    if (!(0, json_3.sdIsList)(val.cards)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting array for "cards" of type "CreateBoxSkillCardsOnFileRequestBody"',
        });
    }
    const cards = (0, json_3.sdIsList)(val.cards)
        ? val.cards.map(function (itm) {
            return (0, skillCard_2.deserializeSkillCard)(itm);
        })
        : [];
    return { cards: cards };
}
...
function serializeUpdateBoxSkillCardsOnFileRequestBody(val) {
    return {
        ...
        ['path']: val.path,
        ['value']: val.value == void 0 ? val.value : (0, skillCard_1.serializeSkillCard)(val.value),
    };
}
function deserializeUpdateBoxSkillCardsOnFileRequestBody(val) {
    ...
    if (!(val.path == void 0) && !(0, json_2.sdIsString)(val.path)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "path" of type "UpdateBoxSkillCardsOnFileRequestBody"',
        });
    }
    const path = val.path == void 0 ? void 0 : val.path;
    const value = val.value == void 0 ? void 0 : (0, skillCard_2.deserializeSkillCard)(val.value);
    return {
        op: op,
        path: path,
        value: value,
...
function deserializeUpdateAllSkillCardsOnFileRequestBodyMetadataField(val) {
    ...
    if (!(val.cards == void 0) && !(0, json_3.sdIsList)(val.cards)) {
        throw new errors_1.BoxSdkError({
...
function deserializeUpdateAllSkillCardsOnFileRequestBodyUsageField(val) {
    ...
    if (!(val.unit == void 0) && !(0, json_2.sdIsString)(val.unit)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.value == void 0) && !(0, json_1.sdIsNumber)(val.value)) {
        throw new errors_1.BoxSdkError({

...
const classificationTemplate_1 = require("../schemas/classificationTemplate.js");
...
class ClassificationsManager {
    ...
    getClassificationTemplate() {
        return __awaiter(this, arguments, void 0, function* (headersInput = new GetClassificationTemplateHeaders({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, classificationTemplate_1.deserializeClassificationTemplate)(response.data)), { rawData: response.data });
        });
    }
    /**

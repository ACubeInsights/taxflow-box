...
const collaborationAllowlistExemptTargets_1 = require("../schemas/collaborationAllowlistExemptTargets.js");
const collaborationAllowlistExemptTarget_1 = require("../schemas/collaborationAllowlistExemptTarget.js");
...
class CollaborationAllowlistExemptTargetsManager {
    ...
    getCollaborationWhitelistExemptTargets() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetCollaborationWhitelistExemptTargetsHeaders({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, collaborationAllowlistExemptTargets_1.deserializeCollaborationAllowlistExemptTargets)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createCollaborationWhitelistExemptTarget(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, collaborationAllowlistExemptTarget_1.deserializeCollaborationAllowlistExemptTarget)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getCollaborationWhitelistExemptTargetById(collaborationWhitelistExemptTargetId_1) {
        return __awaiter(this, arguments, void 0, function* (collaborationWhitelistExemptTargetId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/collaboration_whitelist_exempt_targets/', (0, utils_2.toString)(collaborationWhitelistExemptTargetId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
...
//# sourceMappingURL=collaborationAllowlistExemptTargets.js.map
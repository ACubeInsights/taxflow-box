...
const collections_1 = require("../schemas/collections.js");
const itemsOffsetPaginated_1 = require("../schemas/itemsOffsetPaginated.js");
const collection_1 = require("../schemas/collection.js");
...
class CollectionsManager {
    ...
    getCollections() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetCollectionsHeaders({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, collections_1.deserializeCollections)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getCollectionItems(collectionId_1) {
        return __awaiter(this, arguments, void 0, function* (collectionId, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, itemsOffsetPaginated_1.deserializeItemsOffsetPaginated)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getCollectionById(collectionId_1) {
        return __awaiter(this, arguments, void 0, function* (collectionId, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, collection_1.deserializeCollection)(response.data)), { rawData: response.data });
        });
    }
}

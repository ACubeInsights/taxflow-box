...
const trashFolderRestored_1 = require("../schemas/trashFolderRestored.js");
const trashFolder_1 = require("../schemas/trashFolder.js");
...
class TrashedFoldersManager {
    ...
    restoreFolderFromTrash(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, trashFolderRestored_1.deserializeTrashFolderRestored)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getTrashedFolderById(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, trashFolder_1.deserializeTrashFolder)(response.data)), { rawData: response.data });
        });
    }
    /**

...
const classification_1 = require("../schemas/classification.js");
    ...
    getClassificationOnFolder(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folders/', (0, utils_2.toString)(folderId), '/metadata/enterprise/securityClassification-6VMVochwUWo'),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
...
function deserializeAddClassificationToFolderRequestBody(val) {
    ...
    if (!(val.Box__Security__Classification__Key == void 0) &&
        !(0, json_1.sdIsString)(val.Box__Security__Classification__Key)) {
        throw new errors_1.BoxSdkError({
...
function deserializeUpdateClassificationOnFolderRequestBody(val) {
    ...
    if (!(0, json_1.sdIsString)(val.value)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=folderClassifications.js.map
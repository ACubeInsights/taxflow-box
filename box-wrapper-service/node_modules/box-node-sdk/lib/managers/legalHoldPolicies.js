...
const legalHoldPolicies_1 = require("../schemas/legalHoldPolicies.js");
const legalHoldPolicy_1 = require("../schemas/legalHoldPolicy.js");
...
class LegalHoldPoliciesManager {
    ...
    getLegalHoldPolicies() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetLegalHoldPoliciesHeaders({}), cancellationToken) {
            ...
            const queryParamsMap = (0, utils_3.prepareParams)({
                ['policy_name']: (0, utils_4.toString)(queryParams.policyName),
            ...
            return Object.assign(Object.assign({}, (0, legalHoldPolicies_1.deserializeLegalHoldPolicies)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createLegalHoldPolicy(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, legalHoldPolicy_1.deserializeLegalHoldPolicy)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getLegalHoldPolicyById(legalHoldPolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (legalHoldPolicyId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/legal_hold_policies/', (0, utils_4.toString)(legalHoldPolicyId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
...
function deserializeCreateLegalHoldPolicyRequestBody(val) {
    ...
    if (!(val.is_ongoing == void 0) && !(0, json_1.sdIsBoolean)(val.is_ongoing)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=legalHoldPolicies.js.map
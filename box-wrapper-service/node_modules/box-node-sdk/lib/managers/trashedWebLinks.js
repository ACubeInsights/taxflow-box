...
const trashWebLinkRestored_1 = require("../schemas/trashWebLinkRestored.js");
const trashWebLink_1 = require("../schemas/trashWebLink.js");
...
class TrashedWebLinksManager {
    ...
    restoreWeblinkFromTrash(webLinkId_1) {
        return __awaiter(this, arguments, void 0, function* (webLinkId, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/web_links/', (0, utils_2.toString)(webLinkId)),
                method: 'POST',
            ...
            return Object.assign(Object.assign({}, (0, trashWebLinkRestored_1.deserializeTrashWebLinkRestored)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getTrashedWebLinkById(webLinkId_1) {
        return __awaiter(this, arguments, void 0, function* (webLinkId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/web_links/', (0, utils_2.toString)(webLinkId), '/trash'),
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
            ...
            return Object.assign(Object.assign({}, (0, trashWebLink_1.deserializeTrashWebLink)(response.data)), { rawData: response.data });
        });
    }
    /**
...
//# sourceMappingURL=trashedWebLinks.js.map
...
const files_1 = require("../schemas/files.js");
const uploadUrl_1 = require("../schemas/uploadUrl.js");
...
class UploadsManager {
    ...
    uploadFileVersion(fileId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, requestBody, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_3.prepareParams)(Object.assign({
                ['if-match']: (0, utils_4.toString)(headers.ifMatch),
                ['content-md5']: (0, utils_4.toString)(headers.contentMd5),
            }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.uploadUrl, '/2.0/files/', (0, utils_4.toString)(fileId), '/content'),
                method: 'POST',
    ...
    preflightFileUploadCheck() {
        return __awaiter(this, arguments, void 0, function* (requestBody = {}, headersInput = new PreflightFileUploadCheckHeaders({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, uploadUrl_1.deserializeUploadUrl)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    uploadFile(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_3.prepareParams)(Object.assign({ ['content-md5']: (0, utils_4.toString)(headers.contentMd5) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
    ...
    uploadWithPreflightCheck(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            if (preflightUploadUrl.uploadUrl == void 0 ||
                ...
                throw new errors_1.BoxSdkError({ message: 'Unable to get preflight upload URL' });
            }
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({

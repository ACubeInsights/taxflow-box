...
const legalHoldPolicyAssignments_1 = require("../schemas/legalHoldPolicyAssignments.js");
const legalHoldPolicyAssignment_1 = require("../schemas/legalHoldPolicyAssignment.js");
const filesOnHold_1 = require("../schemas/filesOnHold.js");
...
class LegalHoldPolicyAssignmentsManager {
    ...
    getLegalHoldPolicyAssignments(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, legalHoldPolicyAssignments_1.deserializeLegalHoldPolicyAssignments)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createLegalHoldPolicyAssignment(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, legalHoldPolicyAssignment_1.deserializeLegalHoldPolicyAssignment)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getLegalHoldPolicyAssignmentFileOnHold(legalHoldPolicyAssignmentId_1) {
        return __awaiter(this, arguments, void 0, function* (legalHoldPolicyAssignmentId, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, filesOnHold_1.deserializeFilesOnHold)(response.data)), { rawData: response.data });
        });
    }
}

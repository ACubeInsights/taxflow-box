...
const integrationMappings_1 = require("../schemas/integrationMappings.js");
const integrationMapping_1 = require("../schemas/integrationMapping.js");
const integrationMappingSlackCreateRequest_1 = require("../schemas/integrationMappingSlackCreateRequest.js");
const integrationMappingBoxItemSlack_1 = require("../schemas/integrationMappingBoxItemSlack.js");
const integrationMappingBoxItemSlack_2 = require("../schemas/integrationMappingBoxItemSlack.js");
const integrationMappingSlackOptions_1 = require("../schemas/integrationMappingSlackOptions.js");
const integrationMappingSlackOptions_2 = require("../schemas/integrationMappingSlackOptions.js");
const integrationMappingsTeams_1 = require("../schemas/integrationMappingsTeams.js");
const integrationMappingTeams_1 = require("../schemas/integrationMappingTeams.js");
const integrationMappingTeamsCreateRequest_1 = require("../schemas/integrationMappingTeamsCreateRequest.js");
const folderReference_1 = require("../schemas/folderReference.js");
const folderReference_2 = require("../schemas/folderReference.js");
...
class IntegrationMappingsManager {
    ...
    getSlackIntegrationMapping() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetSlackIntegrationMappingHeaders({}), cancellationToken) {
            ...
            const queryParamsMap = (0, utils_1.prepareParams)({
                ...
                ['partner_item_type']: (0, utils_2.toString)(queryParams.partnerItemType),
                ['partner_item_id']: (0, utils_2.toString)(queryParams.partnerItemId),
                ['box_item_id']: (0, utils_2.toString)(queryParams.boxItemId),
                ['box_item_type']: (0, utils_2.toString)(queryParams.boxItemType),
                ['is_manually_created']: (0, utils_2.toString)(queryParams.isManuallyCreated),
            });
            ...
            return Object.assign(Object.assign({}, (0, integrationMappings_1.deserializeIntegrationMappings)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createSlackIntegrationMapping(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                ...
                method: 'POST',
                headers: headersMap,
                data: (0, integrationMappingSlackCreateRequest_1.serializeIntegrationMappingSlackCreateRequest)(requestBody),
            ...
            return Object.assign(Object.assign({}, (0, integrationMapping_1.deserializeIntegrationMapping)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateSlackIntegrationMappingById(integrationMappingId_1) {
        return __awaiter(this, arguments, void 0, function* (integrationMappingId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/integration_mappings/slack/', (0, utils_2.toString)(integrationMappingId)),
                method: 'PUT',
                headers: headersMap,
    ...
    getTeamsIntegrationMapping() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetTeamsIntegrationMappingHeaders({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, integrationMappingsTeams_1.deserializeIntegrationMappingsTeams)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createTeamsIntegrationMapping(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                ...
                method: 'POST',
                headers: headersMap,
                data: (0, integrationMappingTeamsCreateRequest_1.serializeIntegrationMappingTeamsCreateRequest)(requestBody),
                contentType: 'application/json',
                responseFormat: 'json',
                auth: this.auth,
                networkSession: this.networkSession,
            ...
            return Object.assign(Object.assign({}, (0, integrationMappingTeams_1.deserializeIntegrationMappingTeams)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateTeamsIntegrationMappingById(integrationMappingId_1) {
        return __awaiter(this, arguments, void 0, function* (integrationMappingId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/integration_mappings/teams/', (0, utils_2.toString)(integrationMappingId)),
                method: 'PUT',
                headers: headersMap,
...
function serializeUpdateSlackIntegrationMappingByIdRequestBody(val) {
    return {
        ['box_item']: val.boxItem == void 0
            ? val.boxItem
            : (0, integrationMappingBoxItemSlack_1.serializeIntegrationMappingBoxItemSlack)(val.boxItem),
        ['options']: val.options == void 0
            ? val.options
            : (0, integrationMappingSlackOptions_1.serializeIntegrationMappingSlackOptions)(val.options),
    };
}
function deserializeUpdateSlackIntegrationMappingByIdRequestBody(val) {
    ...
    const boxItem = val.box_item == void 0
        ? void 0
        : (0, integrationMappingBoxItemSlack_2.deserializeIntegrationMappingBoxItemSlack)(val.box_item);
    const options = val.options == void 0
        ? void 0
        : (0, integrationMappingSlackOptions_2.deserializeIntegrationMappingSlackOptions)(val.options);
    return {
        boxItem: boxItem,
        options: options,
    };
...
function serializeUpdateTeamsIntegrationMappingByIdRequestBody(val) {
    return {
        ['box_item']: val.boxItem == void 0
            ? val.boxItem
            : (0, folderReference_1.serializeFolderReference)(val.boxItem),
    };
}
function deserializeUpdateTeamsIntegrationMappingByIdRequestBody(val) {
    ...
    const boxItem = val.box_item == void 0 ? void 0 : (0, folderReference_2.deserializeFolderReference)(val.box_item);
    return {
        boxItem: boxItem,
    };
}
//# sourceMappingURL=integrationMappings.js.map
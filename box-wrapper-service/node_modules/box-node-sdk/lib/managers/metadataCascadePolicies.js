...
const metadataCascadePolicies_1 = require("../schemas/metadataCascadePolicies.js");
const metadataCascadePolicy_1 = require("../schemas/metadataCascadePolicy.js");
...
class MetadataCascadePoliciesManager {
    ...
    getMetadataCascadePolicies(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            const queryParamsMap = (0, utils_1.prepareParams)({
                ['folder_id']: (0, utils_2.toString)(queryParams.folderId),
                ['owner_enterprise_id']: (0, utils_2.toString)(queryParams.ownerEnterpriseId),
            ...
            return Object.assign(Object.assign({}, (0, metadataCascadePolicies_1.deserializeMetadataCascadePolicies)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createMetadataCascadePolicy(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, metadataCascadePolicy_1.deserializeMetadataCascadePolicy)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getMetadataCascadePolicyById(metadataCascadePolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (metadataCascadePolicyId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/metadata_cascade_policies/', (0, utils_2.toString)(metadataCascadePolicyId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
    ...
    applyMetadataCascadePolicy(metadataCascadePolicyId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (metadataCascadePolicyId, requestBody, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/metadata_cascade_policies/', (0, utils_2.toString)(metadataCascadePolicyId), '/apply'),
                method: 'POST',
                headers: headersMap,
...
function deserializeCreateMetadataCascadePolicyRequestBody(val) {
    ...
    if (!(0, json_1.sdIsString)(val.folder_id)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_1.sdIsString)(val.templateKey)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=metadataCascadePolicies.js.map
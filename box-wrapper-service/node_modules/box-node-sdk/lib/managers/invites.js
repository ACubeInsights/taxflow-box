...
const invite_1 = require("../schemas/invite.js");
...
class InvitesManager {
    ...
    createInvite(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, invite_1.deserializeInvite)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getInviteById(inviteId_1) {
        return __awaiter(this, arguments, void 0, function* (inviteId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/invites/', (0, utils_2.toString)(inviteId)),
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',

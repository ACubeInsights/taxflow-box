...
const shieldInformationBarrierReports_1 = require("../schemas/shieldInformationBarrierReports.js");
const shieldInformationBarrierReport_1 = require("../schemas/shieldInformationBarrierReport.js");
const shieldInformationBarrierReference_1 = require("../schemas/shieldInformationBarrierReference.js");
...
class ShieldInformationBarrierReportsManager {
    ...
    getShieldInformationBarrierReports(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, shieldInformationBarrierReports_1.deserializeShieldInformationBarrierReports)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createShieldInformationBarrierReport(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                ...
                method: 'POST',
                headers: headersMap,
                data: (0, shieldInformationBarrierReference_1.serializeShieldInformationBarrierReference)(requestBody),
            ...
            return Object.assign(Object.assign({}, (0, shieldInformationBarrierReport_1.deserializeShieldInformationBarrierReport)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getShieldInformationBarrierReportById(shieldInformationBarrierReportId_1) {
        return __awaiter(this, arguments, void 0, function* (shieldInformationBarrierReportId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/shield_information_barrier_reports/', (0, utils_2.toString)(shieldInformationBarrierReportId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
...
//# sourceMappingURL=shieldInformationBarrierReports.js.map
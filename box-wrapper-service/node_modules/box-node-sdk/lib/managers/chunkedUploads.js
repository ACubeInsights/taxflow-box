...
const uploadSession_1 = require("../schemas/uploadSession.js");
const uploadedPart_1 = require("../schemas/uploadedPart.js");
const uploadParts_1 = require("../schemas/uploadParts.js");
const files_1 = require("../schemas/files.js");
const uploadPart_1 = require("../schemas/uploadPart.js");
const uploadPart_2 = require("../schemas/uploadPart.js");
...
const utils_8 = require("../internal/utils.js");
const utils_9 = require("../internal/utils.js");
...
function deserializeCreateFileUploadSessionCommitByUrlRequestBody(val) {
    ...
    if (!(0, json_3.sdIsList)(val.parts)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting array for "parts" of type "CreateFileUploadSessionCommitByUrlRequestBody"',
        });
    }
    const parts = (0, json_3.sdIsList)(val.parts)
        ? val.parts.map(function (itm) {
            return (0, uploadPart_2.deserializeUploadPart)(itm);
        })
        : [];
    return {
        parts: parts,
...
//# sourceMappingURL=chunkedUploads.js.map
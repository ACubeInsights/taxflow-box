...
const devicePinner_1 = require("../schemas/devicePinner.js");
const devicePinners_1 = require("../schemas/devicePinners.js");
...
class DevicePinnersManager {
    ...
    getDevicePinnerById(devicePinnerId_1) {
        return __awaiter(this, arguments, void 0, function* (devicePinnerId, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/device_pinners/', (0, utils_2.toString)(devicePinnerId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return Object.assign(Object.assign({}, (0, devicePinner_1.deserializeDevicePinner)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getEnterpriseDevicePinners(enterpriseId_1) {
        return __awaiter(this, arguments, void 0, function* (enterpriseId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/enterprises/', (0, utils_2.toString)(enterpriseId), '/device_pinners'),
                method: 'GET',
            ...
            return Object.assign(Object.assign({}, (0, devicePinners_1.deserializeDevicePinners)(response.data)), { rawData: response.data });
        });
    }
}
...
//# sourceMappingURL=devicePinners.js.map
...
const termsOfServices_1 = require("../schemas/termsOfServices.js");
const termsOfService_1 = require("../schemas/termsOfService.js");
...
class TermsOfServicesManager {
    ...
    getTermsOfService() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetTermsOfServiceHeaders({}), cancellationToken) {
            ...
            const queryParamsMap = (0, utils_1.prepareParams)({
                ['tos_type']: (0, utils_2.toString)(queryParams.tosType),
            });
            ...
            return Object.assign(Object.assign({}, (0, termsOfServices_1.deserializeTermsOfServices)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createTermsOfService(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, termsOfService_1.deserializeTermsOfService)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getTermsOfServiceById(termsOfServiceId_1) {
        return __awaiter(this, arguments, void 0, function* (termsOfServiceId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/terms_of_services/', (0, utils_2.toString)(termsOfServiceId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
...
function deserializeCreateTermsOfServiceRequestBody(val) {
    ...
    if (!(0, json_1.sdIsString)(val.text)) {
        throw new errors_1.BoxSdkError({

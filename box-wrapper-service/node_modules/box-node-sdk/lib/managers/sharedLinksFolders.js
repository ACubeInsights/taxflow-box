...
class SharedLinksFoldersManager {
    ...
    getSharedLinkForFolder(folderId_1, queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, queryParams, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folders/', (0, utils_4.toString)(folderId), '#get_shared_link'),
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
    ...
    addShareLinkToFolder(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, requestBody = {}, queryParams, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folders/', (0, utils_4.toString)(folderId), '#add_shared_link'),
                method: 'PUT',
                params: queryParamsMap,
                headers: headersMap,
    ...
    updateSharedLinkOnFolder(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, requestBody = {}, queryParams, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folders/', (0, utils_4.toString)(folderId), '#update_shared_link'),
                method: 'PUT',
                params: queryParamsMap,
                headers: headersMap,
    ...
    removeSharedLinkFromFolder(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, requestBody = {}, queryParams, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folders/', (0, utils_4.toString)(folderId), '#remove_shared_link'),
                method: 'PUT',
                params: queryParamsMap,
                headers: headersMap,
...
//# sourceMappingURL=sharedLinksFolders.js.map
...
const termsOfServiceUserStatuses_1 = require("../schemas/termsOfServiceUserStatuses.js");
const termsOfServiceUserStatus_1 = require("../schemas/termsOfServiceUserStatus.js");
...
class TermsOfServiceUserStatusesManager {
    ...
    getTermsOfServiceUserStatuses(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            const queryParamsMap = (0, utils_1.prepareParams)({
                ['tos_id']: (0, utils_2.toString)(queryParams.tosId),
                ['user_id']: (0, utils_2.toString)(queryParams.userId),
            });
            ...
            return Object.assign(Object.assign({}, (0, termsOfServiceUserStatuses_1.deserializeTermsOfServiceUserStatuses)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createTermsOfServiceStatusForUser(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, termsOfServiceUserStatus_1.deserializeTermsOfServiceUserStatus)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateTermsOfServiceStatusForUserById(termsOfServiceUserStatusId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (termsOfServiceUserStatusId, requestBody, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/terms_of_service_user_statuses/', (0, utils_2.toString)(termsOfServiceUserStatusId)),
                method: 'PUT',
                headers: headersMap,
...
function deserializeCreateTermsOfServiceStatusForUserRequestBody(val) {
    ...
    if (!(0, json_1.sdIsBoolean)(val.is_accepted)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=termsOfServiceUserStatuses.js.map
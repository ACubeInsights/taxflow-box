...
const folderLocks_1 = require("../schemas/folderLocks.js");
const folderLock_1 = require("../schemas/folderLock.js");
...
class FolderLocksManager {
    ...
    getFolderLocks(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, folderLocks_1.deserializeFolderLocks)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createFolderLock(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, folderLock_1.deserializeFolderLock)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteFolderLockById(folderLockId_1) {
        return __awaiter(this, arguments, void 0, function* (folderLockId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folder_locks/', (0, utils_2.toString)(folderLockId)),
                method: 'DELETE',
                headers: headersMap,
...
function deserializeCreateFolderLockRequestBodyLockedOperationsField(val) {
    ...
    if (!(0, json_1.sdIsBoolean)(val.move)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(0, json_1.sdIsBoolean)(val.delete)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=folderLocks.js.map
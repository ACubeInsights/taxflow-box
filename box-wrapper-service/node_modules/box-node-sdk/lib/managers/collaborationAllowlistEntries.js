...
const collaborationAllowlistEntries_1 = require("../schemas/collaborationAllowlistEntries.js");
const collaborationAllowlistEntry_1 = require("../schemas/collaborationAllowlistEntry.js");
...
class CollaborationAllowlistEntriesManager {
    ...
    getCollaborationWhitelistEntries() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetCollaborationWhitelistEntriesHeaders({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, collaborationAllowlistEntries_1.deserializeCollaborationAllowlistEntries)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createCollaborationWhitelistEntry(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, collaborationAllowlistEntry_1.deserializeCollaborationAllowlistEntry)(response.data)), { rawData: response.data });
        });
    }
    /**

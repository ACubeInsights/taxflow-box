...
const signTemplates_1 = require("../schemas/signTemplates.js");
const signTemplate_1 = require("../schemas/signTemplate.js");
...
class SignTemplatesManager {
    ...
    getSignTemplates() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetSignTemplatesHeaders({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, signTemplates_1.deserializeSignTemplates)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getSignTemplateById(templateId_1) {
        return __awaiter(this, arguments, void 0, function* (templateId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/sign_templates/', (0, utils_2.toString)(templateId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return Object.assign(Object.assign({}, (0, signTemplate_1.deserializeSignTemplate)(response.data)), { rawData: response.data });
        });
    }
}
exports.SignTemplatesManager = SignTemplatesManager;
//# sourceMappingURL=signTemplates.js.map
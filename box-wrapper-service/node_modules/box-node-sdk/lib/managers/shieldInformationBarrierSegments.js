...
const shieldInformationBarrierSegment_1 = require("../schemas/shieldInformationBarrierSegment.js");
const shieldInformationBarrierSegments_1 = require("../schemas/shieldInformationBarrierSegments.js");
    ...
    getShieldInformationBarrierSegmentById(shieldInformationBarrierSegmentId_1) {
        return __awaiter(this, arguments, void 0, function* (shieldInformationBarrierSegmentId, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/shield_information_barrier_segments/', (0, utils_2.toString)(shieldInformationBarrierSegmentId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return Object.assign(Object.assign({}, (0, shieldInformationBarrierSegment_1.deserializeShieldInformationBarrierSegment)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getShieldInformationBarrierSegments(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            const queryParamsMap = (0, utils_1.prepareParams)({
                ['shield_information_barrier_id']: (0, utils_2.toString)(queryParams.shieldInformationBarrierId),
            ...
            return Object.assign(Object.assign({}, (0, shieldInformationBarrierSegments_1.deserializeShieldInformationBarrierSegments)(response.data)), { rawData: response.data });
        });
    }
    /**
...
function serializeCreateShieldInformationBarrierSegmentRequestBody(val) {
    return {
        ['shield_information_barrier']: (0, shieldInformationBarrierBase_1.serializeShieldInformationBarrierBase)(val.shieldInformationBarrier),
        ['name']: val.name,
...
function deserializeCreateShieldInformationBarrierSegmentRequestBody(val) {
    ...
    const shieldInformationBarrier = (0, shieldInformationBarrierBase_2.deserializeShieldInformationBarrierBase)(val.shield_information_barrier);
    if (val.name == void 0) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=shieldInformationBarrierSegments.js.map
...
const storagePolicies_1 = require("../schemas/storagePolicies.js");
const storagePolicy_1 = require("../schemas/storagePolicy.js");
...
class StoragePoliciesManager {
    ...
    getStoragePolicies() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetStoragePoliciesHeaders({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, storagePolicies_1.deserializeStoragePolicies)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getStoragePolicyById(storagePolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (storagePolicyId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/storage_policies/', (0, utils_2.toString)(storagePolicyId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return Object.assign(Object.assign({}, (0, storagePolicy_1.deserializeStoragePolicy)(response.data)), { rawData: response.data });
        });
    }
}
exports.StoragePoliciesManager = StoragePoliciesManager;
//# sourceMappingURL=storagePolicies.js.map
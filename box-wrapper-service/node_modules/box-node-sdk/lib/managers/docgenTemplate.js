...
const docGenTemplateBaseV2025R0_1 = require("../schemas/v2025R0/docGenTemplateBaseV2025R0.js");
const docGenTemplateCreateRequestV2025R0_1 = require("../schemas/v2025R0/docGenTemplateCreateRequestV2025R0.js");
const docGenTemplatesV2025R0_1 = require("../schemas/v2025R0/docGenTemplatesV2025R0.js");
const docGenTemplateV2025R0_1 = require("../schemas/v2025R0/docGenTemplateV2025R0.js");
const docGenTagsV2025R0_1 = require("../schemas/v2025R0/docGenTagsV2025R0.js");
const docGenJobsV2025R0_1 = require("../schemas/v2025R0/docGenJobsV2025R0.js");
...
class DocgenTemplateManager {
    ...
    createDocgenTemplateV2025R0(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                ...
                method: 'POST',
                headers: headersMap,
                data: (0, docGenTemplateCreateRequestV2025R0_1.serializeDocGenTemplateCreateRequestV2025R0)(requestBody),
            ...
            return Object.assign(Object.assign({}, (0, docGenTemplateBaseV2025R0_1.deserializeDocGenTemplateBaseV2025R0)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getDocgenTemplatesV2025R0() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetDocgenTemplatesV2025R0Headers({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, docGenTemplatesV2025R0_1.deserializeDocGenTemplatesV2025R0)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteDocgenTemplateByIdV2025R0(templateId_1) {
        return __awaiter(this, arguments, void 0, function* (templateId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({ ['box-version']: (0, utils_2.toString)(headers.boxVersion) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/docgen_templates/', (0, utils_2.toString)(templateId)),
                method: 'DELETE',
                headers: headersMap,
    ...
    getDocgenTemplateByIdV2025R0(templateId_1) {
        return __awaiter(this, arguments, void 0, function* (templateId, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, docGenTemplateV2025R0_1.deserializeDocGenTemplateV2025R0)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getDocgenTemplateTagsV2025R0(templateId_1) {
        return __awaiter(this, arguments, void 0, function* (templateId, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_1.prepareParams)({
                ['template_version_id']: (0, utils_2.toString)(queryParams.templateVersionId),
                ['marker']: (0, utils_2.toString)(queryParams.marker),
                ['limit']: (0, utils_2.toString)(queryParams.limit),
            });
            const headersMap = (0, utils_1.prepareParams)(Object.assign({ ['box-version']: (0, utils_2.toString)(headers.boxVersion) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/docgen_templates/', (0, utils_2.toString)(templateId), '/tags'),
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
            ...
            return Object.assign(Object.assign({}, (0, docGenTagsV2025R0_1.deserializeDocGenTagsV2025R0)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getDocgenTemplateJobByIdV2025R0(templateId_1) {
        return __awaiter(this, arguments, void 0, function* (templateId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({ ['box-version']: (0, utils_2.toString)(headers.boxVersion) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/docgen_template_jobs/', (0, utils_2.toString)(templateId)),
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
            ...
            return Object.assign(Object.assign({}, (0, docGenJobsV2025R0_1.deserializeDocGenJobsV2025R0)(response.data)), { rawData: response.data });
        });
    }
}
exports.DocgenTemplateManager = DocgenTemplateManager;
//# sourceMappingURL=docgenTemplate.js.map
...
const metadataQueryResults_1 = require("../schemas/metadataQueryResults.js");
const metadataQuery_1 = require("../schemas/metadataQuery.js");
const searchResultsResponse_1 = require("../schemas/searchResultsResponse.js");
const metadataFilter_1 = require("../schemas/metadataFilter.js");
    ...
    searchByMetadataQuery(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                ...
                method: 'POST',
                headers: headersMap,
                data: (0, metadataQuery_1.serializeMetadataQuery)(requestBody),
            ...
            return Object.assign(Object.assign({}, (0, metadataQueryResults_1.deserializeMetadataQueryResults)(response.data)), { rawData: response.data });
        });
    }
    /**
        ...
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new SearchForContentHeaders({}), cancellationToken) {
            ...
            const queryParamsMap = (0, utils_1.prepareParams)({
                ...
                ['file_extensions']: queryParams.fileExtensions
                    ? queryParams.fileExtensions.map(utils_2.toString).join(',')
                    : undefined,
                ['created_at_range']: queryParams.createdAtRange
                    ? queryParams.createdAtRange.map(utils_2.toString).join(',')
                    : undefined,
                ['updated_at_range']: queryParams.updatedAtRange
                    ? queryParams.updatedAtRange.map(utils_2.toString).join(',')
                    : undefined,
                ['size_range']: queryParams.sizeRange
                    ? queryParams.sizeRange.map(utils_2.toString).join(',')
                    : undefined,
                ['owner_user_ids']: queryParams.ownerUserIds
                    ? queryParams.ownerUserIds.map(utils_2.toString).join(',')
                    : undefined,
                ['recent_updater_user_ids']: queryParams.recentUpdaterUserIds
                    ? queryParams.recentUpdaterUserIds.map(utils_2.toString).join(',')
                    : undefined,
                ['ancestor_folder_ids']: queryParams.ancestorFolderIds
                    ? queryParams.ancestorFolderIds.map(utils_2.toString).join(',')
                    : undefined,
                ['content_types']: queryParams.contentTypes
                    ? queryParams.contentTypes.map(utils_2.toString).join(',')
                    : undefined,
                ['type']: (0, utils_2.toString)(queryParams.type),
                ['trash_content']: (0, utils_2.toString)(queryParams.trashContent),
                ['mdfilters']: queryParams.mdfilters
                    ? (0, json_1.sdToJson)(queryParams.mdfilters.map(metadataFilter_1.serializeMetadataFilter))
                    : undefined,
                ['sort']: (0, utils_2.toString)(queryParams.sort),
                ['direction']: (0, utils_2.toString)(queryParams.direction),
                ['limit']: (0, utils_2.toString)(queryParams.limit),
                ['include_recent_shared_links']: (0, utils_2.toString)(queryParams.includeRecentSharedLinks),
                ...
                ['deleted_user_ids']: queryParams.deletedUserIds
                    ? queryParams.deletedUserIds.map(utils_2.toString).join(',')
                    : undefined,
                ['deleted_at_range']: queryParams.deletedAtRange
                    ? queryParams.deletedAtRange.map(utils_2.toString).join(',')
                    : undefined,
            });
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
            ...
            return Object.assign(Object.assign({}, (0, searchResultsResponse_1.deserializeSearchResultsResponse)(response.data)), { rawData: response.data });
        });
    }
}

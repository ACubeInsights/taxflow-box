...
const trashFileRestored_1 = require("../schemas/trashFileRestored.js");
const trashFile_1 = require("../schemas/trashFile.js");
...
class TrashedFilesManager {
    ...
    restoreFileFromTrash(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, trashFileRestored_1.deserializeTrashFileRestored)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getTrashedFileById(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, trashFile_1.deserializeTrashFile)(response.data)), { rawData: response.data });
        });
    }
    /**

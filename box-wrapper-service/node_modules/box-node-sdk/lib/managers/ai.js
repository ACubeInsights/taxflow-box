...
const aiResponseFull_1 = require("../schemas/aiResponseFull.js");
const aiAsk_1 = require("../schemas/aiAsk.js");
const aiResponse_1 = require("../schemas/aiResponse.js");
const aiTextGen_1 = require("../schemas/aiTextGen.js");
const aiAgent_1 = require("../schemas/aiAgent.js");
const aiExtract_1 = require("../schemas/aiExtract.js");
const aiExtractStructuredResponse_1 = require("../schemas/aiExtractStructuredResponse.js");
const aiExtractStructured_1 = require("../schemas/aiExtractStructured.js");
    ...
    createAiAsk(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                ...
                method: 'POST',
                headers: headersMap,
                data: (0, aiAsk_1.serializeAiAsk)(requestBody),
            ...
            if ((0, utils_2.toString)(response.status) == '204') {
                return void 0;
            }
            return Object.assign(Object.assign({}, (0, aiResponseFull_1.deserializeAiResponseFull)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createAiTextGen(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                ...
                method: 'POST',
                headers: headersMap,
                data: (0, aiTextGen_1.serializeAiTextGen)(requestBody),
                contentType: 'application/json',
                responseFormat: 'json',
                auth: this.auth,
                networkSession: this.networkSession,
            ...
            return Object.assign(Object.assign({}, (0, aiResponse_1.deserializeAiResponse)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getAiAgentDefaultConfig(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            const queryParamsMap = (0, utils_1.prepareParams)({
                ['mode']: (0, utils_2.toString)(queryParams.mode),
                ['language']: (0, utils_2.toString)(queryParams.language),
                ['model']: (0, utils_2.toString)(queryParams.model),
            });
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
            ...
            return Object.assign(Object.assign({}, (0, aiAgent_1.deserializeAiAgent)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createAiExtract(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                ...
                method: 'POST',
                headers: headersMap,
                data: (0, aiExtract_1.serializeAiExtract)(requestBody),
                contentType: 'application/json',
                responseFormat: 'json',
                auth: this.auth,
                networkSession: this.networkSession,
    ...
    createAiExtractStructured(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                ...
                method: 'POST',
                headers: headersMap,
                data: (0, aiExtractStructured_1.serializeAiExtractStructured)(requestBody),
                contentType: 'application/json',
                responseFormat: 'json',
                auth: this.auth,
                networkSession: this.networkSession,
            ...
            return Object.assign(Object.assign({}, (0, aiExtractStructuredResponse_1.deserializeAiExtractStructuredResponse)(response.data)), { rawData: response.data });
        });
    }
}

...
const shieldInformationBarrierSegmentMember_1 = require("../schemas/shieldInformationBarrierSegmentMember.js");
const shieldInformationBarrierSegmentMembers_1 = require("../schemas/shieldInformationBarrierSegmentMembers.js");
const shieldInformationBarrierBase_1 = require("../schemas/shieldInformationBarrierBase.js");
const shieldInformationBarrierBase_2 = require("../schemas/shieldInformationBarrierBase.js");
const userBase_1 = require("../schemas/userBase.js");
const userBase_2 = require("../schemas/userBase.js");
    ...
    getShieldInformationBarrierSegmentMemberById(shieldInformationBarrierSegmentMemberId_1) {
        return __awaiter(this, arguments, void 0, function* (shieldInformationBarrierSegmentMemberId, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/shield_information_barrier_segment_members/', (0, utils_2.toString)(shieldInformationBarrierSegmentMemberId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return Object.assign(Object.assign({}, (0, shieldInformationBarrierSegmentMember_1.deserializeShieldInformationBarrierSegmentMember)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getShieldInformationBarrierSegmentMembers(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            const queryParamsMap = (0, utils_1.prepareParams)({
                ['shield_information_barrier_segment_id']: (0, utils_2.toString)(queryParams.shieldInformationBarrierSegmentId),
            ...
            return Object.assign(Object.assign({}, (0, shieldInformationBarrierSegmentMembers_1.deserializeShieldInformationBarrierSegmentMembers)(response.data)), { rawData: response.data });
        });
    }
    /**
...
function serializeCreateShieldInformationBarrierSegmentMemberRequestBody(val) {
    return {
        ...
        ['shield_information_barrier']: val.shieldInformationBarrier == void 0
            ...
            : (0, shieldInformationBarrierBase_1.serializeShieldInformationBarrierBase)(val.shieldInformationBarrier),
        ...
        ['user']: (0, userBase_1.serializeUserBase)(val.user),
    };
}
function deserializeCreateShieldInformationBarrierSegmentMemberRequestBody(val) {
    ...
    const shieldInformationBarrier = val.shield_information_barrier == void 0
        ? void 0
        : (0, shieldInformationBarrierBase_2.deserializeShieldInformationBarrierBase)(val.shield_information_barrier);
    ...
    const user = (0, userBase_2.deserializeUserBase)(val.user);
    return {
        type: type,
...
//# sourceMappingURL=shieldInformationBarrierSegmentMembers.js.map
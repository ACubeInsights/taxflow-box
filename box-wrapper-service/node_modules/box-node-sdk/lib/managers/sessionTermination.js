...
const sessionTerminationMessage_1 = require("../schemas/sessionTerminationMessage.js");
...
function deserializeTerminateUsersSessionsRequestBody(val) {
    ...
    if (!(0, json_2.sdIsList)(val.user_logins)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting array for "user_logins" of type "TerminateUsersSessionsRequestBody"',
        });
    }
    const userLogins = (0, json_2.sdIsList)(val.user_logins)
...
function deserializeTerminateGroupsSessionsRequestBody(val) {
    ...
    if (!(0, json_2.sdIsList)(val.group_ids)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting array for "group_ids" of type "TerminateGroupsSessionsRequestBody"',
        });
    }
    const groupIds = (0, json_2.sdIsList)(val.group_ids)
...
//# sourceMappingURL=sessionTermination.js.map
...
function deserializeCreateWebLinkRequestBody(val) {
    ...
    if (!(0, json_1.sdIsString)(val.url)) {
        throw new errors_1.BoxSdkError({
...
function deserializeUpdateWebLinkByIdRequestBodyParentField(val) {
    ...
    if (!(val.user_id == void 0) && !(0, json_1.sdIsString)(val.user_id)) {
        throw new errors_1.BoxSdkError({
...
function deserializeUpdateWebLinkByIdRequestBodySharedLinkField(val) {
    ...
    if (!(val.password == void 0) && !(0, json_1.sdIsString)(val.password)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.vanity_name == void 0) && !(0, json_1.sdIsString)(val.vanity_name)) {
        throw new errors_1.BoxSdkError({
    ...
    if (!(val.unshared_at == void 0) && !(0, json_1.sdIsString)(val.unshared_at)) {
        throw new errors_1.BoxSdkError({

...
const fileVersions_1 = require("../schemas/fileVersions.js");
const fileVersionFull_1 = require("../schemas/fileVersionFull.js");
...
class FileVersionsManager {
    ...
    getFileVersions(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/files/', (0, utils_2.toString)(fileId), '/versions'),
                method: 'GET',
            ...
            return Object.assign(Object.assign({}, (0, fileVersions_1.deserializeFileVersions)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getFileVersionById(fileId_1, fileVersionId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, fileVersionId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/files/', (0, utils_2.toString)(fileId), '/versions/', (0, utils_2.toString)(fileVersionId)),
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
            ...
            return Object.assign(Object.assign({}, (0, fileVersionFull_1.deserializeFileVersionFull)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    promoteFileVersion(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/files/', (0, utils_2.toString)(fileId), '/versions/current'),
                method: 'POST',
                params: queryParamsMap,
                headers: headersMap,
...
function deserializeUpdateFileVersionByIdRequestBody(val) {
    ...
    if (!(val.trashed_at == void 0) && !(0, json_1.sdIsString)(val.trashed_at)) {
        throw new errors_1.BoxSdkError({

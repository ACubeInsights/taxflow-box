...
const fileVersionLegalHold_1 = require("../schemas/fileVersionLegalHold.js");
const fileVersionLegalHolds_1 = require("../schemas/fileVersionLegalHolds.js");
...
class FileVersionLegalHoldsManager {
    ...
    getFileVersionLegalHoldById(fileVersionLegalHoldId_1) {
        return __awaiter(this, arguments, void 0, function* (fileVersionLegalHoldId, optionalsInput = {}) {
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/file_version_legal_holds/', (0, utils_2.toString)(fileVersionLegalHoldId)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return Object.assign(Object.assign({}, (0, fileVersionLegalHold_1.deserializeFileVersionLegalHold)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getFileVersionLegalHolds(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, fileVersionLegalHolds_1.deserializeFileVersionLegalHolds)(response.data)), { rawData: response.data });
        });
    }
}
exports.FileVersionLegalHoldsManager = FileVersionLegalHoldsManager;
//# sourceMappingURL=fileVersionLegalHolds.js.map
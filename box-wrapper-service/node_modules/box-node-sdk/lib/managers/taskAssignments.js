...
const taskAssignments_1 = require("../schemas/taskAssignments.js");
const taskAssignment_1 = require("../schemas/taskAssignment.js");
...
class TaskAssignmentsManager {
    ...
    getTaskAssignments(taskId_1) {
        return __awaiter(this, arguments, void 0, function* (taskId, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, taskAssignments_1.deserializeTaskAssignments)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createTaskAssignment(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, taskAssignment_1.deserializeTaskAssignment)(response.data)), { rawData: response.data });
        });
    }
    /**

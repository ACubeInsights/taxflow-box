...
const accessToken_1 = require("../schemas/accessToken.js");
const postOAuth2Token_1 = require("../schemas/postOAuth2Token.js");
const postOAuth2TokenRefreshAccessToken_1 = require("../schemas/postOAuth2TokenRefreshAccessToken.js");
const postOAuth2Revoke_1 = require("../schemas/postOAuth2Revoke.js");
const postOAuth2TokenRefreshAccessToken_2 = require("../schemas/postOAuth2TokenRefreshAccessToken.js");
...
class AuthorizationManager {
    ...
    requestAccessToken(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, accessToken_1.deserializeAccessToken)(response.data)), { rawData: response.data });
        });
    }
    /**

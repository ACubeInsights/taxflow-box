...
const aiMultipleAgentResponse_1 = require("../schemas/aiMultipleAgentResponse.js");
const aiSingleAgentResponseFull_1 = require("../schemas/aiSingleAgentResponseFull.js");
const createAiAgent_1 = require("../schemas/createAiAgent.js");
const createAiAgent_2 = require("../schemas/createAiAgent.js");
...
class AiStudioManager {
    ...
    getAiAgents() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetAiAgentsHeaders({}), cancellationToken) {
            ...
            return Object.assign(Object.assign({}, (0, aiMultipleAgentResponse_1.deserializeAiMultipleAgentResponse)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createAiAgent(requestBodyInput_1) {
        return __awaiter(this, arguments, void 0, function* (requestBodyInput, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, aiSingleAgentResponseFull_1.deserializeAiSingleAgentResponseFull)(response.data)), { rawData: response.data });
        });
    }
    /**
       * Updates an AI agent.

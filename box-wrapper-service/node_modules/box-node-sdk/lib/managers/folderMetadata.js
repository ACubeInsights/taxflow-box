...
const metadatas_1 = require("../schemas/metadatas.js");
const metadataFull_1 = require("../schemas/metadataFull.js");
const metadataInstanceValue_1 = require("../schemas/metadataInstanceValue.js");
const metadataInstanceValue_2 = require("../schemas/metadataInstanceValue.js");
...
class FolderMetadataManager {
    ...
    getFolderMetadata(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            ...
            const queryParamsMap = (0, utils_1.prepareParams)({ ['view']: (0, utils_2.toString)(queryParams.view) });
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folders/', (0, utils_2.toString)(folderId), '/metadata'),
                method: 'GET',
            ...
            return Object.assign(Object.assign({}, (0, metadatas_1.deserializeMetadatas)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getFolderMetadataById(folderId_1, scope_1, templateKey_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, scope, templateKey, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_1.FetchOptions({
                url: ''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folders/', (0, utils_2.toString)(folderId), '/metadata/', (0, utils_2.toString)(scope), '/', (0, utils_2.toString)(templateKey)),
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return Object.assign(Object.assign({}, (0, metadataFull_1.deserializeMetadataFull)(response.data)), { rawData: response.data });
        });
    }
    /**
...
function serializeUpdateFolderMetadataByIdRequestBody(val) {
    return {
        ...
        ['value']: val.value == void 0
            ? val.value
            : (0, metadataInstanceValue_1.serializeMetadataInstanceValue)(val.value),
        ['from']: val.from,
    };
}
function deserializeUpdateFolderMetadataByIdRequestBody(val) {
    ...
    if (!(val.path == void 0) && !(0, json_1.sdIsString)(val.path)) {
        throw new errors_1.BoxSdkError({
            message: 'Expecting string for "path" of type "UpdateFolderMetadataByIdRequestBody"',
        });
    }
    const path = val.path == void 0 ? void 0 : val.path;
    const value = val.value == void 0 ? void 0 : (0, metadataInstanceValue_2.deserializeMetadataInstanceValue)(val.value);
    if (!(val.from == void 0) && !(0, json_1.sdIsString)(val.from)) {
        throw new errors_1.BoxSdkError({
...
//# sourceMappingURL=folderMetadata.js.map
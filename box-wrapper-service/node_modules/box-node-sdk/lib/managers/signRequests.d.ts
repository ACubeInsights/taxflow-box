...
import { SignRequestCancelRequest } from '../schemas/signRequestCancelRequest.js';
...
export declare class CancelSignRequestOptionals {
    ...
    constructor(fields: Omit<CancelSignRequestOptionals, 'requestBody' | 'headers' | 'cancellationToken'> & Partial<Pick<CancelSignRequestOptionals, 'requestBody' | 'headers' | 'cancellationToken'>>);
}
...
//# sourceMappingURL=signRequests.d.ts.map
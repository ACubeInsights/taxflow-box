...
class BoxOAuth {
    ...
    getAuthorizeUrl(options = {}) {
        const paramsMap = (0, utils_1.prepareParams)({
        ...
        return ''.concat('https://account.box.com/api/oauth2/authorize?', (0, json_1.sdToUrlParams)(JSON.stringify(paramsMap)));
    }
    /**
    ...
    downscopeToken(scopes, resource, sharedLink, networkSession) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (token == void 0 || token.accessToken == void 0) {
                throw new errors_1.BoxSdkError({ message: 'No access token is available.' });
            }
            const authManager = new authorization_1.AuthorizationManager({
                networkSession: !(networkSession == void 0)
                    ? networkSession
